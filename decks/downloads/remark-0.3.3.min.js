  ...
  (function (a) {
    ...
    !(function (a) {
      (function () {
        function l() {
          var a =
            "(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b";
          return a;
        }
        var a = {
          newline: /^\n+/,
        ...
        (a.list = (function () {
          ...
          (a.paragraph = (function () {
            ...
            return (
              ...
              })("gfm_code")("hr")("heading")("lheading")("blockquote")(
                "<(?!" + l() + ")\\w+"
              )("def"),
          ...
          (a.token = function (b, c, d) {
            var b = b.replace(/^ +$/gm, ""),
              ...
              j;
            while (b) {
              if ((f = a.newline.exec(b)))
                (b = b.substring(f[0].length)),
                  f[0].length > 1 && c.push({ type: "space" });
              if ((f = a.code.exec(b))) {
                (b = b.substring(f[0].length)),
                  (f = f[0].replace(/^ {4}/gm, "")),
                  c.push({ type: "code", text: f.replace(/\n+$/, "") });
                continue;
              }
              if ((f = a.gfm_code.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({ type: "code", lang: f[1], text: f[2] });
                continue;
              }
              if ((f = a.heading.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({ type: "heading", depth: f[1].length, text: f[2] });
                continue;
              }
              if ((f = a.lheading.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({
                    type: "heading",
                    depth: f[2] === "=" ? 1 : 2,
              ...
              if ((f = a.hr.exec(b))) {
                (b = b.substring(f[0].length)), c.push({ type: "hr" });
                continue;
              }
              if ((f = a.blockquote.exec(b))) {
                (b = b.substring(f[0].length)),
              ...
              if ((f = a.list.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({ type: "list_start", ordered: isFinite(f[2]) }),
                  (e = /\n *\n *(?:[*+-]|\d+\.)/.test(f[0])),
                  (f = f[0].match(
                    /^( *)([*+-]|\d+\.)[^\n]*(?:\n(?!\1(?:[*+-]|\d+\.))[^\n]*)*/gm
                  )),
              ...
              if ((f = a.html.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({ type: "html", text: f[0] });
                continue;
              }
              if (d && (f = a.def.exec(b))) {
                (b = b.substring(f[0].length)),
                  (c.links[f[1].toLowerCase()] = { href: f[2], title: f[3] });
                continue;
              }
              if (d && (f = a.paragraph.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({ type: "paragraph", text: f[0] });
                continue;
              }
              if ((f = a.text.exec(b))) {
                (b = b.substring(f[0].length)),
                  c.push({ type: "text", text: f[0] });
                continue;
              }
            }
            return c;
        ...
        b.lexer = function (a) {
          ...
          while (a) {
            ...
            if ((l = b.tag.exec(a))) {
              (a = a.substring(l[0].length)), (e += l[0]);
              continue;
            }
            if ((l = b.link.exec(a))) {
              (a = a.substring(l[0].length)),
        ...
        var c = function (a, c) {
          ...
          g = function () {
            switch (e.type) {
              ...
              case "heading":
                return (
                  "<h" + e.depth + ">" + b.lexer(e.text) + "</h" + e.depth + ">"
                );
              case "code":
                return (
                  "<pre><code" +
              ...
              case "blockquote_start":
                var a = [];
                while (f().type !== "blockquote_end") a.push(g());
                return "<blockquote>" + a.join("") + "</blockquote>";
              case "list_start":
                var c = e.ordered ? "ol" : "ul",
                  a = [];
                while (f().type !== "list_end") a.push(g());
                return "<" + c + ">" + a.join("") + "</" + c + ">";
              case "list_item_start":
                var a = [];
                while (f().type !== "list_item_end")
                  a.push(e.type === "text" ? h() : g());
                return "<li>" + a.join(" ") + "</li>";
              case "loose_item_start":
                var a = [];
                while (f().type !== "list_item_end") a.push(g());
                return "<li>" + a.join(" ") + "</li>";
              case "html":
                return b.lexer(e.text);
              case "paragraph":
          ...
          h = function () {
            var a = [e.text],
              c;
            while ((c = d[d.length - 1]) && c.type === "text") a.push(f().text);
            return b.lexer(a.join("\n"));
          },
          i = function (a) {
            d = a.reverse();
            var b = [];
            while (f()) b.push(g());
            return (d = null), (e = null), b.join("\n");
          },
          j = function (a, b) {
            return a
              .replace(b ? /&/g : /&(?!#?\w+;)/g, "&amp;")
          ...
          k = function (a) {
            ...
            for (; d < e; d++)
              (c = a.charCodeAt(d)),
                Math.random() > 0.5 && (c = "x" + c.toString(16)),
                (b += "&#" + c + ";");
            return b;
          },
          m = function (b) {

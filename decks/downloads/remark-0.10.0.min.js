require = (function (e, t, n) {
...
})(
  {
    ...
    aIW4aw: [
      function (require, module, exports) {
        ...
        function SlideNumberViewModel(slide, slideshow) {
          ...
          self.element.innerHTML = formatSlideNumber(
            self.slide,
            self.slideshow
          );
        }
    ...
    3: [
      ...
      { "components/styler": "t5Lx4S", "./remark/api": 4, "./polyfills": 5 },
    ],
    "components/timer": [
      function (require, module, exports) {
          ...
          var hljs = new (function () {
              ...
              function compileLanguage(language) {
                ...
                function compileMode(mode, parent) {
                  ...
                  mode.lexemesRe = langRe(
                    mode.lexemes || /\b[A-Za-z0-9_]+\b/,
                    true
                  );
                  if (parent) {
              ...
              function highlightAuto(text, languageSubset) {
                ...
                var result = { relevance: 0, value: escape(text) };
              ...
              function highlightBlock(block) {
                ...
                if (original.length) {
                  var pre = document.createElementNS(
                        ...
                        contains: [
                          {
                            ...
                            starts: { contains: [hljs.TITLE_MODE] },
                          },
                          {
      ...
      function (require, module, exports) {
        !(function () {
          ...
          function cleanInput(source) {
            ...
            var whitespace = getMatchCaptures(
              source,
            ...
            var trimWhitespacePattern = new RegExp(
              "^[ \\t]{0," + minWhitespace + "}",
              "gm"
            );
      ...
      function (require, module, exports) {
        ...
        function SlideshowView(events, dom, containerElement, slideshow) {
          ...
          events.on("forcePresenterMode", function () {
            if (
              !utils.hasClass(self.containerElement, "remark-presenter-mode")
            ) {
        ...
        function handleFullscreen(self) {
          var requestFullscreen = utils.getPrefixedProperty(
            ...
            cancelFullscreen = utils.getPrefixedProperty(
              document,
              "cancelFullScreen"
            );
    ...
    16: [
      function (require, module, exports) {
        ...
        var block = replace(
            /CODE|CONTENT|FENCES|DEF|MACRO|SEPARATOR|NOTES_SEPARATOR/,
            regexByName
          ),
    ...
    19: [
      function (require, module, exports) {
        ...
        function ignoreProperty(property) {
          return (
            property === "name" || property === "layout" || property === "count"
          );
        }
        ...
        function Navigation(events) {
          ...
          function gotoSlideByIndex(slideIndex, noMessage) {
            var alreadyOnSlide = slideIndex === currentSlideIndex,
              slideOutOfRange =
                slideIndex < 0 || slideIndex > self.getSlideCount() - 1;
    ...
    25: [
      function (require, module, exports) {
        ...
        SlideView.prototype.configureElements = function () {
          ...
          self.notesElement = createNotesElement(
            self.slideshow,
            self.slide.notes
          );
            ...
            image.onload = function () {
              if (
                ...
                if (!self.originalBackgroundSize) {
                  ...
                  self.originalBackgroundPosition =
                    self.contentElement.style.backgroundPosition;
        ...
        function extractMetadata(block) {
          ...
          block.innerHTML = block.innerHTML
            ...
            .join("\n");
          return { highlightedLines: highlightedLines };
        }
        ...
        function highlightBlockSpans(block) {
          var pattern = /([^\\`])`([^`]+?)`/g,
            replacement =
              '$1<span class="remark-code-span-highlighted">$2</span>';
    ...
    27: [
      function (require, module, exports) {
        ...
        NotesView.prototype.showSlide = function (slideIndex) {
          ...
          if (nextSlideView) {
            self.notesPreviewElement.innerHTML =
              nextSlideView.notesElement.innerHTML;
          } else {
            self.notesPreviewElement.innerHTML = "";
          }
        };
        NotesView.prototype.configureElements = function () {
          var self = this;
          self.notesElement = self.element.getElementsByClassName(
            "remark-notes"
          )[0];
          self.notesPreviewElement = self.element.getElementsByClassName(
            "remark-notes-preview"
          )[0];
          self.notesElement.addEventListener("mousewheel", function (event) {
            event.stopPropagation();
          });
          self.notesPreviewElement.addEventListener("mousewheel", function (
            event
          ) {
            event.stopPropagation();
          });
          self.toolbarElement = self.element.getElementsByClassName(
            "remark-toolbar"
          )[0];
          var commands = {
            increase: function () {
              self.notesElement.style.fontSize =
                ...
                0.1 +
                "em";
              self.notesPreviewElement.style.fontsize =
                self.notesElement.style.fontSize;
            },
            decrease: function () {
              self.notesElement.style.fontSize =

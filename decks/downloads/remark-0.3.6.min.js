...
(require.paths = []),
  ...
  require.define("/src/remark.js", function (a, b, c, d, e) {
    function m(a, b) {
      return a
        ? b
          ? !0
          : (g.alert("remark error: slideshow element not present."), !1)
        : (g.alert("remark error: source element not present."), !1);
    }
    function n() {
      var a = g.createElement("style"),
        b = g.getElementsByTagName("head")[0];
      (a.type = "text/css"),
        (a.innerHTML = l.documentStyles),
        (a.innerHTML += j.cssForStyle()),
        b.insertBefore(a, b.firstChild);
    }
    function o(a, b) {
      var c = a.innerHTML,
        d;
      (d = k.create(c, b)), h.initialize(d), i.initialize();
    }
    var f = a("./remark/api"),
      g = a("./remark/dom"),
      h = a("./remark/controller"),
      i = a("./remark/dispatcher"),
      j = a("./remark/highlighter"),
      k = a("./remark/slideshow"),
      l = a("./remark/resources");
    (g.exports.remark = f),
      g.on("load", function () {
        var a = g.getElementById("source"),
          b = g.getElementById("slideshow");
        if (!m(a, b)) return;
        (a.style.display = "none"), n(), o(a, b);
      });
  }),
  ...
  require.define("/src/remark/controller.js", function (a, b, c, d, e) {
    ...
    h.initialize = function (a) {
      var b = function () {
        var b = parseInt((location.hash || "").substr(1), 10) || 1;
        j(a, b - 1);
      };
      g.on("hashchange", b),
        b(),
        f.on("previousSlide", function () {
          j(a, i - 1);
        }),
        f.on("nextSlide", function () {
          j(a, i + 1);
        });
    };
    var j = function (a, b) {
    ...
    var i = function () {
      ...
      k = function () {
        h.on("mousewheel", function (a) {
          a.wheelDeltaY > 0 ? m() : a.wheelDeltaY < 0 && l();
        });
      },
      l = function () {
        g.emit("nextSlide");
      ...
      (b.exports.highlighter.engine = (function () {
        var a = new (function () {
          ...
          function d(a) {
            for (var b = 0; b < a.childNodes.length; b++) {
              ...
              if (c.nodeName == "CODE") return c;
              if (c.nodeType != 3 || !c.nodeValue.match(/\s+/)) break;
            }
          }
          function e(a, b) {
            var c = "";
            for (var d = 0; d < a.childNodes.length; d++)
              if (a.childNodes[d].nodeType == 3) {
                var f = a.childNodes[d].nodeValue;
                b && (f = f.replace(/\n/g, "")), (c += f);
              } else
                a.childNodes[d].nodeName == "BR"
                  ? (c += "\n")
                  : (c += e(a.childNodes[d]));
            return (
          ...
          function f(a) {
            ...
            b = b.concat(a.parentNode.className.split(/\s+/));
            for (var c = 0; c < b.length; c++) {
              var d = b[c].replace(/^language-/, "");
              if (p[d] || d == "no-highlight") return d;
            }
          }
          function g(a) {
            var b = [];
            return (
              (function c(a, d) {
                for (var e = 0; e < a.childNodes.length; e++)
                  a.childNodes[e].nodeType == 3
                    ? (d += a.childNodes[e].nodeValue.length)
                    : a.childNodes[e].nodeName == "BR"
                    ? (d += 1)
                    : a.childNodes[e].nodeType == 1 &&
                      (b.push({
                        event: "start",
                        offset: d,
                        node: a.childNodes[e],
                      }),
                      (d = c(a.childNodes[e], d)),
                      b.push({
                        event: "stop",
                        offset: d,
                        node: a.childNodes[e],
          ...
          function i() {
            function b(d, e, f) {
              ...
              var g,
                h = [];
              if (d.keywords) {
                d.lexemsRe = c(e, d.lexems || a.IDENT_RE, !0);
                for (var i in d.keywords) {
                  if (!d.keywords.hasOwnProperty(i)) continue;
                  d.keywords[i] instanceof Object
                    ? (g = d.keywords[i])
                    : ((g = d.keywords), (i = "keyword"));
                  for (var j in g) {
                    if (!g.hasOwnProperty(j)) continue;
                    (d.keywords[j] = [i, g[j]]), h.push(j);
                  }
                }
              }
              f ||
                (d.beginWithKeyword &&
                  (d.begin = "\\b(" + h.join("|") + ")\\s"),
                (d.beginRe = c(e, d.begin ? d.begin : "\\B|\\b")),
                !d.end && !d.endsWithParent && (d.end = "\\B|\\b"),
                d.end && (d.endRe = c(e, d.end))),
                d.illegal && (d.illegalRe = c(e, d.illegal)),
                d.relevance === undefined && (d.relevance = 1),
                d.contains || (d.contains = []),
                (d.compiled = !0);
              for (var k = 0; k < d.contains.length; k++)
                d.contains[k] == "self" && (d.contains[k] = d),
                  b(d.contains[k], e, !1);
              d.starts && b(d.starts, e, !1);
            }
            for (var d in p) {
              if (!p.hasOwnProperty(d)) continue;
              b(p[d].defaultMode, p[d], !0);
            }
          }
          function j(a, d) {
            function e(a, b) {
            ...
            function f(a, b) {
              if (u[a].end && u[a].endRe.test(b)) return 1;
              if (u[a].endsWithParent) {
                var c = f(a - 1, b);
                return c ? c + 1 : 0;
              }
              return 0;
            ...
            function h(a, b) {
              var d = [];
              for (var e = 0; e < a.contains.length; e++)
                d.push(a.contains[e].begin);
              var f = u.length - 1;
              do u[f].end && d.push(u[f].end), f--;
              while (u[f + 1].endsWithParent);
              return a.illegal && d.push(a.illegal), c(b, d.join("|"), !0);
            }
            function l(a, b) {
              var c = u[u.length - 1];
              c.terminators || (c.terminators = h(c, t)),
                (c.terminators.lastIndex = b);
              var d = c.terminators.exec(a);
              return d
                ? [a.substr(b, d.index - b), d[0], !1]
                : [a.substr(b), "", !0];
            }
            function m(a, b) {
              var c = t.case_insensitive ? b[0].toLowerCase() : b[0],
                d = a.keywords[c];
              return d && d instanceof Array ? d : !1;
            }
            function n(a, c) {
              a = b(a);
              if (!c.keywords) return a;
              var d = "",
                e = 0;
              c.lexemsRe.lastIndex = 0;
              var f = c.lexemsRe.exec(a);
              while (f) {
                d += a.substr(e, f.index - e);
                var g = m(c, f);
                g
                  ? ((w += g[1]),
                    (d += '<span class="' + g[0] + '">' + f[0] + "</span>"))
                  : (d += f[0]),
                  (e = c.lexemsRe.lastIndex),
                  (f = c.lexemsRe.exec(a));
              }
              return d + a.substr(e, a.length - e);
            }
            function o(a, b) {
              var c;
              return (
                b.subLanguage == "" ? (c = k(a)) : (c = j(b.subLanguage, a)),
                b.relevance > 0 && ((w += c.keyword_count), (v += c.relevance)),
                '<span class="' + c.language + '">' + c.value + "</span>"
              );
            }
            function q(a, b) {
              return (b.subLanguage && p[b.subLanguage]) || b.subLanguage == ""
                ? o(a, b)
                : n(a, b);
            }
            function r(a, c) {
            ...
            function s(a, c, d) {
              var h = u[u.length - 1];
              if (d) return (x += q(h.buffer + a, h)), !1;
              var i = e(c, h);
              if (i) return (x += q(h.buffer + a, h)), r(i, c), i.returnBegin;
              var j = f(u.length - 1, c);
              if (j) {
                var k = h.className ? "</span>" : "";
                h.returnEnd
                  ? (x += q(h.buffer + a, h) + k)
                  : h.excludeEnd
                  ? (x += q(h.buffer + a, h) + k + b(c))
                  : (x += q(h.buffer + a + c, h) + k);
                while (j > 1)
                  (k = u[u.length - 2].className ? "</span>" : ""),
                    (x += k),
                    j--,
                    u.length--;
                var l = u[u.length - 1];
              ...
              if (g(c, h)) throw "Illegal";
            }
            i.called || (i(), (i.called = !0));
            var t = p[a],
              u = [t.defaultMode],
              v = 0,
              w = 0,
            ...
            try {
              var y,
                z = 0;
              t.defaultMode.buffer = "";
              do {
                y = l(d, z);
                var A = s(y[0], y[1], y[2]);
                (z += y[0].length), A || (z += y[1].length);
              } while (!y[2]);
              if (u.length > 1) throw "Illegal";
              return { relevance: v, keyword_count: w, value: x, language: a };
            } catch (B) {
              if (B == "Illegal")
                return { relevance: 0, keyword_count: 0, value: b(d) };
              throw B;
            }
          }
          function k(a) {
          ...
          function m(a, b, c) {
            var d = e(a, c),
              ...
              m,
              n;
            if (i == "no-highlight") return;
            i ? (m = j(i, d)) : ((m = k(d)), (i = m.language));
            var o = g(a);
            o.length &&
              ((n = document.createElement("pre")),
              (n.innerHTML = m.value),
              (m.value = h(o, g(n), d))),
              (m.value = l(m.value, b, c));
            var p = a.className;
            p.match("(\\s|^)(language-)?" + i + "(\\s|$)") ||
              (p = p ? p + " " + i : i);
            if (
              /MSIE [678]/.test(navigator.userAgent) &&
              a.tagName == "CODE" &&
              a.parentNode.tagName == "PRE"
            ) {
              n = a.parentNode;
              var q = document.createElement("div");
              (q.innerHTML = "<pre><code>" + m.value + "</code></pre>"),
                (a = q.firstChild.firstChild),
                (q.firstChild.className = n.className),
                n.parentNode.replaceChild(q.firstChild, n);
            } else a.innerHTML = m.value;
            (a.className = p),
              (a.result = {
                language: i,
                kw: m.keyword_count,
          ...
          (this.LANGUAGES = p),
            ...
            (this.RE_STARTERS_RE =
              "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|\\.|-|-=|/|/=|:|;|<|<<|<<=|<=|=|==|===|>|>=|>>|>>=|>>>|>>>=|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~"),
            (this.EOF_RE = "(?![\\s\\S])"),
            (this.BACKSLASH_ESCAPE = { begin: "\\\\.", relevance: 0 }),
        ...
        return (
          ...
          (a.LANGUAGES.ruby = (function () {
            ...
            return (
              (g.contains = l),
              (j.contains[1].contains = l),
              { defaultMode: { lexems: b, keywords: d, contains: l } }
            );
          })()),
          (a.LANGUAGES.python = (function () {
            var b = [
                {
                  className: "string",
                  begin: "(u|b)?r?'''",
              ...
              d = {
                ...
                contains: b.concat([a.C_NUMBER_MODE]),
              },
              e = {
                beginWithKeyword: !0,
                end: ":",
            ...
            return {
              defaultMode: {
                ...
                contains: b.concat([
                  a.HASH_COMMENT_MODE,
                  a.inherit(e, { className: "function", keywords: { def: 1 } }),
                  a.inherit(e, { className: "class", keywords: { class: 1 } }),
                  a.C_NUMBER_MODE,
          ...
          (a.LANGUAGES.bash = (function () {
            var b = { true: 1, false: 1 },
              ...
              g = {
                ...
                contains: [e, f, c, d, a.C_NUMBER_MODE],
                keywords: { literal: b },
                relevance: 0,
              };
            return {
          ...
          (a.LANGUAGES.php = (function () {
            var b = {
              ...
              d = [a.C_NUMBER_MODE, a.BINARY_NUMBER_MODE],
                  ...
                  b,
                  {
                    ...
                    contains: [
                      e,
                      {
                        ...
                        contains: [b, a.C_BLOCK_COMMENT_MODE]
                          .concat(c)
                          .concat(d),
                      },
                    ],
          ...
          (a.LANGUAGES.perl = (function () {
            var b = {
              ...
              i = [
                ...
                { className: "pod", begin: "\\=\\w", end: "\\=cut" },
              ];
            return (
              (c.contains = i),
              (g.contains[1].contains = i),
              { defaultMode: { keywords: b, contains: i } }
            );
          })()),
          (a.LANGUAGES.cpp = (function () {
            var b = {
              keyword: {
                false: 1,
                int: 1,
          ...
          (a.LANGUAGES.objectivec = (function () {
            var b = {
              keyword: {
                false: 1,
                int: 1,
          ...
          (a.LANGUAGES.xml = (function () {
            var a = "[A-Za-z0-9\\._:-]+",
              b = {
                endsWithParent: !0,
                contains: [
                  { className: "attribute", begin: a, relevance: 0 },
                  {
                    begin: '="',
                    returnBegin: !0,
                    end: '"',
              ...
              defaultMode: {
                contains: [
                  ...
                  { begin: "<%", end: "%>", subLanguage: "vbscript" },
                  {
                    ...
                    contains: [{ className: "title", begin: "[^ />]+" }, b],
                  },
                ],
              },
            };
          })()),
          (a.LANGUAGES.css = (function () {
            var b = {
              className: "function",
              begin: a.IDENT_RE + "\\(",
              end: "\\)",
          ...
          (a.LANGUAGES.coffeescript = (function () {
            var b = {
                keyword: {
                  in: 1,
                  if: 1,
              ...
              d = {
                ...
                keywords: b,
                contains: [a.C_NUMBER_MODE, a.BINARY_NUMBER_MODE],
              },
              e = {
                className: "string",
                begin: '"',
  ...
  require.define("/src/remark/slideshow.js", function (a, b, c, d, e) {
    var f = a("./api"),
      g = a("./slide"),
      h = a("./dom"),
      i = (b.exports = {}),
    ...
    i.create = function (a, b) {
      ...
      (d.className = "position"), b.appendChild(d), n(b);
      ...
      return {
        showSlide: function (a) {
          ...
          f.emit("slidein", b.element(), a),
            (b.element().style.display = "table"),
            (d.innerHTML = a + 1 + " / " + c.length);
        },
        hideSlide: function (a) {
          var b = c[a];
          f.emit("slideout", b.element(), a),
    ...
    var m = function (a, b) {
        var c,
          ...
          e;
        c = a.split(/\n\n---\n/);
        for (e = 0; e < c.length; ++e) d.push(g.create(c[e]));
        return d;
      },
      n = function (a) {
        var b = j * l,
  ...
  require.define("/src/remark/slide.js", function (a, b, c, d, e) {
    var f = a("./converter"),
      g = a("./dom"),
      h = a("./highlighter"),
      i = (b.exports = {});
        ...
        (b.element = function () {
          return (
            d === undefined &&
              ...
              d.appendChild(g.createElement("div")),
              j(b)),
            d
          );
        }),
    ...
    var j = function (a) {
        var b = a.element().children[0];
        (b.innerHTML = a.source()), k(b);
      },
      k = function (a) {
        f.convertContentClasses(a),
          f.convertSlideAttributes(a),
          f.convertSlideClasses(a),
          f.convertMarkdown(a),
          f.convertCodeClasses(a),
          h.highlightCodeBlocks(a);
      };
  }),
  require.define("/src/remark/converter.js", function (a, b, c, d, e) {
    var f = a("marked"),
      ...
      h = (b.exports = {});
    f.setOptions({ gfm: !1 }),
      (h.convertSlideAttributes = function (a) {
        var b = /(?:^|\n)(\\)?((?:\.[a-z_\-][a-z\-_0-9]*)+)\s*=\s*([^$\n]*)\s*(?:$|\n)/gi,
          c,
          d = {},
          e,
          f;
        while ((e = b.exec(a.innerHTML)) !== null)
          e[1]
            ? (c = e[0].replace(/\\/, ""))
            : ((c = ""), (d[e[2].substr(1)] = e[3])),
            (a.innerHTML =
              a.innerHTML.substr(0, e.index) +
              c +
              a.innerHTML.substr(e.index + e[0].length)),
            (b.lastIndex = e.index + c.length);
        for (f in d) d.hasOwnProperty(f) && a.setAttribute(f, d[f]);
      }),
      (h.convertSlideClasses = function (a) {
        var b = /(?:^|\n)(\\)?((?:\.[a-z_\-][a-z\-_0-9]*)+)\s*(?:$|\n)/gi,
          c,
          d,
          e = ["content"],
          f;
        while ((f = b.exec(a.innerHTML)) !== null)
          f[1]
            ? (d = f[0].replace(/\\/, ""))
            : ((d = ""), (c = f[2].substr(1).split(".")), (e = e.concat(c))),
            (a.innerHTML =
              a.innerHTML.substr(0, f.index) +
              d +
              a.innerHTML.substr(f.index + f[0].length)),
            (b.lastIndex = f.index + d.length);
        e.length && (a.className = e.join(" "));
      }),
    ...
    (h.convertMarkdown = function (a) {
      (a.innerHTML = f(a.innerHTML.trim(" "))),

...
(require.paths = []),
  ...
  require.define("/remark/api.js", function (a, b, c, d, e) {
  ...
  require.define("/remark/config.js", function (a, b, c, d, e) {
    function h(a) {
      k(a);
    }
    function i() {
    ...
    function k(a) {
      ...
      for (b = 0; b < g.length; ++b)
        (c = g[b]), a.hasOwnProperty(c) && (f[c] = a[c]);
    }
    var f = (b.exports = h),
      g = ["highlightInline", "highlightLanguage", "highlightStyle"];
    typeof document != "undefined" && i();
  }),
  require.define("/remark/controller.js", function (a, b, c, d, e) {
    var f = a("./dispatcher"),
      g = (b.exports = {}),
      h = -1;
    g.create = function (a) {
  ...
  require.define("/remark/dispatcher.js", function (a, b, c, d, e) {
    var f = a("events").EventEmitter,
      g = (b.exports = new f());
    g.create = function () {
      h(), i(), j();
    ...
    var h = function () {
      ...
      i = function () {
        ...
        document.addEventListener("touchstart", function (a) {
          (b = a.touches[0]), (c = b.clientX);
        }),
          document.addEventListener("touchend", function (a) {
            if (a.target.nodeName.toUpperCase() === "A") return;
            (b = a.changedTouches[0]), (d = b.clientX), e() ? f() : g();
          }),
      ...
      j = function () {
        document.addEventListener("mousewheel", function (a) {
          a.wheelDeltaY > 0 ? l() : a.wheelDeltaY < 0 && k();
        });
      },
      k = function () {
        g.emit("nextSlide");
  ...
  require.define("/remark/converter.js", function (a, b, c, d, e) {
    var f = a("../vendor/marked"),
      g = a("./config"),
      h = (b.exports = {});
    f.setOptions({ gfm: !1 }),
      ...
      (h.convertContentClasses = function (a) {
        var b = /(\\)?((?:\.[a-z_-][a-z-_0-9]*)+)\[/gi,
          ...
          f,
          g;
        while ((c = b.exec(a.innerHTML))) {
          e = i(a.innerHTML.substr(c.index + c[0].length));
          if (e === null) continue;
          c[1]
            ? ((f = c[2] + "[" + e + "]"), (b.lastIndex = c.index + f.length))
            : ((d = c[2].substr(1).split(".")),
              (f = '<span class="' + d.join(" ") + '">' + e + "</span>"),
              (b.lastIndex =
                c.index + ('<span class="' + d.join(" ") + '">').length)),
            (g = a.innerHTML.substr(c.index + c[0].length + e.length + 1)),
            (a.innerHTML = a.innerHTML.substr(0, c.index) + f + g);
        }
      });
    var i = function (a) {
      var b = 1,
  ...
  require.define("/vendor/marked.js", function (a, b, c, d, e) {
    (function () {
      function m() {
        var a =
  ...
  require.define("/remark/highlighter.js", function (a, b, c, d, e) {
    var f = a("../vendor/highlight/highlight.min"),
      g = a("./api"),
      h = a("./config"),
      i = a("./resources"),
      j = (b.exports = {});
    (g.highlighter = {
      ...
      (j.cssForStyle = function () {
        return (
          h.highlightStyle === undefined && (h.highlightStyle = "default"),
          h.highlightStyle === null ? "" : i.highlightStyles[h.highlightStyle]
        );
      }),
      (j.highlightCodeBlocks = function (a) {
        var b = a.getElementsByTagName("code"),
          c,
          d;
        for (d = 0; d < b.length; d++) (c = b[d]), f.highlightBlock(c, "  ");
      });
  }),
  require.define("/vendor/highlight/highlight.min.js", function (
    a,
    b,
    c,
    d,
    ...
    var f = (b.exports = new (function () {
      ...
      function d(a, b) {
        ...
        for (var e = 0; e < a.childNodes.length; e++)
          if (a.childNodes[e].nodeType == 3) {
            var f = a.childNodes[e].nodeValue;
            b && (f = f.replace(/\n/g, "")), (c += f);
          } else
        ...
        return (
          (function (a, c) {
            for (var d = 0; d < a.childNodes.length; d++)
              a.childNodes[d].nodeType == 3
                ? (c += a.childNodes[d].nodeValue.length)
                : a.childNodes[d].nodeName == "BR"
                ? (c += 1)
                : (b.push({ event: "start", offset: c, node: a.childNodes[d] }),
                  (c = arguments.callee(a.childNodes[d], c)),
                  b.push({ event: "stop", offset: c, node: a.childNodes[d] }));
            return c;
          })(a, 0),
          b
        );
      ...
      function h(b, c, d) {
        ...
        while (b.length || c.length) {
          ...
          if (j.event == "start") (f += i(j.node)), g.push(j.node);
            ...
            g.splice(k, 1);
            while (k < g.length) (f += i(g[k])), k++;
          }
        }
        return (f += d.substr(e)), f;
      }
      function i() {
        function a(c, d, e) {
          if (c.compiled) return;
          e ||
            ((c.bR = b(d, c.b ? c.b : "\\B|\\b")),
            !c.e && !c.eW && (c.e = "\\B|\\b"),
            c.e && (c.eR = b(d, c.e))),
            c.i && (c.iR = b(d, c.i)),
            c.r == undefined && (c.r = 1),
            c.k && (c.lR = b(d, c.l || f.IR, !0));
          for (var g in c.k) {
            if (!c.k.hasOwnProperty(g)) continue;
            c.k[g] instanceof Object ? (c.kG = c.k) : (c.kG = { keyword: c.k });
            break;
          }
          c.c || (c.c = []), (c.compiled = !0);
          for (var h = 0; h < c.c.length; h++) a(c.c[h], d, !1);
          c.starts && a(c.starts, d, !1);
        }
        for (var c in p) {
      ...
      function j(c, d) {
        function e(a, b) {
          for (var c = 0; c < b.c.length; c++)
            if (b.c[c].bR.test(a)) return b.c[c];
        }
        function f(a, b) {
          if (s[a].e && s[a].eR.test(b)) return 1;
          if (s[a].eW) {
            var c = f(a - 1, b);
            return c ? c + 1 : 0;
          }
        ...
        function g(a, b) {
          return b.iR && b.iR.test(a);
        }
        function h(a, c) {
          var d = [];
          for (var e = 0; e < a.c.length; e++) d.push(a.c[e].b);
          var f = s.length - 1;
          do s[f].e && d.push(s[f].e), f--;
          while (s[f + 1].eW);
          return a.i && d.push(a.i), b(c, "(" + d.join("|") + ")", !0);
        }
        function k(a, b) {
          var c = s[s.length - 1];
          c.t || (c.t = h(c, r)), (c.t.lastIndex = b);
          var d = c.t.exec(a);
          return d
        ...
        function l(a, b) {
          var c = r.cI ? b[0].toLowerCase() : b[0];
          for (var d in a.kG) {
            if (!a.kG.hasOwnProperty(d)) continue;
            var e = a.kG[d].hasOwnProperty(c);
            if (e) return [d, e];
          }
          return !1;
        }
        function m(b, c) {
          ...
          var f = c.lR.exec(b);
          while (f) {
            d += a(b.substr(e, f.index - e));
            var g = l(c, f);
            g
              ? ((u += g[1]),
                (d += '<span class="' + g[0] + '">' + a(f[0]) + "</span>"))
              : (d += a(f[0])),
              (e = c.lR.lastIndex),
              (f = c.lR.exec(b));
          }
          return (d += a(b.substr(e, b.length - e))), d;
        }
        function n(a, b) {
          if (b.sL && p[b.sL]) {
            var c = j(b.sL, a);
            return (u += c.keyword_count), c.value;
          }
          return m(a, b);
        }
        function o(b, c) {
        ...
        function q(b, c, d) {
          var h = s[s.length - 1];
          if (d) return (v += n(h.buffer + b, h)), !1;
          var i = e(c, h);
          if (i) return (v += n(h.buffer + b, h)), o(i, c), i.rB;
          var j = f(s.length - 1, c);
          if (j) {
            var k = h.cN ? "</span>" : "";
            h.rE
              ? (v += n(h.buffer + b, h) + k)
              : h.eE
              ? (v += n(h.buffer + b, h) + k + a(c))
              : (v += n(h.buffer + b + c, h) + k);
            while (j > 1)
              (k = s[s.length - 2].cN ? "</span>" : ""),
                (v += k),
                j--,
                s.length--;
            var l = s[s.length - 1];
        ...
        try {
          ...
          do {
            var x = k(d, w),
              y = q(x[0], x[1], x[2]);
            (w += x[0].length), y || (w += x[1].length);
          } while (!x[2]);
          if (s.length > 1) throw "Illegal";
          return { r: t, keyword_count: u, value: v };
        } catch (z) {
          if (z == "Illegal") return { r: 0, keyword_count: 0, value: a(d) };
          throw z;
        }
      }
      function k(b) {
        var c = { keyword_count: 0, r: 0, value: a(b) },
          d = c;
        for (var e in p) {
      ...
      function m(a, b, c) {
        ...
        if (n.length) {
          ...
          (o.innerHTML = m.value), (m.value = h(n, g(o), f));
        }
        ...
        if (
          ...
          (q.innerHTML = "<pre><code>" + m.value + "</code></pre>"),
            ...
            (q.firstChild.cN = o.cN),
            o.parentNode.replaceChild(q.firstChild, o);
        } else a.innerHTML = m.value;
        (a.className = p),
          (a.result = { language: i, kw: m.keyword_count, re: m.r }),
          m.second_best &&
            (a.second_best = {
    ...
    (f.LANGUAGES.bash = (function () {
      var a = { true: 1, false: 1 },
        b = { cN: "variable", b: "\\$([a-zA-Z0-9_]+)\\b" },
        c = { cN: "variable", b: "\\$\\{(([^}])|(\\\\}))+\\}", c: [f.CNM] },
        d = { cN: "string", b: '"', e: '"', i: "\\n", c: [f.BE, b, c], r: 0 },
        e = {
          cN: "test_condition",
          b: "",
      ...
      (f.LANGUAGES.erlang = (function () {
        var a = "[a-z'][a-zA-Z0-9_']*",
          ...
          g = {
            ...
            r: 0,
            c: [
              { cN: "function_name", b: b, r: 0 },
              { b: "\\(", e: "\\)", eW: !0, rE: !0, r: 0 },
            ],
          },
          h = { cN: "tuple", b: "{", e: "}", r: 0 },
          i = { cN: "variable", b: "\\b_([A-Z][A-Za-z0-9_]*)?", r: 0 },
          j = { cN: "variable", b: "[A-Z][a-zA-Z0-9_]*", r: 0 },
          k = {
            b: "#",
            e: "}",
            i: ".",
            ...
            rB: !0,
            c: [
              { cN: "record_name", b: "#" + f.UIR, r: 0 },
              { b: "{", eW: !0, r: 0 },
            ],
          },
          l = { k: c, b: "(fun|receive|if|try|case)", e: "end" };
        l.c = [
          d,
          e,
          f.inherit(f.ASM, { cN: "" }),
        ...
        var m = [d, e, l, g, f.QSM, f.CNM, h, i, j, k];
        (g.c[1].c = m), (h.c = m), (k.c[1].c = m);
        var n = { cN: "params", b: "\\(", e: "\\)", eW: !0, c: m };
        return {
          dM: {
            k: c,
            i: "(</|\\*=|\\+=|-=|/=|/\\*|\\*/|\\(\\*|\\*\\))",
            c: [
              {
                ...
                e: ";|\\.",
                rB: !0,
                c: [n, { cN: "title", b: a }, { k: c, b: "->", eW: !0, c: m }],
              },
              d,
              {
                cN: "pp",
      ...
      (f.LANGUAGES.ruby = (function () {
        var a = "[a-zA-Z_][a-zA-Z0-9_]*(\\!|\\?)?",
          ...
          d = { cN: "yardoctag", b: "@[A-Za-z]+" },
          e = { cN: "comment", b: "#", e: "$", c: [d] },
          g = { cN: "comment", b: "^\\=begin", e: "^\\=end", c: [d], r: 10 },
          h = { cN: "comment", b: "^__END__", e: "\\n$" },
          i = { cN: "subst", b: "#\\{", e: "}", l: a, k: c },
          j = [f.BE, i],
          k = { cN: "string", b: "'", e: "'", c: j, r: 0 },
          l = { cN: "string", b: '"', e: '"', c: j, r: 0 },
          m = { cN: "string", b: "%[qw]?\\(", e: "\\)", c: j, r: 10 },
          n = { cN: "string", b: "%[qw]?\\[", e: "\\]", c: j, r: 10 },
          o = { cN: "string", b: "%[qw]?{", e: "}", c: j, r: 10 },
          p = { cN: "string", b: "%[qw]?<", e: ">", c: j, r: 10 },
          q = { cN: "string", b: "%[qw]?/", e: "/", c: j, r: 10 },
          r = { cN: "string", b: "%[qw]?%", e: "%", c: j, r: 10 },
          s = { cN: "string", b: "%[qw]?-", e: "-", c: j, r: 10 },
          t = { cN: "string", b: "%[qw]?\\|", e: "\\|", c: j, r: 10 },
          u = {
            cN: "function",
            b: "\\bdef\\s+",
            e: " |$|;",
            ...
            k: c,
            c: [
              { cN: "title", b: b, l: a, k: c },
              { cN: "params", b: "\\(", e: "\\)", l: a, k: c },
              e,
              g,
              h,
            ],
          },
          v = { cN: "identifier", b: a, l: a, k: c, r: 0 },
          w = [
            e,
            g,
            h,
        ...
        return (i.c = w), (u.c[1].c = w), { dM: { l: a, k: c, c: w } };
      })()),
      (f.LANGUAGES.diff = {
        cI: !0,
        dM: {
        ...
        dM: {
          ...
          c: [
            ...
            },
            {
              ...
              e: "\\(",
              k: { illuminate: 1, illuminance: 1, gather: 1 },
            },
          ],
        },
      }),
      ...
      (f.LANGUAGES.lua = (function () {
        var a = "\\[=*\\[",
          b = "\\]=*\\]",
          c = { b: a, e: b };
        c.c = [c];
        var d = { cN: "comment", b: "--(?!" + a + ")", e: "$" },
          e = { cN: "comment", b: "--" + a, e: b, c: [c], r: 10 };
        return {
          dM: {
            l: f.UIR,
            k: {
            ...
            c: [
              ...
              f.ASM,
              f.QSM,
              { cN: "string", b: a, e: b, c: [c], r: 10 },
            ],
          },
        };
      })()),
      (f.LANGUAGES.css = (function () {
        var a = {
          cN: "function",
          b: f.IR + "\\(",
          e: "\\)",
          c: [{ eW: !0, eE: !0, c: [f.NM, f.ASM, f.QSM] }],
        };
        return {
          cI: !0,
          dM: {
      ...
      (f.LANGUAGES.xml = (function () {
        var a = "[A-Za-z0-9\\._:-]+",
          b = {
            eW: !0,
            c: [
              { cN: "attribute", b: a, r: 0 },
              { b: '="', rB: !0, e: '"', c: [{ cN: "value", b: '"', eW: !0 }] },
              { b: "='", rB: !0, e: "'", c: [{ cN: "value", b: "'", eW: !0 }] },
              { b: "=", c: [{ cN: "value", b: "[^\\s/>]+" }] },
            ],
          };
          ...
          dM: {
            c: [
              ...
              { cN: "cdata", b: "<\\!\\[CDATA\\[", e: "\\]\\]>", r: 10 },
              {
                ...
                k: { title: { style: 1 } },
                c: [b],
                starts: { cN: "css", e: "</style>", rE: !0, sL: "css" },
              },
              {
                cN: "tag",
                b: "<script",
      ...
      (f.LANGUAGES.lisp = (function () {
        var a =
            "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#]*",
          b = "(\\-|\\+)?\\d+(\\.\\d+|\\/\\d+)?((d|e|f|l|s)(\\+|\\-)?\\d+)?",
          c = { cN: "literal", b: "\\b(t{1}|nil)\\b" },
          d = { cN: "number", b: b },
          e = { cN: "number", b: "#b[0-1]+(/[0-1]+)?" },
          g = { cN: "number", b: "#o[0-7]+(/[0-7]+)?" },
          h = { cN: "number", b: "#x[0-9a-f]+(/[0-9a-f]+)?" },
          i = { cN: "number", b: "#c\\(" + b + " +" + b, e: "\\)" },
          j = { cN: "string", b: '"', e: '"', c: [f.BE], r: 0 },
          k = { cN: "comment", b: ";", e: "$" },
          l = { cN: "variable", b: "\\*", e: "\\*" },
          m = { cN: "keyword", b: "[:&]" + a },
          n = { b: "\\(", e: "\\)" };
        ...
        return (
          (q.c = [{ cN: "title", b: a }, r]),
          (r.c = [o, p, q, c, d, e, g, h, i, j, k, l, m]),
          { cI: !0, dM: { i: "[^\\s]", c: [c, d, e, g, h, i, j, k, o, p, q] } }
        );
      })()),
      (f.LANGUAGES.profile = {
        dM: {
          c: [
            ...
            },
            {
              ...
              e: "$",
              k: { ncalls: 1, tottime: 10, cumtime: 10, filename: 1 },
              r: 10,
            },
            { cN: "summary", b: "function calls", e: "$", c: [f.CNM], r: 10 },
            f.ASM,
            f.QSM,
            {
              cN: "function",
      ...
      (f.LANGUAGES.php = {
        ...
        dM: {
          ...
          c: [
            ...
            { cN: "variable", b: "\\$[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*" },
            { cN: "preprocessor", b: "<\\?php", r: 10 },
            { cN: "preprocessor", b: "\\?>" },
          ],
        },
      }),
      (f.LANGUAGES.haskell = (function () {
        var a = { cN: "label", b: "\\b[A-Z][\\w']*", r: 0 },
          b = {
            cN: "container",
            b: "\\(",
            e: "\\)",
        ...
        return {
          dM: {
            ...
            c: [
              { cN: "comment", b: "--", e: "$" },
              { cN: "comment", b: "{-", e: "-}" },
              { cN: "string", b: "\\s+'", e: "'", c: [f.BE], r: 0 },
              f.QSM,
              {
                cN: "import",
                b: "\\bimport",
                e: "$",
                k: { import: 1, qualified: 1, as: 1, hiding: 1 },
                c: [b],
              },
              {
                cN: "module",
              ...
              {
                cN: "class",
                b: "\\b(class|instance|data|(new)?type)",
                e: "(where|$)",
                k: {
                  class: 1,
                  where: 1,
      ...
      (f.LANGUAGES["1c"] = (function () {
        var a = "[a-zA-Zа-яА-Я][a-zA-Z0-9_а-яА-Я]*",
          ...
          d = { cN: "dquote", b: '""' },
          e = { cN: "string", b: '"', e: '"|$', c: [d], r: 0 },
          g = { cN: "string", b: "\\|", e: '"|$', c: [d] };
        return {
          cI: !0,
          dM: {
            l: a,
            k: { keyword: b, built_in: c },
            c: [
              f.CLCM,
              f.NM,
              e,
              g,
              {
                ...
                e: "$",
                l: a,
                k: { процедура: 1, экспорт: 1, функция: 1 },
                c: [
                  { cN: "title", b: a },
                  {
                    cN: "tail",
      ...
      (f.LANGUAGES.python = (function () {
        var a = { cN: "string", b: "(u|b)?r?'''", e: "'''", r: 10 },
          b = { cN: "string", b: '(u|b)?r?"""', e: '"""', r: 10 },
          c = { cN: "string", b: "(u|r|ur|b|br)'", e: "'", c: [f.BE], r: 10 },
          d = { cN: "string", b: '(u|r|ur|b|br)"', e: '"', c: [f.BE], r: 10 },
          e = { cN: "title", b: f.UIR },
          g = {
            cN: "params",
            b: "\\(",
            e: "\\)",
            c: [a, b, c, d, f.ASM, f.QSM],
          };
        return {
          dM: {
            k: {
      ...
      (f.LANGUAGES.smalltalk = (function () {
        var a = "[a-z][a-zA-Z0-9_]*",
          b = { cN: "char", b: "\\$.{1}" },
          c = { cN: "symbol", b: "#" + f.UIR };
        return {
          dM: {
            k: { self: 1, super: 1, nil: 1, true: 1, false: 1, thisContext: 1 },
            c: [
              { cN: "comment", b: '"', e: '"', r: 0 },
              f.ASM,
              ...
              c,
              b,
              { cN: "localvars", b: "\\|\\s*((" + a + ")\\s*)+\\|" },
              { cN: "array", b: "\\#\\(", e: "\\)", c: [f.ASM, b, f.CNM, c] },
            ],
          },
        };
      })()),
      (f.LANGUAGES.tex = (function () {
        var a = { cN: "command", b: "\\\\[a-zA-Zа-яА-я]+[\\*]?", r: 10 },
          b = { cN: "command", b: "\\\\[^a-zA-Zа-яА-я0-9]", r: 0 },
          c = { cN: "special", b: "[{}\\[\\]\\&#~]", r: 0 };
        return {
          dM: {
            c: [
          ...
          c: [
            {
              cN: "operator",
              b:
                "(begin|start|commit|rollback|savepoint|lock|alter|create|drop|rename|call|delete|do|handler|insert|load|replace|select|truncate|update|set|show|pragma)\\b",
              e: ";|$",
              k: {
                keyword: {
                  all: 1,
          ...
          c: [
            {
              ...
              c: [
                ...
                { cN: "title", b: f.UIR, e: f.IMMEDIATE_RE },
              ],
            },
            f.CLCM,
            f.CBLCLM,
            ...
            { cN: "constant", b: " [A-Z_]+ ", e: f.IMMEDIATE_RE, r: 0 },
          ],
        },
      }),
      (f.LANGUAGES.ini = {
              ...
              c: [
                {
                  cN: "value",
                  eW: !0,
                  k: { on: 1, off: 1, true: 1, false: 1, yes: 1, no: 1 },
                  c: [f.QSM, f.NM],
                },
              ],
            },
      ...
      (f.LANGUAGES.perl = (function () {
        var a = {
          ...
          h = [
            ...
            d,
            f.HCM,
            { cN: "comment", b: "^(__END__|__DATA__)", e: "\\n$", r: 5 },
            g,
            { cN: "string", b: "q[qwxr]?\\s*\\(", e: "\\)", c: e, r: 5 },
            { cN: "string", b: "q[qwxr]?\\s*\\[", e: "\\]", c: e, r: 5 },
            { cN: "string", b: "q[qwxr]?\\s*\\{", e: "\\}", c: e, r: 5 },
            { cN: "string", b: "q[qwxr]?\\s*\\|", e: "\\|", c: e, r: 5 },
            { cN: "string", b: "q[qwxr]?\\s*\\<", e: "\\>", c: e, r: 5 },
            { cN: "string", b: "qw\\s+q", e: "q", c: e, r: 5 },
            { cN: "string", b: "'", e: "'", c: [f.BE], r: 0 },
            { cN: "string", b: '"', e: '"', c: e, r: 0 },
            { cN: "string", b: "`", e: "`", c: [f.BE] },
            { cN: "string", b: "{\\w+}", r: 0 },
            { cN: "string", b: "-?\\w+\\s*\\=\\>", r: 0 },
            {
        ...
        return (b.c = h), (g.c[1].c = h), { dM: { k: a, c: h } };
      })()),
      (f.LANGUAGES.scala = (function () {
        var a = { cN: "annotation", b: "@[A-Za-z]+" },
          b = { cN: "string", b: 'u?r?"""', e: '"""', r: 10 };
        return {
          dM: {
            k: {
              type: 1,
            ...
            c: [
              ...
              b,
              {
                ...
                e: "({|$)",
                i: ":",
                k: { case: 1, class: 1, trait: 1, object: 1 },
                c: [
                  { b: "(extends|with)", k: { extends: 1, with: 1 }, r: 10 },
                  { cN: "title", b: f.UIR },
                  { cN: "params", b: "\\(", e: "\\)", c: [f.ASM, f.QSM, b, a] },
                ],
              },
              f.CNM,
              a,
      ...
      (f.LANGUAGES.cmake = {
        ...
        dM: {
          ...
          c: [{ cN: "envvar", b: "\\${", e: "}" }, f.HCM, f.QSM, f.NM],
        },
      }),
      (f.LANGUAGES.objectivec = (function () {
        var a = {
          keyword: {
            false: 1,
            int: 1,
          ...
          dM: {
            ...
            c: [
              ...
              { cN: "preprocessor", b: "#", e: "$" },
              {
                ...
                e: "({|$)",
                k: { interface: 1, class: 1, protocol: 5, implementation: 5 },
                c: [{ cN: "id", b: f.UIR }],
              },
            ],
          },
      ...
      (f.LANGUAGES.nginx = (function () {
        var a = { cN: "variable", b: "\\$\\d+" },
          b = { cN: "variable", b: "\\${", e: "}" },
          c = { cN: "variable", b: "[\\$\\@]" + f.UIR };
        return {
          dM: {
            c: [
              f.HCM,
                ...
                c: [
                  f.HCM,
                  {
                    ...
                    c: [
                      ...
                      { cN: "number", b: "\\s\\d+[kKmMgGdshdwy]*\\b", r: 0 },
                      a,
                      b,
                      c,
                    ],
      ...
      (f.LANGUAGES.erlang_repl = {
        dM: {
          k: {
            special_functions: { spawn: 10, spawn_link: 10, self: 2 },
            reserved: {
              after: 1,
              and: 1,
              andalso: 5,
      ...
      (f.LANGUAGES.django = (function () {
        function a(a, b) {
          return b == undefined || (!a.cN && b.cN == "tag") || a.cN == "value";
        }
        function b(c, e) {
          var f = {};
          for (var g in c) {
            g != "contains" && (f[g] = c[g]);
            var h = [];
            for (var i = 0; c.c && i < c.c.length; i++) h.push(b(c.c[i], c));
            a(c, e) && (h = d.concat(h)), h.length && (f.c = h);
          }
          return f;
        }
        var c = {
        ...
        return { cI: !0, dM: b(f.LANGUAGES.xml.dM) };
      })()),
      (f.LANGUAGES.delphi = (function () {
        var a = {
            and: 1,
            safecall: 1,
            cdecl: 1,
          ...
          c = { cN: "comment", b: "{", e: "}", r: 0 },
          d = { cN: "comment", b: "\\(\\*", e: "\\*\\)", r: 10 },
          e = { cN: "string", b: "'", e: "'", c: [{ b: "''" }], r: 0 },
          g = { cN: "string", b: "(#\\d+)+" },
          h = {
            cN: "function",
            b: "(procedure|constructor|destructor|function)\\b",
            e: "[:;]",
            k: { function: 1, constructor: 10, destructor: 10, procedure: 10 },
            c: [
              { cN: "title", b: f.IR },
              { cN: "params", b: "\\(", e: "\\)", k: a, c: [e, g] },
              c,
              d,
            ],
          };
      ...
      (f.LANGUAGES.go = (function () {
        var a = {
          ...
          constant: { true: 1, false: 1, iota: 1, nil: 1 },
          typename: {
            bool: 1,
            byte: 1,
            complex64: 1,
  ...
  require.define("/remark/resources.js", function (a, b, c, d, e) {
    b.exports = {
      documentStyles:
  ...
  require.define("/remark/slideshow.js", function (a, b, c, d, e) {
    ...
    h.create = function (a, b) {
      ...
      (d.className = "position"), b.appendChild(d), m(b);
        ...
        var b = i * k,
          ...
          d = function () {
            var d = window.innerHeight,
              e = window.innerWidth,
              f;
            e / k > d / j ? (f = d / (i * j)) : (f = e / (i * k)),
              (a.style["-webkit-transform"] = "scale(" + f + ")"),
              (a.style.MozTransform = "scale(" + f + ")"),
              (a.style.left = (e - b * f) / 2 + "px"),
              (a.style.top = (d - c * f) / 2 + "px");
          };
        (a.style.width = i * k + "px"),
          (a.style.height = i * j + "px"),
          (window.onresize = d),
          window.onresize();
      };
  }),
  require.define("/remark/slide.js", function (a, b, c, d, e) {
    var f = a("./converter"),
      g = a("./highlighter"),
      h = (b.exports = {});
    h.create = function (a) {
    ...
    var i = function (a) {
      ...
      j = function (a) {
        f.convertContentClasses(a),
          ...
          g.highlightCodeBlocks(a);
      };
  }),
  require.define("/remark.js", function (a, b, c, d, e) {
    var f = a("./remark/api"),
      g = a("./remark/controller"),
      h = a("./remark/converter"),
    ...
    var m = function (a, b) {
      ...
      o = function (a, b) {
        var c = a.innerHTML,
          d;
        (d = k.create(c, b)), g.create(d), i.create();
      };
  }),
  require("/remark.js");

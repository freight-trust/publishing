...
})(
  {
      ...
      function (e, l) {
        ...
        (s.prototype = new t()),
          (s.prototype.init = function () {
            var e = this;
            return (
              this.setPageOrientation(r),
              window.matchMedia
                ? (window.matchMedia("print").addListener(function (l) {
                    e.onPrint(l);
                  }),
                  void 0)
                : !1
          ...
          (s.prototype.onPrint = function (e) {
            e.matches &&
              this.emit("print", {
          ...
          (s.prototype.setPageOrientation = function (e) {
            if (e === o) (this._pageHeight = h), (this._pageWidth = i);
            else {
              if (e !== r) throw new Error("Unknown print orientation: " + e);
              (this._pageHeight = i), (this._pageWidth = h);
            }
            (this._orientation = e),
              a.setPageSize(this._pageWidth + "px " + this._pageHeight + "px");
          }),
          (l.exports = new s());
      },
      ...
      function (e, l) {
        function s(e, l) {
          ...
          (s.slide = e),
            ...
            (s.element.className = "remark-slide-number"),
            (s.element.innerHTML = t(s.slide, s.slideshow));
        }
        function t(e, l) {
          var s = l.getSlideNumberFormat(),
            t = l.getSlides(),
            r = a(e, l),
            o = a(t[t.length - 1], l);
          return "function" == typeof s
            ? s.call(l, r, o)
            : s.replace("%current%", r).replace("%total%", o);
        }
        function a(e, l) {
          var s,
            t = l.getSlides(),
            a = 0;
          for (s = 0; s <= e.getSlideIndex() && s < t.length; ++s)
            "false" !== t[s].properties.count && (a += 1);
          return Math.max(1, a);
        }
        l.exports = s;
      },
        ...
        (s.nextTick = (function () {
          ...
          if (l) {
            ...
            return (
              ...
              function (e) {
                s.push(e), window.postMessage("process-tick", "*");
              }
            );
          }
          return function (e) {
    ...
    1: [
      function (e, l, s) {
        !(function (e) {
          function l(e, l) {
            if (e.indexOf) return e.indexOf(l);
            for (var s = 0; s < e.length; s++) if (l === e[s]) return s;
            return -1;
          }
          e.EventEmitter || (e.EventEmitter = function () {});
          var t = (s.EventEmitter = e.EventEmitter),
            a =
          ...
          (t.prototype.setMaxListeners = function (e) {
            ...
            (t.prototype.addListener = function (e, l) {
              if ("function" != typeof l)
                throw new Error("addListener only takes instances of Function");
              if (
                (this._events || (this._events = {}),
                this.emit("newListener", e, l),
                this._events[e])
              )
                if (a(this._events[e])) {
                  ...
                  this._events[e].push(l);
                } else this._events[e] = [this._events[e], l];
              else this._events[e] = l;
              return this;
            }),
            (t.prototype.on = t.prototype.addListener),
            (t.prototype.once = function (e, l) {
              var s = this;
              return (
                s.on(e, function t() {
                  s.removeListener(e, t), l.apply(this, arguments);
                }),
                this
              );
            }),
            (t.prototype.removeListener = function (e, s) {
              ...
              if (a(t)) {
                var r = l(t, s);
                if (0 > r) return this;
                t.splice(r, 1), 0 == t.length && delete this._events[e];
              } else this._events[e] === s && delete this._events[e];
              return this;
            }),
    ...
    3: [
      function (e) {
        var l = e("./remark/api"),
          s = e("./polyfills"),
          t = e("components/styler");
        (window.remark = new l()), s.apply(), t.styleDocument();
      },
    ...
    5: [
      function (e, l, s) {
        ...
        s.apply = function () {
          t([Array, window.NodeList, window.HTMLCollection], a);
        };
      },
      {},
    ],
      ...
      function (e, l) {
        function s() {
          ...
          if (!a()) {
            (e = document.getElementsByTagName("head")[0]),
              ...
              (l.type = "text/css"),
              (l.title = "remark"),
              (l.innerHTML = o.documentStyles);
            for (s in i.styles)
              i.styles.hasOwnProperty(s) &&
                (l.innerHTML = l.innerHTML + i.styles[s]);
        ...
        function r(e) {
          var l,
            s = e.cssRules.length;
          for (l = 0; s > l; ++l)
            if (e.cssRules[l] instanceof window.CSSPageRule)
              return e.cssRules[l];
        }
        var o = e("../../resources"),
          i = e("../../highlighter");
        l.exports = { styleDocument: s, setPageSize: t };
      },
          ...
          (s.events = e),
            ...
            e.on("resetTimer", function () {
              (s.startTime = null),
                (s.pauseStart = null),
                (s.pauseLength = 0),
                (s.element.innerHTML = "0:00:00");
            }),
            e.on("pause", function () {
              s.pauseStart = new Date();
            }),
            e.on("resume", function () {
              (s.pauseLength += new Date() - s.pauseStart),
                (s.pauseStart = null);
            });
        }
        e("../../utils"),
          (l.exports = s),
          (s.prototype.updateTimer = function () {
            var e = this;
            if (e.startTime) {
              var l;
              l = e.pauseStart
    ...
    8: [
      function (e, l, s) {
        (s.addClass = function (e, l) {
          e.className = s.getClasses(e).concat([l]).join(" ");
        }),
          (s.removeClass = function (e, l) {
            e.className = s
              .getClasses(e)
              .filter(function (e) {
                return e !== l;
          ...
          (s.toggleClass = function (e, l) {
            var t = s.getClasses(e),
              a = t.indexOf(l);
            -1 !== a ? t.splice(a, 1) : t.push(l), (e.className = t.join(" "));
          }),
          ...
          (s.hasClass = function (e, l) {
            return -1 !== s.getClasses(e).indexOf(l);
          }),
          (s.getPrefixedProperty = function (e, l) {
            var s = l[0].toUpperCase() + l.slice(1);
            return e[l] || e["moz" + s] || e["webkit" + s];
          });
      },
      {},
    ],
            ...
            var e = (function () {
                ...
                return (
                  (function (l) {
                        ...
                        (function t(e, a) {
                          for (var r = e.firstChild; r; r = r.nextSibling)
                            3 == r.nodeType
                              ...
                              : 1 == r.nodeType &&
                                (l.push({ event: "start", offset: a, node: r }),
                                (a = t(r, a)),
                                s(r).match(/br|hr|img|input/) ||
                                  l.push({
                                    event: "stop",
                                    offset: a,
                                    node: r,
                    ...
                    function i(e, t, a) {
                      ...
                      function o(e) {
                        function t(e) {
                          return " " + e.nodeName + '="' + l(e.value) + '"';
                        }
                        j +=
                          "<" +
                          s(e) +
                          Array.prototype.map.call(e.attributes, t).join("") +
                          ">";
                      }
                      function i(e) {
                        j += "</" + s(e) + ">";
                      ...
                      function h(e) {
                        ("start" == e.event ? o : i)(e.node);
                      }
                      for (var n = 0, j = "", c = []; e.length || t.length; ) {
                        var d = r();
                        if (
                          ((j += l(a.substr(n, d[0].offset - n))),
                          (n = d[0].offset),
                          d == e)
                        ) {
                          c.reverse().forEach(i);
                          do h(d.splice(0, 1)[0]), (d = r());
                          while (d == e && d.length && d[0].offset == n);
                          c.reverse().forEach(o);
                        } else
                          "start" == d[0].event ? c.push(d[0].node) : c.pop(),
                            h(d.splice(0, 1)[0]);
                      }
                      return j + l(a.substr(n));
                    }
                    function h(e) {
                      function l(e) {
                        return (e && e.source) || e;
                      ...
                      function t(a, o) {
                        if (!a.compiled) {
                          if (
                            ...
                            var i = {},
                              h = function (l, s) {
                                e.case_insensitive && (s = s.toLowerCase()),
                                  s.split(" ").forEach(function (e) {
                                    var s = e.split("|");
                                    i[s[0]] = [l, s[1] ? Number(s[1]) : 1];
                                  });
                              };
                            "string" == typeof a.keywords
                              ? h("keyword", a.keywords)
                              : Object.keys(a.keywords).forEach(function (e) {
                                  h(e, a.keywords[e]);
                                }),
                              (a.keywords = i);
                          }
                          (a.lexemesRe = s(a.lexemes || /\b\w+\b/, !0)),
                            o &&
                              (a.beginKeywords &&
                                (a.begin =
                                  "\\b(" +
                              ...
                              a.end && (a.endRe = s(a.end)),
                              (a.terminator_end = l(a.end) || ""),
                              a.endsWithParent &&
                                o.terminator_end &&
                                (a.terminator_end +=
                                  (a.end ? "|" : "") + o.terminator_end)),
                            a.illegal && (a.illegalRe = s(a.illegal)),
                            void 0 === a.relevance && (a.relevance = 1),
                            a.contains || (a.contains = []);
                          var n = [];
                          a.contains.forEach(function (e) {
                            e.variants
                              ? e.variants.forEach(function (l) {
                                  n.push(r(e, l));
                                })
                              : n.push("self" == e ? a : e);
                          }),
                    ...
                    function n(e, s, a, r) {
                      function o(e, l) {
                        for (var s = 0; s < l.contains.length; s++)
                          if (t(l.contains[s].beginRe, e)) return l.contains[s];
                      }
                      function i(e, l) {
                        if (t(e.endRe, l)) {
                        ...
                        return e.endsWithParent ? i(e.parent, l) : void 0;
                      }
                      function c(e, l) {
                        return !a && t(l.illegalRe, e);
                      }
                      function d(e, l) {
                        var s = v.case_insensitive ? l[0].toLowerCase() : l[0];
                        return e.keywords.hasOwnProperty(s) && e.keywords[s];
                      }
                      function u(e, l, s, t) {
                        var a = t ? "" : y.classPrefix,
                          r = '<span class="' + a,
                          o = s ? "" : "</span>";
                        return (r += e + '">'), r + l + o;
                      }
                      function m() {
                        if (!x.keywords) return l(S);
                        var e = "",
                          s = 0;
                        x.lexemesRe.lastIndex = 0;
                        for (var t = x.lexemesRe.exec(S); t; ) {
                          e += l(S.substr(s, t.index - s));
                          var a = d(x, t);
                          a
                            ? ((z += a[1]), (e += u(a[0], l(t[0]))))
                            : (e += l(t[0])),
                            (s = x.lexemesRe.lastIndex),
                            (t = x.lexemesRe.exec(S));
                        }
                        return e + l(S.substr(s));
                      }
                      function g() {
                        if (x.subLanguage && !w[x.subLanguage]) return l(S);
                        var e = x.subLanguage
                          ? n(x.subLanguage, S, !0, E[x.subLanguage])
                          : j(S);
                        return (
                          x.relevance > 0 && (z += e.relevance),
                          "continuous" == x.subLanguageMode &&
                            (E[x.subLanguage] = e.top),
                          u(e.language, e.value, !1, !0)
                        );
                      }
                      function p() {
                        return void 0 !== x.subLanguage ? g() : m();
                      }
                      function b(e, s) {
                        var t = e.className ? u(e.className, "", !0) : "";
                        e.returnBegin
                          ? ((N += t), (S = ""))
                          : e.excludeBegin
                          ? ((N += l(s) + t), (S = ""))
                      ...
                      function f(e, s) {
                        if (((S += e), void 0 === s)) return (N += p()), 0;
                        var t = o(s, x);
                        if (t)
                          return (
                            (N += p()), b(t, s), t.returnBegin ? 0 : s.length
                          );
                        var a = i(x, s);
                        if (a) {
                          var r = x;
                          r.returnEnd || r.excludeEnd || (S += s), (N += p());
                          do
                            x.className && (N += "</span>"),
                              (z += x.relevance),
                              (x = x.parent);
                      ...
                      var _,
                        ...
                        E = {},
                        N = "";
                      for (_ = x; _ != v; _ = _.parent)
                        _.className && (N = u(_.className, "", !0) + N);
                      var S = "",
                        z = 0;
                      try {
                        for (var M, C, O = 0; ; ) {
                          if (
                            ((x.terminators.lastIndex = O),
                            (M = x.terminators.exec(s)),
                            !M)
                          )
                            break;
                          (C = f(s.substr(O, M.index - O), M[0])),
                            (O = M.index + C);
                        }
                        for (f(s.substr(O)), _ = x; _.parent; _ = _.parent)
                          _.className && (N += "</span>");
                        return { relevance: z, value: N, language: e, top: x };
                      } catch (T) {
                        if (-1 != T.message.indexOf("Illegal"))
                          return { relevance: 0, value: l(s) };
                        throw T;
                      }
                    }
                    function j(e, s) {
                      s = s || y.languages || Object.keys(w);
                      ...
                      return (
                        s.forEach(function (l) {
                          if (k(l)) {
                            var s = n(l, e, !1);
                            (s.language = l),
                              s.relevance > a.relevance && (a = s),
                              s.relevance > t.relevance && ((a = t), (t = s));
                          }
                        }),
                        a.language && (t.second_best = a),
                        t
                      );
                    }
                    function c(e) {
                      return (
                        y.tabReplace &&
                          (e = e.replace(/^((<[^>]+>|\t)+)/gm, function (e, l) {
                            return l.replace(/\t/g, y.tabReplace);
                          })),
                        y.useBR && (e = e.replace(/\n/g, "<br>")),
                        e
                      );
                    ...
                    function d(e, l, s) {
                      ...
                      return (
                        ...
                        -1 === e.indexOf(t) && a.push(t),
                        a.join(" ").trim()
                      );
                    }
                    function u(e) {
                      var l = a(e);
                      if (!/no(-?)highlight|plain|text/.test(l)) {
                        var s;
                        y.useBR
                        ...
                        if (h.length) {
                          ...
                          (u.innerHTML = r.value), (r.value = i(h, o(u), t));
                        }
                        (r.value = c(r.value)),
                          (e.innerHTML = r.value),
                    ...
                    return (
                      ...
                      (e.COMMENT = function (l, s, t) {
                        ...
                        return a.contains.push(e.PHRASAL_WORDS_MODE), a;
                      }),
              ...
              s = [
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l =
                      ...
                      t = { className: "yardoctag", begin: "@[A-Za-z]+" },
                      a = { className: "value", begin: "#<", end: ">" },
                      r = [
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l =
                      ...
                      a = { className: "number", begin: t, relevance: 0 };
                    return {
                      aliases: ["jsp"],
                      keywords: s,
                      illegal: /<\//,
                      contains: [
                        ...
                        { beginKeywords: "new throw return", relevance: 0 },
                        {
                          className: "function",
                          begin:
                            "(" +
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l = {
                      ...
                      s = { className: "preprocessor", begin: /<\?(php)?|\?>/ },
                      t = {
                        className: "string",
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l =
                      ...
                      r = e.COMMENT("^(__END__|__DATA__)", "\\n$", {
                        relevance: 5,
                      }),
                      o = [e.BACKSLASH_ESCAPE, s, a],
                      i = [
                        a,
                        e.HASH_COMMENT_MODE,
                        r,
                    ...
                    return (
                      (s.contains = i),
                      (t.contains = i),
                      { aliases: ["pl"], keywords: l, contains: i }
                    );
                  },
                },
                {
                    ...
                    return {
                      ...
                      contains: [
                        ...
                        e.C_NUMBER_MODE,
                        {
                          ...
                          keywords:
                            "if else elif endif define undef warning error line pragma",
                          contains: [
                            { begin: /\\\n/, relevance: 0 },
                            {
                              begin: 'include\\s*[<"]',
                ...
                },
                {
                  ...
                  create: function (e) {
                    ...
                    return {
                      ...
                      contains: [e.HASH_COMMENT_MODE, e.NUMBER_MODE, t, a, s],
                    };
                  },
                },
                {
                  ...
                  create: function (e) {
                    var l = "[A-Za-z0-9\\._:-]+",
                      ...
                      t = {
                        ...
                        contains: [
                          s,
                          { className: "attribute", begin: l, relevance: 0 },
                          {
                            begin: "=",
                            relevance: 0,
                            contains: [
                  ...
                  create: function (e) {
                    ...
                    return {
                      ...
                      contains: [
                        ...
                        { className: "tag", begin: l, relevance: 0 },
                        {
                          className: "rules",
                          begin: "{",
                          end: "}",
                ...
                },
                {
                  name: "scala",
                  create: function (e) {
                    var l = { className: "annotation", begin: "@[A-Za-z]+" },
                      s = {
                        className: "string",
                        begin: 'u?r?"""',
                        end: '"""',
                      ...
                      t = { className: "symbol", begin: "'\\w[\\w\\d_]*(?!')" },
                      a = {
                        className: "type",
                ...
                },
                {
                  ...
                  create: function (e) {
                    ...
                    t.contains = a;
                    var r = e.inherit(e.TITLE_MODE, { begin: s }),
                      o = "(\\(.*\\))?\\s*\\B[-=]>",
                      i = {
                        className: "params",
                        begin: "\\([^\\(]",
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l =
                      ...
                      h = e.COMMENT(";", "$", { relevance: 0 }),
                      n = { className: "variable", begin: "\\*", end: "\\*" },
                      j = { className: "keyword", begin: "[:&]" + l },
                      c = { begin: l, relevance: 0 },
                      d = { begin: s },
                      u = {
                        begin: "\\(",
                        end: "\\)",
                        contains: ["self", r, i, o, c],
                      },
                      m = {
                        className: "quoted",
                        contains: [o, i, n, j, u, c],
                        variants: [
                          { begin: "['`]\\(", end: "\\)" },
                          { begin: "\\(quote ", end: "\\)", keywords: "quote" },
                          { begin: "'" + s },
                        ],
                      },
                      g = {
                      ...
                      p = { className: "list", begin: "\\(\\s*", end: "\\)" },
                      b = { endsWithParent: !0, relevance: 0 };
                    return (
                      (p.contains = [
                        {
                          className: "keyword",
                          variants: [{ begin: l }, { begin: s }],
                        },
                        b,
                      ]),
                      (b.contains = [m, g, p, r, o, i, h, n, j, d, c]),
                      { illegal: /\S/, contains: [o, a, r, i, h, m, g, p, c] }
                    );
                  },
                },
                {
                  ...
                  create: function (e) {
                    var l = {
                      ...
                      o = { className: "number", begin: a, relevance: 0 },
                      i = e.inherit(e.QUOTE_STRING_MODE, { illegal: null }),
                      h = e.COMMENT(";", "$", { relevance: 0 }),
                      n = {
                        className: "literal",
                      ...
                      c = { className: "comment", begin: "\\^" + t },
                      d = e.COMMENT("\\^\\{", "\\}"),
                      u = { className: "attribute", begin: "[:]" + t },
                      m = { className: "list", begin: "\\(", end: "\\)" },
                      ...
                      b = [m, i, c, d, h, u, j, o, n, r];
                    return (
                      (m.contains = [e.COMMENT("comment", ""), p, g]),
                      (g.contains = b),
                      (j.contains = b),
                      {
                        aliases: ["clj"],
                        illegal: /\S/,
                        contains: [m, i, c, d, h, u, j, o, n],
                      }
                    );
                  },
                },
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l = [
                      ...
                      s = { className: "pragma", begin: "{-#", end: "#-}" },
                      t = { className: "preprocessor", begin: "^#", end: "$" },
                      a = {
                        className: "type",
                        begin: "\\b[A-Z][\\w']*",
                        relevance: 0,
                    ...
                    return {
                      ...
                      contains: [
                        ...
                        },
                        {
                          ...
                          contains: [e.C_NUMBER_MODE].concat(l),
                        },
                        {
                          className: "foreign",
                          begin: "\\bforeign\\b",
                          ...
                          contains: [a, e.QUOTE_STRING_MODE].concat(l),
                        },
                        {
                          className: "shebang",
    ...
    4: [
      function (e, l) {
        ...
        function t(e, l) {
          var s;
          if (((l = l || {}), l.hasOwnProperty("sourceUrl"))) {
            var t = new e.XMLHttpRequest();
            t.open("GET", l.sourceUrl, !1),
              t.send(),
              (l.source = t.responseText.replace(/\r\n/g, "\n"));
          } else
            l.hasOwnProperty("source") ||
              ((s = e.getElementById("source")),
              s && ((l.source = a(s.innerHTML)), (s.style.display = "none")));
          return (
            l.container instanceof window.HTMLElement ||
              (l.container = e.getBodyElement()),
            l
          );
        }
        function a(e) {
        ...
        var r = e("events").EventEmitter,
          ...
          h = e("./resources"),
          n = e("./parser"),
          j = e("./models/slideshow"),
          c = e("./views/slideshowView"),
          d = e("./controllers/defaultController"),
          u = e("./dom"),
          m = e("./macros");
        (l.exports = s),
          (s.prototype.highlighter = o),
          (s.prototype.convert = function (e) {
            var l = new n(),
              s = l.parse(e || "", m)[0].content;
            return i.convertMarkdown(s, {}, !0);
          }),
          (s.prototype.create = function (e) {
            ...
            return (
              ...
              l.setMaxListeners(0),
              (s = new j(l, e)),
              (a = new c(l, this.dom, e.container, s)),
              (o = e.controller || new d(l, this.dom, a, e.navigation)),
              s
            );
          });
      },
    ...
    14: [
      function (e, l) {
        function s() {}
        (l.exports = s),
          (s.prototype.XMLHttpRequest = XMLHttpRequest),
          (s.prototype.getHTMLElement = function () {
            return document.getElementsByTagName("html")[0];
          }),
          (s.prototype.getBodyElement = function () {
            return document.body;
          }),
          (s.prototype.getElementById = function (e) {
            return document.getElementById(e);
          }),
          (s.prototype.getLocationHash = function () {
            return window.location.hash;
          }),
          (s.prototype.setLocationHash = function (e) {
    ...
    10: [
      function (e, l) {
        !(function () {
          ...
          function r(e, l) {
            var s = e.content;
            void 0 !== e.notes && (s = e.notes);
            var t = s.length - 1;
            "string" == typeof s[t] && "string" == typeof l
              ? (s[t] += l)
              : s.push(l);
          }
          function o(e, l) {
            for (
              ...
              (e = e.substr(0, s.index) + e.substr(s.index + s[0].length)),
                void 0 !== s[1]
                  ? (l[s[1].trim()] = s[2].trim())
                  : (l[s[3].trim()] = s[4].trim()),
                (t.lastIndex = s.index);
          ...
          function i(e) {
            var l = function (e, l) {
                for (var s, t = []; null !== (s = l.exec(e)); ) t.push(s[1]);
                return t;
              },
              s = /^([ \t]*)[^ \t\n]/gm,
              t = l(e, s).map(function (e) {
                return e.length;
              }),
          ...
          var h = e("./lexer");
          (l.exports = s),
            (s.prototype.parse = function (e, l) {
              var s = this,
                n = new h(),
                j = n.lex(i(e)),
                c = [],
              ...
              return (
                ...
                j.forEach(function (e) {
                  switch (e.type) {
                    ...
                    case "code":
                    case "fences":
                      r(d[d.length - 1], e.text);
                      break;
                    case "def":
                      d[0].links[e.id] = { href: e.href, title: e.title };
                      break;
                    case "macro":
                      var o = l[e.name];
                      ...
                      var i = o.apply(e.obj, e.args);
                      "string" == typeof i
                        ? ((i = s.parse(i, l)),
                          r(d[d.length - 1], i[0].content[0]))
                        : r(d[d.length - 1], void 0 === i ? "" : i.toString());
                      break;
                    case "content_start":
                      d.push(a(e));
                      break;
                    case "content_end":
                      r(d[d.length - 2], d[d.length - 1]), d.pop();
                      break;
                    case "separator":
                      c.push(d[0]),
                        (d = [t()]),
                        (d[0].properties.continued = (
                          "--" === e.text
                        ).toString());
                      break;
                ...
                c.forEach(function (e) {
                  e.content[0] = o(e.content[0] || "", e.properties);
                }),
                c.filter(function (e) {
                  var l = (e.properties.exclude || "").toLowerCase();
                  return "true" === l ? !1 : !0;
                })
              );
            });
    ...
    13: [
      function (e, l) {
        !(function () {
          ...
          function t(e, l, s) {
            e.on("pause", function () {
              a.unregister(e), r.unregister(e), o.unregister(e);
            }),
              e.on("resume", function () {
                a.register(e), r.register(e, s), o.register(e, s);
              });
          }
          l.exports = s;
          var a = e("./inputs/keyboard"),
            r = e("./inputs/mouse"),
            o = e("./inputs/touch"),
            i = e("./inputs/message"),
            h = e("./inputs/location");
      ...
      function (e, l) {
        function s(e, l, s, a) {
          ...
          (r.events = e),
            ...
            (r.scaler = new h(e, a)),
            (r.slideViews = []),
            r.configureContainerElement(s),
            r.configureChildElements(),
            r.updateDimensions(),
            r.scaleElements(),
            r.updateSlideViews(),
            (r.timer = new o(e, r.timerElement)),
            ...
            e.on("forcePresenterMode", function () {
              j.hasClass(r.containerElement, "remark-presenter-mode") ||
                (j.toggleClass(r.containerElement, "remark-presenter-mode"),
                r.scaleElements(),
                c.setPageOrientation("landscape"));
            }),
            e.on("togglePresenterMode", function () {
              j.toggleClass(r.containerElement, "remark-presenter-mode"),
                ...
                e.emit(
                  "toggledPresenter",
                  r.slideshow.getCurrentSlideIndex() + 1
                ),
                j.hasClass(r.containerElement, "remark-presenter-mode")
                  ? c.setPageOrientation("portrait")
                  : c.setPageOrientation("landscape");
            }),
            e.on("toggleHelp", function () {
              j.toggleClass(r.containerElement, "remark-help-mode");
            }),
            e.on("toggleBlackout", function () {
              j.toggleClass(r.containerElement, "remark-blackout-mode");
            }),
            e.on("toggleMirrored", function () {
              j.toggleClass(r.containerElement, "remark-mirrored-mode");
            }),
            e.on("hideOverlay", function () {
              j.removeClass(r.containerElement, "remark-blackout-mode"),
                j.removeClass(r.containerElement, "remark-help-mode");
            }),
            e.on("pause", function () {
              j.toggleClass(r.containerElement, "remark-pause-mode");
            }),
            e.on("resume", function () {
              j.toggleClass(r.containerElement, "remark-pause-mode");
            }),
        ...
        function t(e) {
          var l = j.getPrefixedProperty(
              e.containerElement,
              "requestFullScreen"
            ),
            s = j.getPrefixedProperty(document, "cancelFullScreen");
          e.events.on("toggleFullscreen", function () {
            var t =
              j.getPrefixedProperty(document, "fullscreenElement") ||
              j.getPrefixedProperty(document, "fullScreenElement");
            !t && l
              ? l.call(e.containerElement, Element.ALLOW_KEYBOARD_INPUT)
              : s && s.call(document),
              e.scaleElements();
          });
        }
        function a(e, l, s) {
          s.forEach(function (s) {
            l.addEventListener(s, function () {
              ...
              e.emit.apply(e, [s].concat(l));
            });
          });
        }
        var r = e("./slideView"),
          o = e("components/timer"),
          i = e("./notesView"),
          h = e("../scaler"),
          n = e("../resources"),
          j = e("../utils"),
          c = e("components/printing");
        (l.exports = s),
          (s.prototype.isEmbedded = function () {
            return this.containerElement !== this.dom.getBodyElement();
          }),
          (s.prototype.configureContainerElement = function (e) {
            var l = this;
            (l.containerElement = e),
              j.addClass(e, "remark-container"),
              e === l.dom.getBodyElement()
                ? (j.addClass(l.dom.getHTMLElement(), "remark-container"),
                  a(l.events, window, [
                    "hashchange",
                    "resize",
                    "keydown",
              ...
              l.events.on("tap", function (e) {
                e < l.containerElement.clientWidth / 2
                  ? l.slideshow.gotoPreviousSlide()
                  : l.slideshow.gotoNextSlide();
              });
          }),
          (s.prototype.configureChildElements = function () {
            function e() {
              s.scaleElements();
            }
            function l(e) {
              var l;
              (l = e.isPortrait ? 0.4 * e.pageHeight : e.pageHeight),
                s.slideViews.forEach(function (s) {
                  s.scale({ clientWidth: e.pageWidth, clientHeight: l }),
                    e.isPortrait &&
                      ((s.scalingElement.style.top = "20px"),
                      (s.notesElement.style.top = l + 40 + "px"));
                });
            }
            var s = this;
            (s.containerElement.innerHTML += n.containerLayout),
              (s.elementArea = s.containerElement.getElementsByClassName(
                "remark-slides-area"
              )[0]),
              (s.previewArea = s.containerElement.getElementsByClassName(
                "remark-preview-area"
              )[0]),
              (s.notesArea = s.containerElement.getElementsByClassName(
                "remark-notes-area"
              )[0]),
              (s.notesView = new i(s.events, s.notesArea, function () {
                return s.slideViews;
              })),
              (s.backdropElement = s.containerElement.getElementsByClassName(
                "remark-backdrop"
              )[0]),
              (s.helpElement = s.containerElement.getElementsByClassName(
                "remark-help"
              )[0]),
              (s.timerElement = s.notesArea.getElementsByClassName(
                "remark-toolbar-timer"
              )[0]),
              (s.pauseElement = s.containerElement.getElementsByClassName(
                "remark-pause"
              )[0]),
              s.events.on("propertiesChanged", function (e) {
                e.hasOwnProperty("ratio") && s.updateDimensions();
              }),
              s.events.on("resize", e),
              c.init(),
              c.on("print", l);
          }),
          (s.prototype.updateSlideViews = function () {
            var e = this;
            e.slideViews.forEach(function (l) {
              e.elementArea.removeChild(l.containerElement);
            }),
              (e.slideViews = e.slideshow.getSlides().map(function (l) {
                return new r(e.events, e.slideshow, e.scaler, l);
              })),
              e.slideViews.forEach(function (l) {
                e.elementArea.appendChild(l.containerElement);
              }),
              e.updateDimensions(),
              e.slideshow.getCurrentSlideIndex() > -1 &&
                e.showSlide(e.slideshow.getCurrentSlideIndex());
          }),
          (s.prototype.scaleSlideBackgroundImages = function (e) {
            var l = this;
            l.slideViews.forEach(function (l) {
              l.scaleBackgroundImage(e);
            });
          }),
          (s.prototype.showSlide = function (e) {
            var l = this,
              s = l.slideViews[e],
              t = l.slideViews[e + 1];
            l.events.emit("beforeShowSlide", e),
              s.show(),
              (l.previewArea.innerHTML = t ? t.containerElement.outerHTML : ""),
              l.events.emit("afterShowSlide", e);
          }),
          (s.prototype.hideSlide = function (e) {
            var l = this,
              s = l.slideViews[e];
            l.events.emit("beforeHideSlide", e),
              s.hide(),
              l.events.emit("afterHideSlide", e);
          }),
          (s.prototype.updateDimensions = function () {
            var e = this,
              l = e.scaler.dimensions;
            (e.helpElement.style.width = l.width + "px"),
              (e.helpElement.style.height = l.height + "px"),
              e.scaleSlideBackgroundImages(l),
              e.scaleElements();
          }),
          (s.prototype.scaleElements = function () {
            var e = this;
            e.slideViews.forEach(function (l) {
              l.scale(e.elementArea);
            }),
      ...
      function (e, l) {
        function s(e, l) {
          function s(s) {
            (s = s || ""),
              ...
              w.forEach(function (e) {
                for (var l in e.links)
                  e.links.hasOwnProperty(l) && (v[l] = e.links[l]);
              }),
          ...
          (l = l || {}),
            ...
            (y.getSlideCount = j),
            (y.getSlideByName = c),
            (y.togglePresenterMode = d),
            (y.toggleHelp = u),
            (y.toggleBlackout = m),
            (y.toggleMirrored = g),
            (y.toggleFullscreen = p),
            (y.createClone = b),
            (y.resetTimer = f),
            (y.getRatio = k("ratio", "4:3")),
            (y.getHighlightStyle = k("highlightStyle", "default")),
            (y.getHighlightLines = k("highlightLines", !1)),
            (y.getHighlightSpans = k("highlightSpans", !1)),
            (y.getHighlightLanguage = k("highlightLanguage", "")),
            (y.getSlideNumberFormat = k(
              "slideNumberFormat",
              "%current% / %total%"
            )),
            s(l.source),
            e.on("toggleBlackout", function () {
              y.clone &&
                !y.clone.closed &&
                y.clone.postMessage("toggleBlackout", "*");
            });
        }
        function t(e, l) {
          var s,
          ...
          return (
            ...
            a.forEach(function (e, t) {
              var a, h;
              "true" === e.properties.continued && t > 0
                ? (a = r[r.length - 1])
                : o[e.properties.template]
                ? (a = o[e.properties.template])
                : "false" === e.properties.layout
                ? (s = void 0)
                : s && "true" !== e.properties.layout && (a = s),
                "true" === e.properties.continued &&
                  l.countIncrementalSlides === !1 &&
                  void 0 === e.properties.count &&
                  (e.properties.count = "false"),
                (h = new i(r.length, e, a)),
                "true" === e.properties.layout && (s = h),
                e.properties.name && (o[e.properties.name] = h),
                "true" !== e.properties.layout &&
                  (r.push(h),
                  e.properties.name && (r.byName[e.properties.name] = h));
            }),
            r
          );
        }
        ...
        var r = e("./slideshow/navigation"),
          o = e("./slideshow/events"),
          i = (e("../utils"), e("./slide")),
          h = e("../parser"),
          n = e("../macros");
        l.exports = s;
    ...
    16: [
      function (e, l) {
        ...
        function t(e, l, s) {
          var a, k;
          for (s = s || []; null !== (a = l.exec(e)); )
            a.index > 0 &&
              s.push({ type: "text", text: e.substring(0, a.index) }),
              a[i]
                ? s.push({ type: "code", text: a[0] })
                : a[h]
                ? s.push({ type: "text", text: a[0] })
                : a[j]
                ? s.push({ type: "fences", text: a[0] })
                : a[c]
                ? s.push({ type: "def", id: a[c], href: a[d], title: a[u] })
                : a[m]
                ? s.push({
                    type: "macro",
                    name: a[m],
                    args: (a[g] || "").split(",").map(r),
                    obj: a[p],
                  })
                : a[b]
                ? s.push({ type: "separator", text: a[b] })
                : a[f]
                ? s.push({ type: "notes_separator", text: a[f] })
                : a[n] &&
                  ((k = o(e, a.index + a[0].length)),
                  void 0 !== k
                    ? ((e = e.substring(k.length + 1)),
                      "\\" !== a[0][0]
                        ? (s.push({
                            type: "content_start",
                            classes: a[n].substring(1).split("."),
                            block: -1 !== k.indexOf("\n"),
                          }),
                          t(k, w, s),
                          s.push({
                        ...
                        : s.push({
                            type: "text",
                            text: a[0].substring(1) + k + "]",
                          }))
                    : s.push({ type: "text", text: a[0] })),
              (e = e.substring(a.index + a[0].length));
          return (
            (e || (!e && 0 === s.length)) && s.push({ type: "text", text: e }),
            s
          );
        }
        function a(e, l) {
        ...
        function o(e, l) {
          for (var s, t = 1, a = l; t > 0 && a < e.length; )
            (s = e[a++]), (t += ("[" === s && 1) || ("]" === s && -1) || 0);
          return 0 === t ? (e = e.substr(l, a - l - 1)) : void 0;
        }
        l.exports = s;
        var i = 1,
          h = 2,
          ...
          w = a(/CODE|INLINE_CODE|CONTENT|FENCES|DEF|MACRO/, k);
        s.prototype.lex = function (e) {
          ...
          for (l = s.length - 2; l >= 0; l--)
            "text" === s[l].type &&
              "text" === s[l + 1].type &&
              ((s[l].text += s[l + 1].text), s.splice(l + 1, 1));
          return s;
        };
      },
      {},
    ...
    25: [
      function (e, l) {
        function s(e) {
          ...
          function a(l, s) {
            var t = l === d,
              a = 0 > l || l > c.getSlideCount() - 1;
            void 0 === s && (s = !1),
              t ||
                a ||
                (-1 !== d && e.emit("hideSlide", d, !1),
                null === u ? (u = !1) : u === !1 && (e.emit("start"), (u = !0)),
                e.emit("showSlide", l),
                (d = l),
                e.emit("slideChanged", l + 1),
                s ||
                  (c.clone &&
                    !c.clone.closed &&
                    c.clone.postMessage("gotoSlide:" + (d + 1), "*"),
                  window.opener &&
                    window.opener.postMessage("gotoSlide:" + (d + 1), "*")));
          }
          function r(e, l) {
            var s = j(e);
            a(s, l);
              ...
              : ((s = parseInt(l, 10)),
                s.toString() === l
                  ...
                  ? (e.emit("forcePresenterMode"),
                    parseInt(l.substr(1), 10) - 1)
                  : ((t = c.getSlideByName(l)), t ? t.getSlideIndex() : 0));
          }
          var c = this,
            d = -1,
            u = null;
          (c.getCurrentSlideIndex = t),
            (c.gotoSlide = r),
            (c.gotoPreviousSlide = o),
            (c.gotoNextSlide = i),
            (c.gotoFirstSlide = h),
            (c.gotoLastSlide = n),
            (c.pause = l),
            (c.resume = s),
            e.on("gotoSlide", r),
            e.on("gotoPreviousSlide", o),
            e.on("gotoNextSlide", i),
            e.on("gotoFirstSlide", h),
            e.on("gotoLastSlide", n),
            e.on("slidesChanged", function () {
              d > c.getSlideCount() && (d = c.getSlideCount());
            }),
            e.on("createClone", function () {
              !c.clone || c.clone.closed
                ? (c.clone = window.open(
                    location.href,
                    "_blank",
                    "location=no"
    ...
    26: [
      function (e, l) {
        function s(e) {
          ...
          s.setMaxListeners(0),
            (l.on = function () {
              return s.on.apply(s, arguments), l;
            }),
            [
              "showSlide",
              "hideSlide",
      ...
      function (e, l, s) {
        function t(e) {
          e.on("keydown", function (l) {
            ...
            e.on("keypress", function (l) {
              if (!l.metaKey && !l.ctrlKey)
                switch (String.fromCharCode(l.which).toLowerCase()) {
                  case "j":
                    e.emit("gotoNextSlide");
                    break;
                  case "k":
        ...
        function t(e, l) {
          if (
            (l.click &&
              ...
              e.on("contextmenu", function (l) {
                "A" !== l.target.nodeName &&
                  (l.preventDefault(), e.emit("gotoPreviousSlide"));
              })),
            l.scroll !== !1)
          ) {
            var s = function (l) {
              l.wheelDeltaY > 0 || l.detail < 0
                ? e.emit("gotoPreviousSlide")
                : (l.wheelDeltaY < 0 || l.detail > 0) &&
                  e.emit("gotoNextSlide");
            };
            e.on("mousewheel", s), e.on("DOMMouseScroll", s);
          }
        }
        function a(e) {
    ...
    19: [
      function (e, l, s) {
        function t(e, l) {
          ...
          if (l.touch !== !1) {
            var r = function () {
                return Math.abs(t - a) < 10;
              },
              o = function () {
                e.emit("tap", a);
              },
              i = function () {
                t > a ? e.emit("gotoNextSlide") : e.emit("gotoPreviousSlide");
              };
            e.on("touchstart", function (e) {
              (s = e.touches[0]), (t = s.clientX);
            }),
              e.on("touchend", function (e) {
                "A" !== e.target.nodeName.toUpperCase() &&
                  ((s = e.changedTouches[0]), (a = s.clientX), r() ? o() : i());
              }),
    ...
    20: [
      function (e, l, s) {
        function t(e) {
          function l(l) {
            var s;
            null !== (s = /^gotoSlide:(\d+)$/.exec(l.data))
              ? e.emit("gotoSlide", parseInt(s[1], 10), !0)
              : "toggleBlackout" === l.data && e.emit("toggleBlackout");
          }
          e.on("message", l);
        }
        s.register = function (e) {
      ...
      function (e, l) {
        function s(e, l) {
          ...
          (s.events = e),
            (s.slideshow = l),
            (s.ratio = t(l)),
            (s.dimensions = a(s.ratio)),
            s.events.on("propertiesChanged", function (e) {
              e.hasOwnProperty("ratio") &&
                ((s.ratio = t(l)), (s.dimensions = a(s.ratio)));
            });
        }
        function t(e) {
          var l,
            s = e.getRatio().split(":");
          return (
            (l = { width: parseInt(s[0], 10), height: parseInt(s[1], 10) }),
            (l.ratio = l.width / l.height),
            l
          );
        }
        function a(e) {
          return { width: Math.floor((r / i) * e.ratio), height: o };
        }
        var r = 908,
          o = 681,
          i = r / o;
        (l.exports = s),
          (s.prototype.scaleToFit = function (e, l) {
            var s,
              t,
              a,
              r,
              ...
              j = i.ratio,
              c = i.dimensions;
            (s = n / j.width > h / j.height ? h / c.height : n / c.width),
              (t = c.width * s),
              (a = c.height * s),
              (r = (n - t) / 2),
              (o = (h - a) / 2),
              (e.style["-webkit-transform"] = "scale(" + s + ")"),
              (e.style.MozTransform = "scale(" + s + ")"),
              (e.style.left = Math.max(r, 0) + "px"),
              (e.style.top = Math.max(o, 0) + "px");
          });
      },
      {},
    ],
    27: [
      function (e, l) {
        ...
        function a(e, l) {
          var s, t;
          for (s in l.properties)
            l.properties.hasOwnProperty(s) &&
              !r(s) &&
              ((t = [l.properties[s]]),
              "class" === s && e.properties[s] && t.push(e.properties[s]),
              ("class" === s || void 0 === e.properties[s]) &&
                (e.properties[s] = t.join(", ")));
        }
        function r(e) {
        ...
        function o(e, l) {
          ...
          (e.properties.content = e.content.slice()),
            (e.content = l.content.slice()),
            (s = e.expandVariables(!0)),
            void 0 === s.content &&
        ...
        (l.exports = s),
          (s.prototype.expandVariables = function (e, l, s) {
            function t(l, t, a, o) {
              var i,
                h = o.trim();
              return t
                ...
                ? l
                : ((i = r[h]),
                  void 0 !== i ? ((s[h] = i), i) : "content" === h ? "" : a);
            }
            var a,
              r = this.properties;
            for (
              l = void 0 !== l ? l : this.content, s = s || {}, a = 0;
              a < l.length;
              ++a
            )
              "string" == typeof l[a]
                ? (l[a] = l[a].replace(/(\\)?(\{\{([^\}\n]+)\}\})/g, t))
                : this.expandVariables(e, l[a].content, s);
            return s;
          });
      },
      {},
      ...
      function (e, l) {
        function s(e, l, s, t) {
          ...
          (a.events = e),
            ...
            (a.scaler = s),
            (a.slide = t),
            (a.slideNumber = new m(t, l)),
            a.configureElements(),
            a.updateDimensions(),
            a.events.on("propertiesChanged", function (e) {
        ...
        function t(e, l, s) {
          ...
          return (
            s.properties.name && (t.id = "slide-" + s.properties.name),
            a(l, t, s.properties),
            (t.innerHTML = g.convertMarkdown(s.content, l.getLinks())),
            n(t, l),
            t
          );
        }
        function a(e, l, s) {
          (l.className = ""), h(l, s), i(l, s, e), o(l, s);
        }
        function r(e, l) {
          var s = document.createElement("div");
          return (
            (s.className = "remark-slide-notes"),
            (s.innerHTML = g.convertMarkdown(l)),
            n(s, e),
            s
          );
        }
        function o(e, l) {
          var s = l["background-image"],
            t = l["background-color"];
          s && (e.style.backgroundImage = s),
            t && (e.style.backgroundColor = t);
        }
        function i(e, l, s) {
          var t = l["highlight-style"] || s.getHighlightStyle();
          t && b.addClass(e, "hljs-" + t);
        }
        function h(e, l) {
          b.addClass(e, "remark-slide-content"),
            (l["class"] || "")
              .split(/,| /)
              .filter(function (e) {
                return "" !== e;
        ...
        function n(e, l) {
          var s,
            t = e.getElementsByTagName("code"),
            a = l.getHighlightLines(),
            r = l.getHighlightSpans();
          t.forEach(function (e) {
            return "PRE" !== e.parentElement.tagName
              ? (b.addClass(e, "remark-inline-code"), void 0)
              : ("" === e.className && (e.className = l.getHighlightLanguage()),
                a && (s = j(e)),
                "" !== e.className && p.engine.highlightBlock(e, "  "),
                c(e),
                a && d(e, s.highlightedLines),
                r && u(e),
                b.addClass(e, "remark-code"),
                void 0);
          });
        }
        function j(e) {
        ...
        function c(e) {
          var l = e.innerHTML.split(/\r?\n/).map(function (e) {
            return '<div class="remark-code-line">' + e + "</div>";
          });
          l.length && -1 !== l[l.length - 1].indexOf("><") && l.pop(),
            (e.innerHTML = l.join(""));
        }
        function d(e, l) {
          l.forEach(function (l) {
            b.addClass(e.childNodes[l], "remark-code-line-highlighted");
          });
        }
        function u(e) {
          var l = /([^`])`([^`]+?)`/g;
          e.childNodes.forEach(function (e) {
            e.innerHTML = e.innerHTML.replace(l, function (e, l, s) {
              return "\\" === l
                ? e.substr(1)
                : l +
        ...
        var m = e("components/slide-number"),
          g = e("../converter"),
          p = e("../highlighter"),
          b = e("../utils");
        (l.exports = s),
          (s.prototype.updateDimensions = function () {
            var e = this,
              l = e.scaler.dimensions;
            (e.scalingElement.style.width = l.width + "px"),
              (e.scalingElement.style.height = l.height + "px");
          }),
          (s.prototype.scale = function (e) {
            var l = this;
            l.scaler.scaleToFit(l.scalingElement, e);
          }),
          (s.prototype.show = function () {
            b.addClass(this.containerElement, "remark-visible"),
              b.removeClass(this.containerElement, "remark-fading");
          }),
          (s.prototype.hide = function () {
            var e = this;
            b.removeClass(this.containerElement, "remark-visible"),
              b.addClass(this.containerElement, "remark-fading"),
              setTimeout(function () {
                b.removeClass(e.containerElement, "remark-fading");
              }, 1e3);
          }),
          (s.prototype.configureElements = function () {
            var e = this;
            (e.containerElement = document.createElement("div")),
              ...
              (e.contentElement = t(e.events, e.slideshow, e.slide)),
              (e.notesElement = r(e.slideshow, e.slide.notes)),
          ...
          (s.prototype.scaleBackgroundImage = function (e) {
            var l,
              s,
              t,
              a = this,
              r = window.getComputedStyle(this.contentElement),
              o = r.backgroundImage;
            null !== (l = /^url\(("?)([^\)]+?)\1\)/.exec(o)) &&
              ((s = new Image()),
              (s.onload = function () {
                s.width > e.width || s.height > e.height
                  ? a.originalBackgroundSize ||
                    ((a.originalBackgroundSize =
                      a.contentElement.style.backgroundSize),
                    (a.originalBackgroundPosition =
                      a.contentElement.style.backgroundPosition),
                    (a.backgroundSizeSet = !0),
                    (t =
                      e.width / s.width < e.height / s.height
                        ? e.width / s.width
                        : e.height / s.height),
                    (a.contentElement.style.backgroundSize =
                      s.width * t + "px " + s.height * t + "px"),
                    (a.contentElement.style.backgroundPosition =
                      "50% " + (e.height - s.height * t) / 2 + "px"))
                  : a.backgroundSizeSet &&
                    ((a.contentElement.style.backgroundSize =
                      a.originalBackgroundSize),
                    (a.contentElement.style.backgroundPosition =
                      a.originalBackgroundPosition),
                    (a.backgroundSizeSet = !1));
              }),
              (s.src = l[2]));
          });
      },
    ...
    23: [
      function (e, l) {
        ...
        e("../converter"),
          ...
          (s.prototype.showSlide = function (e) {
            var l = this,
              s = l.slideViewsAccessor(),
              t = s[e],
              a = s[e + 1];
            (l.notesElement.innerHTML = t.notesElement.innerHTML),
              (l.notesPreviewElement.innerHTML = a
                ? a.notesElement.innerHTML
                : "");
          }),
          (s.prototype.configureElements = function () {
            var e = this;
    ...
    21: [
      function (e, l, s) {
        function t(e, l, s) {
          function t() {
            var s = (l.getLocationHash() || "").substr(1);
            e.emit("gotoSlide", s);
          }
          function r(e) {
            a.hasClass(s.containerElement, "remark-presenter-mode")
              ? l.setLocationHash("#p" + e)
              : l.setLocationHash("#" + e);
          }
          s.isEmbedded()
            ? e.emit("gotoSlide", 1)
            : (e.on("hashchange", t),
              e.on("slideChanged", r),
              e.on("toggledPresenter", r),
              t());
        }
        var a = e("../../utils.js");
        s.register = function (e, l, s) {
          t(e, l, s);
        };
      },
      { "../../utils.js": 8 },
      ...
      function (e, l) {
        function s(e, l, a) {
          ...
          for (o = 0; o < e.length; ++o)
            "string" == typeof e[o]
              ? (n += e[o])
              : ((i = e[o].block ? "div" : "span"),
                (n += "<" + i + ' class="' + e[o].class + '">'),
                (n += s(e[o].content, l, !0)),
                (n += "</" + i + ">"));
          var j = t.Lexer.lex(n.replace(/^\s+/, ""));
          return (
            (j.links = l),
            (h = t.Parser.parse(j)),
            a &&
              ((r.innerHTML = h),
              1 === r.children.length &&
                "P" === r.children[0].tagName &&
                (h = r.children[0].innerHTML)),
            h
          );
        }
        var t = e("marked"),
        ...
        t.setOptions({
          ...
          (a.convertMarkdown = function (e, l, t) {
            return (
              (r.innerHTML = s(e, l || {}, t)),
              (r.innerHTML = r.innerHTML.replace(/<p>\s*<\/p>/g, "")),
              r.innerHTML.replace(/\n\r?$/, "")
            );
          });
      },
          ...
          !function () {
            function e(e) {
              (this.tokens = []),
                ...
                (this.rules = d.normal),
                this.options.gfm &&
                  (this.rules = this.options.tables ? d.tables : d.gfm);
            }
            function t(e, l) {
              if (
                ((this.options = l || c.defaults),
                (this.links = e),
                (this.rules = u.normal),
              ...
              this.options.gfm
                ? (this.rules = this.options.breaks ? u.breaks : u.gfm)
            ...
            function i(e) {
              return e.replace(/&([#\w]+);/g, function (e, l) {
                return (
                  (l = l.toLowerCase()),
                  "colon" === l
                    ? ":"
                    : "#" === l.charAt(0)
                    ? "x" === l.charAt(1)
                      ? String.fromCharCode(parseInt(l.substring(2), 16))
                      : String.fromCharCode(+l.substring(1))
                    : ""
                );
              });
            }
            ...
            function n() {}
            function j(e) {
              for (var l, s, t = 1; t < arguments.length; t++) {
                l = arguments[t];
                for (s in l)
            ...
            function c(l, s, t) {
              if (t || "function" == typeof s) {
                t || ((t = s), (s = null)), (s = j({}, c.defaults, s || {}));
                var a,
                  i,
                  h = s.highlight,
                  n = 0;
                ...
                var u = function () {
                  ...
                  return (s.highlight = h), l ? t(l) : t(null, e);
                };
                if (!h || h.length < 3) return u();
                if ((delete s.highlight, !i)) return u();
                for (; n < a.length; n++)
                  !(function (e) {
                    return "code" !== e.type
                      ? --i || u()
                      : h(e.text, e.lang, function (l, s) {
                          return null == s || s === e.text
                            ? --i || u()
                            : ((e.text = s),
                              (e.escaped = !0),
                              --i || u(),
                ...
                try {
                  return (
                    s && (s = j({}, c.defaults, s)), r.parse(e.lex(l, s), s)
                  );
                } catch (d) {
                  if (
                    ((d.message +=
            ...
            (d.bullet = /(?:[*+-]|\d+\.)/),
              (d.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
              (d.item = h(d.item, "gm")(/bull/g, d.bullet)()),
              (d.list = h(d.list)(/bull/g, d.bullet)(
                "hr",
                /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/
              )()),
              (d._tag =
                "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b"),
              (d.html = h(d.html)("comment", /<!--[\s\S]*?-->/)(
                "closed",
                /<(tag)[\s\S]+?<\/\1>/
              )("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(
                /tag/g,
              ...
              (d.paragraph = h(d.paragraph)("hr", d.hr)("heading", d.heading)(
                "lheading",
                d.lheading
              ...
              (e.prototype.token = function (e, l) {
                for (
                  var s, t, a, r, o, i, h, n, j, e = e.replace(/^ +$/gm, "");
                  e;
                  ...
                  if (
                  ...
                  else if (l && (a = this.rules.nptable.exec(e))) {
                    for (
                      e = e.substring(a[0].length),
                        i = {
                          type: "table",
                      ...
                      i.align[n] = /^ *-+: *$/.test(i.align[n])
                        ...
                        ? "left"
                        : null;
                    for (n = 0; n < i.cells.length; n++)
                      i.cells[n] = i.cells[n].split(/ *\| */);
                    this.tokens.push(i);
                    ...
                    for (
                      ...
                      (i = a[n]),
                        ...
                        this.options.smartLists &&
                          n !== j - 1 &&
                          ((o = d.bullet.exec(a[n + 1])[0]),
                          r === o ||
                            (r.length > 1 && o.length > 1) ||
                            ((e = a.slice(n + 1).join("\n") + e), (n = j - 1))),
                        (t = s || /\n\n(?!\s*$)/.test(i)),
                        n !== j - 1 &&
                          ((s = "\n" === i.charAt(i.length - 1)), t || (t = s)),
                        this.tokens.push({
                          type: t ? "loose_item_start" : "list_item_start",
                        }),
                        this.token(i, !1),
                  ...
                  else if (l && (a = this.rules.def.exec(e)))
                    (e = e.substring(a[0].length)),
                      (this.tokens.links[a[1].toLowerCase()] = {
                        href: a[2],
                        title: a[3],
                      });
                  else if (l && (a = this.rules.table.exec(e))) {
                    for (
                      e = e.substring(a[0].length),
                        i = {
                          type: "table",
                    ...
                    for (n = 0; n < i.cells.length; n++)
                      i.cells[n] = i.cells[n]
                        ...
                        .split(/ *\| */);
                    this.tokens.push(i);
                  } else if (l && (a = this.rules.paragraph.exec(e)))
                    (e = e.substring(a[0].length)),
                      this.tokens.push({
                        type: "paragraph",
                        text:
            ...
            (u._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/),
              ...
              (u.link = h(u.link)("inside", u._inside)("href", u._href)()),
              (u.reflink = h(u.reflink)("inside", u._inside)()),
              (u.normal = j({}, u)),
              (u.pedantic = j({}, u.normal, {
              ...
              (t.prototype.output = function (e) {
                for (var l, s, t, a, r = ""; e; )
                  if ((a = this.rules.escape.exec(e)))
                    (e = e.substring(a[0].length)), (r += a[1]);
                  else if ((a = this.rules.autolink.exec(e)))
                    (e = e.substring(a[0].length)),
                      "@" === a[2]
                        ? ((s =
                            ":" === a[1].charAt(6)
                              ? this.mangle(a[1].substring(7))
                              : this.mangle(a[1])),
                          (t = this.mangle("mailto:") + s))
                        : ((s = o(a[1])), (t = s)),
                      (r += this.renderer.link(t, null, s));
                  else if ((a = this.rules.url.exec(e)))
                    (e = e.substring(a[0].length)),
                      (s = o(a[1])),
                      (t = s),
                      (r += this.renderer.link(t, null, s));
                    ...
                    (e = e.substring(a[0].length)),
                      (r += this.options.sanitize ? o(a[0]) : a[0]);
                  else if ((a = this.rules.link.exec(e)))
                    (e = e.substring(a[0].length)),
                      (r += this.outputLink(a, { href: a[2], title: a[3] }));
                  else if (
                    ...
                    if (
                      ((e = e.substring(a[0].length)),
                      (l = (a[2] || a[1]).replace(/\s+/g, " ")),
                      (l = this.links[l.toLowerCase()]),
                      !l || !l.href)
                    ) {
                      (r += a[0].charAt(0)), (e = a[0].substring(1) + e);
                      continue;
                    }
                    r += this.outputLink(a, l);
                  } else if ((a = this.rules.strong.exec(e)))
                    (e = e.substring(a[0].length)),
                      (r += this.renderer.strong(this.output(a[2] || a[1])));
                  else if ((a = this.rules.em.exec(e)))
                    (e = e.substring(a[0].length)),
                      (r += this.renderer.em(this.output(a[2] || a[1])));
                  else if ((a = this.rules.code.exec(e)))
                    (e = e.substring(a[0].length)),
                      (r += this.renderer.codespan(o(a[2], !0)));
                  else if ((a = this.rules.br.exec(e)))
                    (e = e.substring(a[0].length)), (r += this.renderer.br());
                  else if ((a = this.rules.del.exec(e)))
                    (e = e.substring(a[0].length)),
                      (r += this.renderer.del(this.output(a[1])));
                  else if ((a = this.rules.text.exec(e)))
                    (e = e.substring(a[0].length)),
                      (r += o(this.smartypants(a[0])));
                  else if (e)
                    throw new Error(
                      "Infinite loop on byte: " + e.charCodeAt(0)
                    );
              ...
              (t.prototype.outputLink = function (e, l) {
                var s = o(l.href),
                  t = l.title ? o(l.title) : null;
                return "!" !== e[0].charAt(0)
                  ? this.renderer.link(s, t, this.output(e[1]))
                  : this.renderer.image(s, t, o(e[1]));
              }),
              ...
              (t.prototype.mangle = function (e) {
                for (var l, s = "", t = e.length, a = 0; t > a; a++)
                  (l = e.charCodeAt(a)),
                    Math.random() > 0.5 && (l = "x" + l.toString(16)),
                    (s += "&#" + l + ";");
                return s;
              }),
              (a.prototype.code = function (e, l, s) {
                if (this.options.highlight) {
                  var t = this.options.highlight(e, l);
                  null != t && t !== e && ((s = !0), (e = t));
                }
                return l
                  ? '<pre><code class="' +
              ...
              (a.prototype.heading = function (e, l, s) {
                return (
                  "<h" +
                  l +
                  ' id="' +
              ...
              (a.prototype.table = function (e, l) {
                return (
                  "<table>\n<thead>\n" +
                  e +
                  "</thead>\n" +
              ...
              (a.prototype.tablecell = function (e, l) {
                var s = l.header ? "th" : "td",
                  t = l.align
                    ? "<" + s + ' style="text-align:' + l.align + '">'
                    : "<" + s + ">";
                return t + e + "</" + s + ">\n";
              }),
              ...
              (a.prototype.link = function (e, l, s) {
                if (this.options.sanitize) {
                  try {
                    var t = decodeURIComponent(i(e))
                      .replace(/[^\w:]/g, "")
                      .toLowerCase();
                  } catch (a) {
                    return "";
                  }
                  if (0 === t.indexOf("javascript:")) return "";
                }
                var r = '<a href="' + e + '"';
                return (
                  l && (r += ' title="' + l + '"'), (r += ">" + s + "</a>")
              ...
              (a.prototype.image = function (e, l, s) {
                var t = '<img src="' + e + '" alt="' + s + '"';
                return l && (t += ' title="' + l + '"'), (t += ">");
              }),
              (r.parse = function (e, l, s) {
                var t = new r(l, s);
                return t.parse(e);
              }),
              (r.prototype.parse = function (e) {
                ...
                for (var l = ""; this.next(); ) l += this.tok();
                return l;
              }),
                ...
                switch (this.token.type) {
                  ...
                  case "table":
                    var e,
                      ...
                      r = "",
                      o = "";
                    for (s = "", e = 0; e < this.token.header.length; e++)
                      (t = { header: !0, align: this.token.align[e] }),
                        (s += this.renderer.tablecell(
                          this.inline.output(this.token.header[e]),
                          { header: !0, align: this.token.align[e] }
                        ));
                    for (
                      r += this.renderer.tablerow(s), e = 0;
                      e < this.token.cells.length;
                      e++
                    ) {
                      for (
                        l = this.token.cells[e], s = "", a = 0;
                        a < l.length;
                        a++
                      )
                        s += this.renderer.tablecell(this.inline.output(l[a]), {
                          header: !1,
                  ...
                  case "list_start":
                    for (
                      var o = "", i = this.token.ordered;
                      "list_end" !== this.next().type;

                    )
                      o += this.tok();
                    return this.renderer.list(o, i);

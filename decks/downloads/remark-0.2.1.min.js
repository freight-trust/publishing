!(function (context) {
  ...
  !(function (context) {
    var hljs = new (function () {
          ...
          for (var r = 0; r < s.childNodes.length; r++) {
            if (s.childNodes[r].nodeType == 3) {
              ...
              if (s.childNodes[r].nodeName == "BR") {
                ...
                p.push({ event: "start", offset: t, node: s.childNodes[r] });
                t = arguments.callee(s.childNodes[r], t);
                p.push({ event: "stop", offset: t, node: s.childNodes[r] });
              }
            }
          }
          return t;
      ...
      function d(B, C) {
        ...
        try {
          ...
          return { r: A, keyword_count: x, value: y };
        } catch (H) {
          if (H == "Illegal") {
            return { r: 0, keyword_count: 0, value: m(C) };
          } else {
            throw H;
          }
        }
      ...
      function n(t, w, r) {
        ...
        t.className = u;
        t.result = { language: v, kw: y.keyword_count, re: y.r };
        if (y.second_best) {
          t.second_best = {
    ...
    hljs.LANGUAGES.bash = (function () {
      var e = { true: 1, false: 1 };
      var c = { cN: "variable", b: "\\$([a-zA-Z0-9_]+)\\b" };
      var b = {
        cN: "variable",
        b: "\\$\\{(([^}])|(\\\\}))+\\}",
        c: [hljs.CNM],
    ...
    hljs.LANGUAGES.ruby = (function () {
      ...
      var t = { cN: "subst", b: "#\\{", e: "}", l: g, k: v };
      var u = [hljs.BE, t];
      var r = { cN: "string", b: "'", e: "'", c: u, r: 0 };
      var q = { cN: "string", b: '"', e: '"', c: u, r: 0 };
      var p = { cN: "string", b: "%[qw]?\\(", e: "\\)", c: u, r: 10 };
      var o = { cN: "string", b: "%[qw]?\\[", e: "\\]", c: u, r: 10 };
      var n = { cN: "string", b: "%[qw]?{", e: "}", c: u, r: 10 };
      var m = { cN: "string", b: "%[qw]?<", e: ">", c: u, r: 10 };
      var l = { cN: "string", b: "%[qw]?/", e: "/", c: u, r: 10 };
      var k = { cN: "string", b: "%[qw]?%", e: "%", c: u, r: 10 };
      var i = { cN: "string", b: "%[qw]?-", e: "-", c: u, r: 10 };
      var s = { cN: "string", b: "%[qw]?\\|", e: "\\|", c: u, r: 10 };
      var f = {
        cN: "function",
        b: "\\bdef\\s+",
        e: " |$|;",
        ...
        k: v,
        c: [
          { cN: "title", b: a, l: g, k: v },
          { cN: "params", b: "\\(", e: "\\)", l: g, k: v },
          d,
          c,
          b,
        ],
      };
      var e = { cN: "identifier", b: g, l: g, k: v, r: 0 };
      var j = [
        d,
        c,
        b,
        ...
        { cN: "symbol", b: ":", c: [r, q, p, o, n, m, l, k, i, s, e], r: 0 },
        {
          cN: "number",
          b:
            "(\\b0[0-7_]+)|(\\b0x[0-9a-fA-F_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b",

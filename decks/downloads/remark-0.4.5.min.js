  ...
  (a.paths = []),
    ...
    a.define("/src/remark/api.js", function (a, b, c, d, e, f, g) {
      var h = a("events").EventEmitter,
        i = (b.exports = new h()),
        j = a("./events");
      (i.loadFromString = function (a) {
        j.emit("loadFromString", a);
      }),
        (i.gotoSlide = function (a) {
          j.emit("gotoSlide", a);
        }),
        (i.gotoPreviousSlide = function () {
          j.emit("gotoPreviousSlide");
        }),
        (i.gotoNextSlide = function () {
          j.emit("gotoNextSlide");
        }),
        (i.gotoFirstSlide = function () {
          j.emit("gotoFirstSlide");
        }),
        (i.gotoLastSlide = function () {
          j.emit("gotoLastSlide");
        });
    }),
    ...
    a.define("/src/remark/config.js", function (a, b, c, d, e, f, g) {
      ...
      function n(a) {
        ...
        for (b = 0; b < j.length; ++b)
          (c = j[b]), a.hasOwnProperty(c) && (h[c] = a[c]);
      }
      var h = (b.exports = k),
        i = a("./api"),
        j = ["highlightInline", "highlightLanguage", "highlightStyle", "ratio"];
      (i.config = h), l();
    }),
      ...
      function t(a) {
        function d() {
          var d = window.innerHeight,
            ...
            g,
            h;
          e / b.width > d / b.height ? (f = d / c.height) : (f = e / c.width),
            (g = c.width * f),
            (h = c.height * f),
            (a.style["-webkit-transform"] = "scale(" + f + ")"),
            (a.style.MozTransform = "scale(" + f + ")"),
            (a.style.left = (e - g) / 2 + "px"),
            (a.style.top = (d - h) / 2 + "px");
        }
        var b = v(),
          c = u(b);
    ...
    a.define("/src/remark/views/overlayView.js", function (
      ...
      function j(a) {
        ...
        (b.element = document.createElement("div")),
          ...
          (b.element.innerHTML = i.overlayTemplate),
    ...
    a.define("/src/remark.js", function (a, b, c, d, e, f, g) {
      ...
      function q() {
        var a = document.createElement("style"),
          ...
          c = o.documentStyles + l.cssForStyle();
        (a.type = "text/css"),
          (a.innerHTML = c),
      ...
      function r(a, b) {
        var c = a.innerHTML,
          ...
          f,
          g;
        (d = new m(c)), (e = new n(d, b)), (f = new j(d)), (g = new k());
      }
      var h = a("./remark/utils"),
        i = a("./remark/api"),
        j = a("./remark/controller").Controller,
        k = a("./remark/dispatcher"),
        l = a("./remark/highlighter"),
        m = a("./remark/models/slideshow").Slideshow,
        n = a("./remark/views/slideshowView").SlideshowView,
        o = a("./remark/resources");
      (window.remark = i),
        window.addEventListener("load", function () {
          var a = document.getElementById("source"),
            b = document.getElementById("slideshow");
          if (!p(a, b)) return;
          (a.style.display = "none"), q(), r(a, b), i.emit("ready");
        });
    }),
    a("/src/remark.js");
})();

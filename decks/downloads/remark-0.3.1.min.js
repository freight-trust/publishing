!(function (context) {
  ...
  !(function (context) {
    ...
    Showdown.converter = function () {
      ...
      var _23 = function (_7b) {
        _7b = _7b.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (
          _7c,
          m1,
          m2,
          m3,
    ...
    converter.convertSlideClasses = function (content) {
      ...
      while ((match = classFinder.exec(content.innerHTML))) {
        ...
        content.innerHTML =
          content.innerHTML.substr(0, match.index) +
          replacement +
    ...
    converter.convertContentClasses = function (content) {
      var classFinder = /(\\)?((?:\.[a-z_-][a-z-_0-9]*)+)\[/gi,
        match,
        classes,
        text,
        replacement,
      ...
      while ((match = classFinder.exec(content.innerHTML))) {
        ...
        if (match[1]) {
          ...
          classFinder.lastIndex =
            match.index + ('<span class="' + classes.join(" ") + '">').length;
        }
        after = content.innerHTML.substr(
          match.index + match[0].length + text.length + 1
        );
        content.innerHTML =
          content.innerHTML.substr(0, match.index) + replacement + after;
      }
    };
    ...
    converter.convertMarkdown = function (content) {
      ...
      content.innerHTML = content.innerHTML.replace(/&[l|g]t;/g, function (
        match
      ) {
        return match === "&lt;" ? "<" : ">";
      });
  ...
  !(function () {
    ...
    hljs.LANGUAGES.bash = (function () {
      var d = { true: 1, false: 1 };
      var b = { cN: "variable", b: "\\$([a-zA-Z0-9_]+)\\b" };
      var a = {
        cN: "variable",
        b: "\\$\\{(([^}])|(\\\\}))+\\}",
        c: [hljs.CNM],
    ...
    hljs.LANGUAGES.erlang = (function () {
      ...
      var m = {
        ...
        r: 0,
        c: [
          { cN: "function_name", b: l, r: 0 },
          { b: "\\(", e: "\\)", eW: true, rE: true, r: 0 },
        ],
      };
      var f = { cN: "tuple", b: "{", e: "}", r: 0 };
      var a = { cN: "variable", b: "\\b_([A-Z][A-Za-z0-9_]*)?", r: 0 };
      var k = { cN: "variable", b: "[A-Z][a-zA-Z0-9_]*", r: 0 };
      var h = {
        b: "#",
        e: "}",
        i: ".",
        ...
        rB: true,
        c: [
          { cN: "record_name", b: "#" + hljs.UIR, r: 0 },
          { b: "{", eW: true, r: 0 },
        ],
      };
      var i = { k: d, b: "(fun|receive|if|try|case)", e: "end" };
      i.c = [
        j,
        c,
      ...
      f.c = b;
      h.c[1].c = b;
      var e = { cN: "params", b: "\\(", e: "\\)", eW: true, c: b };
      return {
        dM: {
          k: d,
          i: "(</|\\*=|\\+=|-=|/=|/\\*|\\*/|\\(\\*|\\*\\))",
          c: [
            {
              ...
              e: ";|\\.",
              rB: true,
              c: [e, { cN: "title", b: g }, { k: d, b: "->", eW: true, c: b }],
            },
            j,
            {
              cN: "pp",
    ...
    hljs.LANGUAGES.ruby = (function () {
      ...
      var e = {
        ...
        k: n,
        c: [
          { cN: "title", b: a, l: g, k: n },
          { cN: "params", b: "\\(", e: "\\)", l: g, k: n },
          d,
          c,
          b,
        ],
      ...
      var v = [
        ...
        { cN: "symbol", b: ":", c: [s, r, q, o, m, l, k, j, i, t, f], r: 0 },
        {
          cN: "number",
          b:
      ...
      dM: {
        ...
        c: [
          ...
          { cN: "preprocessor", b: "#", e: "$" },
          {
            ...
            e: "\\(",
            k: { surface: 1, displacement: 1, light: 1, volume: 1, imager: 1 },
          },
          {
            cN: "shading",
    ...
    hljs.LANGUAGES.lisp = (function () {
      var m =
        "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#]*";
      var n = "(\\-|\\+)?\\d+(\\.\\d+|\\/\\d+)?((d|e|f|l|s)(\\+|\\-)?\\d+)?";
      var c = { cN: "literal", b: "\\b(t{1}|nil)\\b" };
      var o = { cN: "number", b: n };
      var p = { cN: "number", b: "#b[0-1]+(/[0-1]+)?" };
      var q = { cN: "number", b: "#o[0-7]+(/[0-7]+)?" };
      var a = { cN: "number", b: "#x[0-9a-f]+(/[0-9a-f]+)?" };
      var b = { cN: "number", b: "#c\\(" + n + " +" + n, e: "\\)" };
      var e = { cN: "string", b: '"', e: '"', c: [hljs.BE], r: 0 };
      var l = { cN: "comment", b: ";", e: "$" };
      var d = { cN: "variable", b: "\\*", e: "\\*" };
      var k = { cN: "keyword", b: "[:&]" + m };
      var i = { b: "\\(", e: "\\)" };
      i.c = [i, c, o, p, q, a, b, e];
      var g = {
        cN: "quoted",
      ...
      var j = { cN: "list", b: "\\(", e: "\\)" };
      var h = { cN: "body", eW: true, eE: true };
      j.c = [{ cN: "title", b: m }, h];
      h.c = [g, f, j, c, o, p, q, a, b, e, l, d, k];
      return {
        cI: true,
        dM: { i: "[^\\s]", c: [c, o, p, q, a, b, e, l, g, f, j] },
      };
    })();
    hljs.LANGUAGES.profile = {
      dM: {
        c: [
          ...
          { cN: "summary", b: "function calls", e: "$", c: [hljs.CNM], r: 10 },
          hljs.ASM,
          hljs.QSM,
          {
            cN: "function",
    ...
    hljs.LANGUAGES["1c"] = (function () {
      ...
      var a = { cN: "dquote", b: '""' };
      var c = { cN: "string", b: '"', e: '"|$', c: [a], r: 0 };
      var f = { cN: "string", b: "\\|", e: '"|$', c: [a] };
      return {
        cI: true,
        dM: {
          l: b,
          k: { keyword: e, built_in: d },
          c: [
            hljs.CLCM,
            hljs.NM,
            c,
    ...
    hljs.LANGUAGES.tex = (function () {
      var c = { cN: "command", b: "\\\\[a-zA-Zа-яА-я]+[\\*]?", r: 10 };
      var b = { cN: "command", b: "\\\\[^a-zA-Zа-яА-я0-9]", r: 0 };
      var a = { cN: "special", b: "[{}\\[\\]\\&#~]", r: 0 };
      return {
        dM: {
          c: [
            {
        ...
        c: [
          {
            ...
            c: [
              ...
              { cN: "title", b: hljs.UIR, e: hljs.IMMEDIATE_RE },
            ],
          },
          hljs.CLCM,
          hljs.CBLCLM,
          ...
          { cN: "constant", b: " [A-Z_]+ ", e: hljs.IMMEDIATE_RE, r: 0 },
        ],
      },
    };
    hljs.LANGUAGES.ini = {
    ...
    hljs.LANGUAGES.perl = (function () {
      ...
      var e = [
        ...
        { cN: "regexp", b: "(m|qr)?/", e: "/[a-z]*", c: [hljs.BE], r: 0 },
        {
          cN: "sub",
          b: "\\bsub\\b",
          e: "(\\s*\\(.*?\\))?[;{]",
    ...
    hljs.LANGUAGES.cmake = {
      ...
      dM: {
        ...
        c: [{ cN: "envvar", b: "\\${", e: "}" }, hljs.HCM, hljs.QSM, hljs.NM],
      },
    };
    ...
    hljs.LANGUAGES.nginx = (function () {
      ...
      var b = { cN: "variable", b: "\\${", e: "}" };
      var a = { cN: "variable", b: "[\\$\\@]" + hljs.UIR };
      return {
        dM: {
          c: [
            hljs.HCM,
    ...
    hljs.LANGUAGES.django = (function () {
      ...
      return { cI: true, dM: d(hljs.LANGUAGES.xml.dM) };
    })();
  ...
  !(function (context) {
    ...
    var styleElement = function (element) {
      ...
      var resize = function () {
        ...
        element.style.top =
          (containerHeight - elementHeight * scale) / 2 + "px";
      };
  ...
  (function (h) {
    ...
    b.prototype.addListener = function (a, b, c, d) {
      ...
      this._events[a].push(new g(a, b, c, d, this));
      this.emit("newListener", a, b, c, d);
      if (
        this._maxListeners &&
    ...
    b.prototype.removeListener = function (a, b) {
      ...
      this._events[a] && this._events[a].length === 0 && delete this._events[a];
      return this;
    };
    b.prototype.removeAllListeners = function (a) {
      if (a && this._events.hasOwnProperty(a)) {
  ...
  var styleDocument = function () {
    ...
    styleElement.innerHTML =
      "html,body{background:#d7d7d7;font-family:Georgia;font-size:20px;overflow:hidden}#slideshow{background:#fff;position:absolute;-webkit-transform-origin:top left;-moz-transform-origin:top left;transform-origin:top-left}#slideshow .slide>.center{text-align:center}#slideshow .slide .content .center{display:block;text-align:center}#slideshow .slide>.middle{vertical-align:middle}#slideshow .slide{display:none;float:left;height:100%;overflow:hidden;width:100%;-moz-box-shadow:0 0 30px #888;-webkit-box-shadow:0 0 30px #888;box-shadow:0 0 30px #888}#slideshow .slide .content{display:table-cell;padding:1em 4em 1em 4em}#slideshow .slide .content pre{font-family:Monaco,monospace;font-size:16px}#slideshow .slide .content code{font-family:Monaco,monospace;font-size:16px}#slideshow .slide .content h1 code{font-size:.8em}#slideshow .slide .content .position{bottom:12px;opacity:.5;position:absolute;right:20px}p>code{padding:1px 4px}";

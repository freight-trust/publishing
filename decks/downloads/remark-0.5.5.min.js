!(function (e, t, n) {
...
})(
  {
    ...
    8: [
      function (require, module, exports) {
        ...
        SlideshowView.prototype.configureChildElements = function () {
          ...
          self.element = self.elementArea.getElementsByClassName(
            "remark-slideshow"
          )[0];
          self.positionElement = self.element.getElementsByClassName(
            "remark-position"
          )[0];
          self.previewArea = self.containerElement.getElementsByClassName(
            "remark-preview-area"
          )[0];
          self.previewElement = self.previewArea.getElementsByClassName(
            "remark-slideshow"
          )[0];
      ...
      { "./slideView": 15, "../resources": 4, "../utils": 12 },
    ],
    10: [
      function (require, module, exports) {
    ...
    15: [
      ...
      { "../converter": 17, "../highlighter": 3, "../utils": 12 },
    ],
    16: [
      function (require, module, exports) {

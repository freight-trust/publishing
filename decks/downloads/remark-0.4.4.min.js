(function () {
  ...
  (a.paths = []),
    ...
    a.define("/src/remark.js", function (a, b, c, d, e, f, g) {
      function q(a, b) {
        return a
          ? b
            ? !0
            : (j.alert("remark error: slideshow element not present."), !1)
          : (j.alert("remark error: source element not present."), !1);
      }
      function r() {
        var a = j.createElement("style"),
          b = j.getElementsByTagName("head")[0];
        (a.type = "text/css"),
          (a.innerHTML = p.documentStyles),
          (a.innerHTML += m.cssForStyle()),
      ...
      function s(a, b) {
        var c = a.innerHTML,
          ...
          e,
          f;
        (d = new n(c)), (e = new o(d, b)), (f = new k(d)), l.initialize();
      }
      var h = a("./remark/utils"),
        i = a("./remark/api"),
        j = a("./remark/dom"),
        k = a("./remark/controller").Controller,
        l = a("./remark/dispatcher"),
        m = a("./remark/highlighter"),
        n = a("./remark/models/slideshow").Slideshow,
        o = a("./remark/views/slideshowView").SlideshowView,
        p = a("./remark/resources");
      (j.exports.remark = i),
        j.on("load", function () {
          var a = j.getElementById("source"),
            b = j.getElementById("slideshow");
          if (!q(a, b)) return;
          (a.style.display = "none"), r(), s(a, b), i.emit("ready");
        });
    }),
    ...
    a.define("/src/remark/dom.js", function (a, b, c, d, e, f, g) {
      function j(a) {
        var b;
        return (
      ...
      function m() {
        (i.innerHeight = i.window.innerHeight),
          (i.innerWidth = i.window.innerWidth);
      }
      var h = a("events").EventEmitter,
        i = (b.exports = new h());
      (i.window = j("window")),
        (i.document = j("document")),
        (i.exports = i.window),
        k(i.window, "alert"),
        k(i.document, "createElement"),
        k(i.document, "getElementById"),
        k(i.document, "getElementsByTagName"),
        l(i.window, "load"),
        l(i.window, "resize"),
        l(i.window, "keydown"),
        l(i.window, "hashchange"),
        l(i.document, "touchstart"),
        l(i.document, "touchend"),
        l(i.document, "touchmove"),
        l(i.document, "mousewheel"),
        i.on("load", m),
        i.on("resize", m);
    }),
    ...
    a.define("/src/remark/dispatcher.js", function (a, b, c, d, e, f, g) {
      function k() {
        function a() {
          var a = (j.window.location.hash || "").substr(1);
          o(a);
        }
        j.on("hashchange", a), a();
      }
      ...
      function m() {
        var a,
          ...
          e = function () {
            c < j.innerWidth / 2 ? q() : p();
          },
          f = function () {
            b > c ? p() : q();
          };
        j.on("touchstart", function (c) {
          (a = c.touches[0]), (b = a.clientX);
        }),
          j.on("touchend", function (b) {
    ...
    a.define("/src/remark/highlighter.js", function (a, b, c, d, e, f, g) {
      ...
      (h.highlighter = {
        engine: function () {
          return j.highlighter.engine;
        },
      }),
        (k.cssForStyle = function () {
          return (
            i.highlightStyle === undefined && (i.highlightStyle = "default"),
            i.highlightStyle === null
              ? ""
              : j.highlighter.styles[i.highlightStyle]
          );
        }),
        (k.highlightCodeBlocks = function (a) {
          var b = a.getElementsByTagName("code"),
            c,
            d;
          for (d = 0; d < b.length; d++)
            (c = b[d]), j.highlighter.engine.highlightBlock(c, "  ");
        });
    }),
    a.define("/src/remark/config.js", function (a, b, c, d, e, f, g) {
      ...
      function m() {
        var a = /remark(-\d\.\d(\.\d)?)?(\.min)?\.js/i,
          b = j.getElementsByTagName("script"),
          c,
          d;
        for (d = 0; d < b.length; ++d) {
          c = b[d];
      ...
      function n(a) {
        ...
        try {
          ...
          j.alert("Parsing remark config failed! Be sure to use valid JSON.");
        }
        o(b);
      }
      function o(a) {
        ...
        for (b = 0; b < k.length; ++b)
          (c = k[b]), a.hasOwnProperty(c) && (h[c] = a[c]);
      }
      var h = (b.exports = l),
        i = a("./api"),
        j = a("./dom"),
        k = ["highlightInline", "highlightLanguage", "highlightStyle"];
      (i.config = h), m();
    }),
          ...
          var a = new (function () {
            ...
            function i(a, c) {
              ...
              function l() {
                ...
                return (
                  r.relevance > 0 &&
                    ((u += a.keyword_count), (t += a.relevance)),
            ...
            function j(a) {
              ...
              for (var e in o) {
                ...
                var f = i(e, a);
                (f.language = e),
                  f.keyword_count + f.relevance >
                    d.keyword_count + d.relevance && (d = f),
                  f.keyword_count + f.relevance >
                    c.keyword_count + c.relevance && ((d = c), (c = f));
              }
    ...
    a.define("/src/remark/models/slideshow.js", function (a, b, c, d, e, f, g) {
      ...
      function j(a) {
        ...
        while ((e = c.exec(a)) !== null)
          b.push(h.create(a.substr(0, e.index), { continued: d.toString() })),
            (a = a.substr(e.index + e[0].length)),
            (d = e[0] === "\n--\n");
        return a !== "" && b.push(h.create(a, { continued: d.toString() })), b;
      }
      function k(a) {
        var b = {};
        return (
      ...
      var h = a("./slide").Slide;
      (c.Slideshow = i),
        (i.prototype.getSlideByName = function (a) {
    ...
    a.define("/src/remark/views/slideshowView.js", function (
      ...
      var h = a("../api"),
        ...
        n = 4;
      (c.SlideshowView = o),
        (o.prototype.showSlide = function (a) {
        ...
        (o.prototype.hideSlide = function (a) {
          var b = this.slideViews[a];
    ...
    a.define("/src/remark/views/slideView.js", function (a, b, c, d, e, f, g) {
      function k(a) {
        (this.slide = a),
          (this.element = l()),
          (this.contentElement = m(a.source, a.properties)),
    ...
    a.define("/index.js", function (a, b, c, d, e, f, g) {
      var h = a("./src/remark");
    }),
    a("/index.js");
})();

!(function (context) {
  ...
  var createStyle = function () {
    ...
    style.type = "text/css";
    style.innerHTML =
      "html,body{background:#d7d7d7;font-family:Georgia;font-size:20px;overflow:hidden}#slideshow{background:#fff;position:absolute;-webkit-transform-origin:top left;-moz-transform-origin:top left;transform-origin:top-left}#slideshow .slide>.center{text-align:center}#slideshow .slide .content .center{display:block;text-align:center}#slideshow .slide>.middle{vertical-align:middle}#slideshow .slide{display:none;float:left;height:100%;overflow:hidden;width:100%;-moz-box-shadow:0 0 30px #888;-webkit-box-shadow:0 0 30px #888;box-shadow:0 0 30px #888}#slideshow .slide .content{display:table-cell;padding:1em 4em 1em 4em}#slideshow .slide .content pre{border-left:.4em solid #d7d7d7;font-family:Monaco,monospace;font-size:16px;padding:1em!important}#slideshow .slide .content pre code{background:transparent!important}#slideshow .slide .content code{font-family:Monaco,monospace;font-size:16px}#slideshow .slide .content h1 code{font-size:.8em} pre code{display:block;padding:.5em;background:#f0f0f0}pre code,code .ruby .subst,code .tag .title,code .lisp .title{color:black}code .string,code .title,code .constant,code .parent,code .tag .value,code .rules .value,code .rules .value .number,code .codeprocessor,code .ruby .symbol,code .ruby .symbol .string,code .ruby .symbol .keyword,code .ruby .symbol .keymethods,code .instancevar,code .aggregate,code .template_tag,code .django .variable,code .smalltalk .class,code .addition,code .flow,code .stream,code .bash .variable,code .apache .tag,code .apache .cbracket,code .tex .command,code .tex .special{color:#800}code .comment,code .annotation,code .template_comment,code .diff .header,code .chunk{color:#888}code .number,code .date,code .regexp,code .literal,code .smalltalk .symbol,code .smalltalk .char,code .change{color:#080}code .label,code .javadoc,code .ruby .string,code .decorator,code .filter .argument,code .localvars,code .array,code .attr_selector,code .important,code .pseudo,code .pi,code .doctype,code .deletion,code .envvar,code .shebang,code .apache .sqbracket,code .nginx .built_in,code .tex .formula{color:#88F}code .javadoctag,code .phpdoc,code .yardoctag{font-weight:bold}code .keyword,code .id,code .phpdoc,code .title,code .built_in,code .aggregate,code .smalltalk .class,code .winutils,code .bash .variable,code .apache .tag,code .tex .command{font-weight:bold}code .nginx .built_in{font-weight:normal}code .html .css,code .html .javascript,code .html .vbscript,code .tex .formula{opacity:.5}";
    return style;
  };

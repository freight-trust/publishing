!(function (e, t, n) {
...
})(
  {
    ...
    8: [
      ...
      { "./slideView": 14, "./overlayView": 15, "../utils": 11 },
    ],
    10: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        ...
        Parser.prototype.parse = function (src) {
          var lexer = new Lexer(),
            ...
            slides = [],
            slide = { source: "", properties: { continued: "false" } },
            tag,
            classes;
          tokens.forEach(function (token) {
            switch (token.type) {
              ...
              case "separator":
                ...
                slide = {
                  source: "",
                  properties: { continued: (token.text === "--").toString() },
                };
                break;
            }
          });
    ...
    14: [
      ...
      { "../converter": 17, "../highlighter": 3, "../utils": 11 },
    ],
    15: [
      function (require, module, exports) {

!(function (a) {
  ...
  (function (a) {
    ...
    (c.prototype.fire = function (a) {
      this.listener.apply(this.scope || this, a);
      if (this.once)
        return this.instance.removeListener(this.type, this.listener), !1;
    }),
      (b.prototype.eachListener = function (a, b) {
        var c = null,
          d = null,
          e = null;
        if (this._events.hasOwnProperty(a)) {
          ...
          for (c = 0; c < d.length; c += 1)
            if (((e = b.call(this, d[c], c)), e === !1)) c -= 1;
            else if (e === !0) break;
        }
        return this;
      }),
      (b.prototype.addListener = function (a, b, d, e) {
        return (
          this._events.hasOwnProperty(a) || (this._events[a] = []),
          this._events[a].push(new c(a, b, d, e, this)),
          this.emit("newListener", a, b, d, e),
          this._maxListeners &&
      ...
      (b.prototype.once = function (a, b, c) {
        return this.addListener(a, b, c, !0);
      }),
      (b.prototype.removeListener = function (a, b) {
        return (
          this.eachListener(a, function (c, d) {
            c.listener === b && this._events[a].splice(d, 1);
          }),
          this._events[a] &&
            this._events[a].length === 0 &&
      ...
      (b.prototype.removeAllListeners = function (a) {
        return (
          a && this._events.hasOwnProperty(a)
            ? delete this._events[a]
            : a || (this._events = {}),
          this
        );
      ...
      (b.prototype.listeners = function (a) {
        if (this._events.hasOwnProperty(a)) {
          var b = [];
          return (
            this.eachListener(a, function (a) {
              b.push(a.listener);
            }),
            b
          );
      ...
      (b.prototype.emit = function (a) {
        for (var b = [], c = null, c = 1; c < arguments.length; c += 1)
          b.push(arguments[c]);
        return (
          this.eachListener(a, function (a) {
            return a.fire(b);
    ...
    (b.events = new EventEmitter()),
    (b.exports.events = new EventEmitter()),
    (a.remark = b.exports),
    !(function (a) {
      var b = ["highlightInline", "highlightLanguage", "highlightStyle"],
        c = (a.config = a.exports.config = function (a) {
          var b;
          f(a);
        }),
        d = function () {
        ...
        e = function (a) {
          ...
          try {
            ...
            alert(
              "Parsing of remark config failed! Be sure to use valid JSON."
            );
          }
          f(b);
        },
        f = function (a) {
          var d, e;
          for (d = 0; d < b.length; ++d)
            (e = b[d]), a.hasOwnProperty(e) && (c[e] = a[e]);
        };
      d();
    })(b),
    !(function (a) {
      ...
      b.create = function (b) {
        ...
        (window.onhashchange = e),
          e(),
          a.events.on("previousSlide", function () {
            d(b, c - 1);
          }),
          a.events.on("nextSlide", function () {
            d(b, c + 1);
          });
      };
      var d = function (a, b) {
    ...
    !(function (a) {
      (function () {
        ...
        (a.list = m(a.list)("bullet", /(?:[*+-](?!(?: *[-*]){2,})|\d+\.)/)()),
          (a.html = m(a.html)("comment", /<!--[^\0]*?-->/)(
            "closed",
            /<(tag)[^\0]+?<\/\1>/
          )("closing", /<tag(?!:\/|@)\b(?:"[^"]*"|'[^']*'|[^'">])*?>/)(
            /tag/g,
          ...
          (a.paragraph = (function () {
            ...
            return (
              ...
              })("hr")("heading")("lheading")("blockquote")("<" + l())("def"),
        ...
        (b._linkInside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/),
          (b._linkHref = /\s*<?([^\s]*?)>?(?:\s+"([^\n]+)")?\s*/),
          (b.link = m(b.link)("inside", b._linkInside)("href", b._linkHref)()),
          (b.reflink = m(b.reflink)("inside", b._linkInside)()),
          (b.normal = { url: b.url, strong: b.strong, em: b.em, text: b.text }),
          (b.pedantic = {
          ...
          (b.lexer = function (a) {
            var e = "",
              ...
              l;
            while (a) {
              if ((l = b.escape.exec(a))) {
                (a = a.substring(l[0].length)), (e += l[1]);
                continue;
              }
              if ((l = b.autolink.exec(a))) {
                (a = a.substring(l[0].length)),
                  l[2] === "@"
                    ? ((h = l[1][6] === ":" ? k(l[1].substring(7)) : k(l[1])),
                      (i = k("mailto:") + h))
                    : ((h = j(l[1])), (i = h)),
                  (e += '<a href="' + i + '">' + h + "</a>");
                continue;
              ...
              if ((l = b.tag.exec(a))) {
                (a = a.substring(l[0].length)),
                  (e += p.sanitize ? j(l[0]) : l[0]);
                continue;
              }
              if ((l = b.link.exec(a))) {
                (a = a.substring(l[0].length)),
                  (e += c(l, { href: l[2], title: l[3] }));
                continue;
              }
              if ((l = b.reflink.exec(a)) || (l = b.nolink.exec(a))) {
                (a = a.substring(l[0].length)),
                  (g = (l[2] || l[1]).replace(/\s+/g, " ")),
                  (g = f[g.toLowerCase()]);
                if (!g || !g.href) {
                  (e += l[0][0]), (a = l[0].substring(1) + a);
                  continue;
                }
                e += c(l, g);
                continue;
              }
              if ((l = b.strong.exec(a))) {
                (a = a.substring(l[0].length)),
                  (e += "<strong>" + b.lexer(l[2] || l[1]) + "</strong>");
                continue;
              }
              if ((l = b.em.exec(a))) {
                (a = a.substring(l[0].length)),
                  (e += "<em>" + b.lexer(l[2] || l[1]) + "</em>");
                continue;
              }
              if ((l = b.code.exec(a))) {
                (a = a.substring(l[0].length)),
              ...
              if ((l = b.br.exec(a))) {
                (a = a.substring(l[0].length)), (e += "<br>");
                continue;
              }
              if ((l = b.text.exec(a))) {
                (a = a.substring(l[0].length)), (e += j(l[0]));
                continue;
              }
            }
            return e;
        ...
        var c = function (a, c) {
            ...
            switch (e.type) {
              ...
              case "code":
                return (
                  ...
                  (e.lang ? ' class="' + e.lang + '"' : "") +
                  ">" +
                  (e.escaped ? e.text : j(e.text, !0)) +
                  "</code></pre>\n"
                );
              case "blockquote_start":
                var a = "";
                while (f().type !== "blockquote_end") a += g();
                return "<blockquote>\n" + a + "</blockquote>\n";
              case "list_start":
                var c = e.ordered ? "ol" : "ul",
                  a = "";
                while (f().type !== "list_end") a += g();
                return "<" + c + ">\n" + a + "</" + c + ">\n";
              case "list_item_start":
                var a = "";
                while (f().type !== "list_item_end")
                  a += e.type === "text" ? h() : g();
                return "<li>" + a + "</li>\n";
              case "loose_item_start":
                var a = "";
                while (f().type !== "list_item_end") a += g();
                return "<li>" + a + "</li>\n";
              case "html":
                return p.sanitize
                  ? b.lexer(e.text)
          ...
          h = function () {
            var a = e.text,
              c;
            while ((c = d[d.length - 1]) && c.type === "text")
              a += "\n" + f().text;
            return b.lexer(a);
          },
          i = function (a) {
            ...
            (p = c),
              p.gfm
                ...
                : ((a.fences = a.normal.fences),
                  ...
                  (b.text = b.normal.text),
                  (b.url = b.normal.url)),
              p.pedantic
                ? ((b.em = b.pedantic.em), (b.strong = b.pedantic.strong))
                : ((b.em = b.normal.em), (b.strong = b.normal.strong));
          };
        (o.options = o.setOptions = function (a) {
          (q = a), r(a);
        }),
          o.options({ gfm: !0, pedantic: !1, sanitize: !1 }),
          (o.parser = function (a, b) {
            return r(b), i(a);
          }),
          (o.lexer = function (b, c) {
            return r(c), a.lexer(b);
          }),
          (o.parse = o),
      ...
      var b = (a.converter = {});
      marked.setOptions({ gfm: !1 }),
        (b.convertSlideClasses = function (a) {
          var b = /(?:^|\n)(\\)?((?:\.[a-z_-][a-z-_0-9]*)+)\s*(?:$|\n)/gi,
            c,
            d,
            e = ["content"],
        ...
        (b.convertContentClasses = function (a) {
          var b = /(\\)?((?:\.[a-z_-][a-z-_0-9]*)+)\[/gi,
            ...
            g,
            h;
          while ((d = b.exec(a.innerHTML))) {
            f = c(a.innerHTML.substr(d.index + d[0].length));
            if (f === null) continue;
            d[1]
              ? ((g = d[2] + "[" + f + "]"), (b.lastIndex = d.index + g.length))
              : ((e = d[2].substr(1).split(".")),
                (g = '<span class="' + e.join(" ") + '">' + f + "</span>"),
                (b.lastIndex =
                  d.index + ('<span class="' + e.join(" ") + '">').length)),
              (h = a.innerHTML.substr(d.index + d[0].length + f.length + 1)),
              (a.innerHTML = a.innerHTML.substr(0, d.index) + g + h);
          }
        });
      var c = function (a) {
        var b = 1,
      ...
      (b.convertMarkdown = function (a) {
        (a.innerHTML = marked(a.innerHTML.trim(" "))),
          (a.innerHTML = a.innerHTML.replace(/&[l|g]t;/g, function (a) {
            return a === "&lt;" ? "<" : ">";
          })),
          (a.innerHTML = a.innerHTML.replace(/&amp;/g, "&"));
      }),
        (b.convertCodeClasses = function (a) {
          var b = a.getElementsByTagName("code"),
            c;
          for (c = 0; c < b.length; c++) d(b[c]);
        });
      var d = function (b) {
          var c = a.config.highlightLanguage,
            d = a.config.highlightInline,
            f = b.parentNode.nodeName.toUpperCase() !== "PRE";
          if (e(b)) return;
          f && !d ? (b.className = "no-highlight") : c && (b.className = c);
        },
        e = function (a) {
          var b = /^(\\)?\.([a-z_-][a-z-_0-9]*)(?:\n|\ )/i,
            c;
      ...
      var c = function () {
        ...
        d = function () {
          ...
          document.addEventListener("touchstart", function (a) {
            ...
            document.addEventListener("touchend", function (a) {
              ...
              (b = a.changedTouches[0]), (d = b.clientX), e() ? h() : i();
            }),
        ...
        e = function () {
          document.addEventListener("mousewheel", function (a) {
            a.wheelDeltaY > 0 ? g() : a.wheelDeltaY < 0 && f();
          });
        },
        f = function () {
          a.events.emit("nextSlide");
        },
        g = function () {
          a.events.emit("previousSlide");
        };
    })(b),
    !(function (a) {
      var b = new (function () {
        ...
        function i() {
          function a(d, e, f) {
            ...
            f ||
              ((d.bR = c(e, d.b ? d.b : "\\B|\\b")),
              !d.e && !d.eW && (d.e = "\\B|\\b"),
              d.e && (d.eR = c(e, d.e))),
              d.i && (d.iR = c(e, d.i)),
              d.r == undefined && (d.r = 1),
              d.k && (d.lR = c(e, d.l || b.IR, !0));
            for (var g in d.k) {
              if (!d.k.hasOwnProperty(g)) continue;
              d.k[g] instanceof Object
                ? (d.kG = d.k)
                : (d.kG = { keyword: d.k });
              break;
            }
            d.c || (d.c = []), (d.compiled = !0);
            for (var h = 0; h < d.c.length; h++) a(d.c[h], e, !1);
            d.starts && a(d.starts, e, !1);
          }
          for (var d in p) {
        ...
        function j(b, d) {
          ...
          function h(a, b) {
            ...
            while (s[f + 1].eW);
            return a.i && d.push(a.i), c(b, "(" + d.join("|") + ")", !0);
          }
          function k(a, b) {
            var c = s[s.length - 1];
        ...
        function k(b) {
          ...
          for (var e in p) {
            ...
            (f.language = e),
              ...
              f.keyword_count + f.r > c.keyword_count + c.r &&
                ((d = c), (c = f));
          }
        ...
        function m(a, b, c) {
          ...
          if (n.length) {
            ...
            (o.innerHTML = m.value), (m.value = h(n, g(o), d));
          }
      ...
      (b.LANGUAGES.bash = (function () {
        var a = { true: 1, false: 1 },
          c = { cN: "variable", b: "\\$([a-zA-Z0-9_]+)\\b" },
          d = { cN: "variable", b: "\\$\\{(([^}])|(\\\\}))+\\}", c: [b.CNM] },
          e = { cN: "string", b: '"', e: '"', i: "\\n", c: [b.BE, c, d], r: 0 },
          f = {
            cN: "test_condition",
            b: "",
        ...
        (b.LANGUAGES.erlang = (function () {
          var a = "[a-z'][a-zA-Z0-9_']*",
            ...
            k = {
              ...
              rB: !0,
              c: [
                { cN: "record_name", b: "#" + b.UIR, r: 0 },
                { b: "{", eW: !0, r: 0 },
              ],
            },
            l = { k: d, b: "(fun|receive|if|try|case)", e: "end" };
          l.c = [
            e,
            f,
            b.inherit(b.ASM, { cN: "" }),
          ...
          var m = [e, f, l, g, b.QSM, b.CNM, h, i, j, k];
        ...
        (b.LANGUAGES.ruby = (function () {
          var a = "[a-zA-Z_][a-zA-Z0-9_]*(\\!|\\?)?",
            ...
            f = { cN: "comment", b: "#", e: "$", c: [e] },
            g = { cN: "comment", b: "^\\=begin", e: "^\\=end", c: [e], r: 10 },
            h = { cN: "comment", b: "^__END__", e: "\\n$" },
            i = { cN: "subst", b: "#\\{", e: "}", l: a, k: d },
            j = [b.BE, i],
            ...
            u = {
              ...
              k: d,
              c: [
                { cN: "title", b: c, l: a, k: d },
                { cN: "params", b: "\\(", e: "\\)", l: a, k: d },
                f,
                g,
                h,
              ],
            },
            v = { cN: "identifier", b: a, l: a, k: d, r: 0 },
            w = [
              f,
              g,
              h,
          ...
          return (i.c = w), (u.c[1].c = w), { dM: { l: a, k: d, c: w } };
        })()),
        (b.LANGUAGES.diff = {
          cI: !0,
          dM: {
        ...
        (b.LANGUAGES.lua = (function () {
          var a = "\\[=*\\[",
            c = "\\]=*\\]",
            d = { b: a, e: c };
          d.c = [d];
          var e = { cN: "comment", b: "--(?!" + a + ")", e: "$" },
            f = { cN: "comment", b: "--" + a, e: c, c: [d], r: 10 };
          return {
            dM: {
              l: b.UIR,
              k: {
              ...
              c: [
                ...
                b.ASM,
                b.QSM,
                { cN: "string", b: a, e: c, c: [d], r: 10 },
              ],
            },
          };
        })()),
        (b.LANGUAGES.css = (function () {
          var a = {
            cN: "function",
            b: b.IR + "\\(",
            e: "\\)",
            c: [{ eW: !0, eE: !0, c: [b.NM, b.ASM, b.QSM] }],
          };
          return {
            cI: !0,
            dM: {
        ...
        (b.LANGUAGES.lisp = (function () {
          var a =
              "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#]*",
            c = "(\\-|\\+)?\\d+(\\.\\d+|\\/\\d+)?((d|e|f|l|s)(\\+|\\-)?\\d+)?",
            d = { cN: "literal", b: "\\b(t{1}|nil)\\b" },
            e = { cN: "number", b: c },
            f = { cN: "number", b: "#b[0-1]+(/[0-1]+)?" },
            g = { cN: "number", b: "#o[0-7]+(/[0-7]+)?" },
            h = { cN: "number", b: "#x[0-9a-f]+(/[0-9a-f]+)?" },
            i = { cN: "number", b: "#c\\(" + c + " +" + c, e: "\\)" },
            j = { cN: "string", b: '"', e: '"', c: [b.BE], r: 0 },
            k = { cN: "comment", b: ";", e: "$" },
            l = { cN: "variable", b: "\\*", e: "\\*" },
            m = { cN: "keyword", b: "[:&]" + a },
            n = { b: "\\(", e: "\\)" };
          ...
          return (
            (q.c = [{ cN: "title", b: a }, r]),
            (r.c = [o, p, q, d, e, f, g, h, i, j, k, l, m]),
            {
              cI: !0,
              dM: { i: "[^\\s]", c: [d, e, f, g, h, i, j, k, o, p, q] },
            }
          );
        })()),
        (b.LANGUAGES.profile = {
          dM: {
            c: [
              ...
              { cN: "summary", b: "function calls", e: "$", c: [b.CNM], r: 10 },
              b.ASM,
              b.QSM,
              {
                cN: "function",
        ...
        (b.LANGUAGES["1c"] = (function () {
          var a = "[a-zA-Zа-яА-Я][a-zA-Z0-9_а-яА-Я]*",
            ...
            e = { cN: "dquote", b: '""' },
            f = { cN: "string", b: '"', e: '"|$', c: [e], r: 0 },
            g = { cN: "string", b: "\\|", e: '"|$', c: [e] };
          return {
            cI: !0,
            dM: {
              l: a,
              k: { keyword: c, built_in: d },
              c: [
                b.CLCM,
                b.NM,
                f,
        ...
        (b.LANGUAGES.python = (function () {
          var a = { cN: "string", b: "(u|b)?r?'''", e: "'''", r: 10 },
            c = { cN: "string", b: '(u|b)?r?"""', e: '"""', r: 10 },
            d = { cN: "string", b: "(u|r|ur|b|br)'", e: "'", c: [b.BE], r: 10 },
            e = { cN: "string", b: '(u|r|ur|b|br)"', e: '"', c: [b.BE], r: 10 },
            f = { cN: "title", b: b.UIR },
            g = {
              cN: "params",
              b: "\\(",
              e: "\\)",
              c: [a, c, d, e, b.ASM, b.QSM],
            };
          return {
            dM: {
              k: {
        ...
        (b.LANGUAGES.smalltalk = (function () {
          var a = "[a-z][a-zA-Z0-9_]*",
            c = { cN: "char", b: "\\$.{1}" },
            d = { cN: "symbol", b: "#" + b.UIR };
          return {
            dM: {
              ...
              c: [
                ...
                { cN: "array", b: "\\#\\(", e: "\\)", c: [b.ASM, c, b.CNM, d] },
              ],
            },
          };
        })()),
        (b.LANGUAGES.tex = (function () {
            ...
            c: [
              {
                ...
                c: [
                  ...
                  { cN: "title", b: b.UIR, e: b.IMMEDIATE_RE },
                ],
              },
              b.CLCM,
              b.CBLCLM,
              ...
              { cN: "constant", b: " [A-Z_]+ ", e: b.IMMEDIATE_RE, r: 0 },
            ],
          },
        }),
        (b.LANGUAGES.ini = {
        ...
        (b.LANGUAGES.perl = (function () {
          var a = {
            ...
            h = [
              ...
              { cN: "regexp", b: "(m|qr)?/", e: "/[a-z]*", c: [b.BE], r: 0 },
              {
                cN: "sub",
                b: "\\bsub\\b",
                e: "(\\s*\\(.*?\\))?[;{]",
          ...
          return (c.c = h), (g.c[1].c = h), { dM: { k: a, c: h } };
        })()),
        (b.LANGUAGES.scala = (function () {
          var a = { cN: "annotation", b: "@[A-Za-z]+" },
            c = { cN: "string", b: 'u?r?"""', e: '"""', r: 10 };
          return {
            dM: {
              k: {
                type: 1,
        ...
        (b.LANGUAGES.cmake = {
          ...
          dM: {
            ...
            c: [{ cN: "envvar", b: "\\${", e: "}" }, b.HCM, b.QSM, b.NM],
          },
        }),
        (b.LANGUAGES.objectivec = (function () {
          var a = {
            keyword: {
              false: 1,
              int: 1,
        ...
        (b.LANGUAGES.nginx = (function () {
          var a = { cN: "variable", b: "\\$\\d+" },
            c = { cN: "variable", b: "\\${", e: "}" },
            d = { cN: "variable", b: "[\\$\\@]" + b.UIR };
          return {
            dM: {
              c: [
                b.HCM,
        ...
        (b.LANGUAGES.django = (function () {
          function a(a, b) {
            return (
              b == undefined || (!a.cN && b.cN == "tag") || a.cN == "value"
            );
          }
          function c(b, d) {
            var f = {};
            for (var g in b) {
              g != "contains" && (f[g] = b[g]);
              var h = [];
              for (var i = 0; b.c && i < b.c.length; i++) h.push(c(b.c[i], b));
              a(b, d) && (h = e.concat(h)), h.length && (f.c = h);
            }
            return f;
          }
          var d = {
          ...
          return { cI: !0, dM: c(b.LANGUAGES.xml.dM) };
        })()),
        (b.LANGUAGES.delphi = (function () {
          var a = {
              and: 1,
              safecall: 1,
              cdecl: 1,
            ...
            e = { cN: "comment", b: "\\(\\*", e: "\\*\\)", r: 10 },
            f = { cN: "string", b: "'", e: "'", c: [{ b: "''" }], r: 0 },
            g = { cN: "string", b: "(#\\d+)+" },
            h = {
              cN: "function",
      ...
      (c.cssForStyle = function () {
        var b = a.config;
        return (
          b.highlightStyle === undefined && (b.highlightStyle = "default"),
          b.highlightStyle === null ? "" : d[b.highlightStyle]
        );
      }),
        (c.highlightCodeBlocks = function (a) {
          var c = a.getElementsByTagName("code"),
            d,
            e;
          for (e = 0; e < c.length; e++) (d = c[e]), b.highlightBlock(d, "  ");
        });
    })(b),
    !(function (a) {
      !(function (a) {
        ...
        var c = function (a) {
            ...
            (b.innerHTML = a.source()), d(b);
          },
          d = function (b) {
            a.converter.convertContentClasses(b),
              a.converter.convertSlideClasses(b),
              a.converter.convertMarkdown(b),
              a.converter.convertCodeClasses(b),
              a.highlighter.highlightCodeBlocks(b);
          };
      })(a);
      var b = (a.slideshow = {}),
        c = 227,
      ...
      b.create = function (b, c) {
        var d = f(b, c),
          e = document.createElement("div");
        (e.className = "position"), c.appendChild(e), g(c);
        ...
        return {
          showSlide: function (b) {
            var c = d[b];
            a.exports.events.emit("slidein", c.element(), b),
              (c.element().style.display = "table"),
              (e.innerHTML = b + 1 + " / " + d.length);
          },
          hideSlide: function (b) {
            var c = d[b];
            a.exports.events.emit("slideout", c.element(), b),
      ...
      var f = function (b, c) {
          var d,
            ...
            g;
          d = b.split(/\n\n---\n/);
          for (g = 0; g < d.length; ++g) e.push(a.slide.create(d[g]));
          return e;
        },
        g = function (a) {
          var b = c * e,
            ...
            g = function () {
              var g = window.innerHeight,
                h = window.innerWidth,
                i;
              h / e > g / d ? (i = g / (c * d)) : (i = h / (c * e)),
                (a.style["-webkit-transform"] = "scale(" + i + ")"),
                (a.style.MozTransform = "scale(" + i + ")"),
                (a.style.left = (h - b * i) / 2 + "px"),
                (a.style.top = (g - f * i) / 2 + "px");
            };
          (a.style.width = c * e + "px"),
            (a.style.height = c * d + "px"),
            (window.onresize = g),
            window.onresize();
        };
    })(b),
  ...
  var c = function (a, b) {
    ...
    d = function () {
      ...
      (a.type = "text/css"),
        ...
        (a.innerHTML += b.highlighter.cssForStyle()),
        c.insertBefore(a, c.firstChild);
    },
    e = function (a, c) {
      var d = a.innerHTML,
        e;
      (e = b.slideshow.create(d, c)),
        b.controller.create(e),
        b.dispatcher.create();
    };
})(this);

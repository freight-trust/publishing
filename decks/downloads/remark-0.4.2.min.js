  ...
  require.define("/src/remark.js", function (a, b, c, d, e) {
    ...
    (h.exports.remark = g),
      h.on("load", function () {
        ...
        if (!o(a, b)) return;
        (a.style.display = "none"), p(), q(a, b), g.emit("ready");
      });
  }),
  ...
  require.define("/src/remark/dom.js", function (a, b, c, d, e) {
    ...
    function i(a, b) {
      typeof a[b] == "function"
        ...
        : ["createElement", "getElementById"].indexOf(b) !== -1
        ? (g[b] = function () {
            return {
              style: {},
  ...
  require.define("/node_modules/marked/lib/marked.js", function (
    ...
    (function () {
      ...
      function i() {
        var a = f.text,
          b;
        while ((b = e[e.length - 1]) && b.type === "text") a += "\n" + g().text;
        return c.lexer(a);
      }
      function j(a) {
        e = a.reverse();
      ...
      (p.options = p.setOptions = function (a) {
        ...
        p.setOptions({ gfm: !0, pedantic: !1, sanitize: !1, highlight: null }),

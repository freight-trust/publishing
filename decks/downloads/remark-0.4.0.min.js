...
(require.paths = []),
  ...
  (require.define = function (a, b) {
    ...
    (d.resolve = function (a) {
      ...
      (d.modules = require.modules),
      (d.define = require.define);
    var e = { exports: {} };
    require.modules[a] = function () {
      return (
        (require.modules[a]._cached = e.exports),
        b.call(e.exports, d, e, e.exports, c, a),
        (require.modules[a]._cached = e.exports),
        e.exports
      );
    };
  ...
  process.nextTick ||
    (process.nextTick = (function () {
      ...
      return (
        ...
        function (c) {
          b
            ? (a.push(c), window.postMessage("browserify-tick", "*"))
            : setTimeout(c, 0);
        }
      );
    })()),
    ...
    (c.resolve = function () {
      ...
      (c.dirname = function (a) {
        var b = h.exec(a)[1] || "",
          c = !1;
        return b
          ? b.length === 1 || (c && b.length <= 3 && b.charAt(1) === ":")
            ? b
  ...
  require.define("/src/remark.js", function (a, b, c, d, e) {
    function o(a, b) {
      return a
        ? b
          ? !0
          : (h.alert("remark error: slideshow element not present."), !1)
        : (h.alert("remark error: source element not present."), !1);
    }
    function p() {
      var a = h.createElement("style"),
        b = h.getElementsByTagName("head")[0];
      (a.type = "text/css"),
        (a.innerHTML = n.documentStyles),
        (a.innerHTML += k.cssForStyle()),
    ...
    function q(a, b) {
      var c = a.innerHTML,
        ...
        e,
        f;
      (d = new l(c)), (e = new m(d, b)), (f = new i(d)), j.initialize();
    }
    var f = a("./remark/utils"),
      g = a("./remark/api"),
      h = a("./remark/dom"),
      i = a("./remark/controller").Controller,
      j = a("./remark/dispatcher"),
      k = a("./remark/highlighter"),
      l = a("./remark/models/slideshow").Slideshow,
      m = a("./remark/views/slideshowView").SlideshowView,
      n = a("./remark/resources");
    (h.exports.remark = g),
      h.on("load", function () {
        var a = h.getElementById("source"),
          b = h.getElementById("slideshow");
        if (!o(a, b)) return;
        (a.style.display = "none"), p(), q(a, b);
      });
  }),
  require.define("/src/remark/utils.js", function (a, b, c, d, e) {
    (Array.prototype.each =
      Array.prototype.each ||
      function (a) {
        var b;
        for (b = 0; b < this.length; ++b) a(this[b], b);
      }),
  ...
  require.define("/src/remark/api.js", function (a, b, c, d, e) {
  ...
  require.define("events", function (a, b, c, d, e) {
    ...
    (f.prototype.setMaxListeners = function (a) {
      ...
      (f.prototype.removeAllListeners = function (a) {
        return (
          a && this._events && this._events[a] && (this._events[a] = null), this
        );
      }),
  ...
  require.define("/src/remark/dom.js", function (a, b, c, d, e) {
    function h(a) {
      return (
        typeof this[a] != "undefined"
          ? (a = this[a])
          : ((a = new f()), (a.addEventListener = a.on)),
        a
      );
    }
    function i(a, b) {
    ...
    var f = a("events").EventEmitter,
      g = (b.exports = new f());
    (g.window = h("window")),
      (g.document = h("document")),
      (g.exports = g.window),
      i(g.window, "alert"),
      i(g.document, "createElement"),
      i(g.document, "getElementById"),
      i(g.document, "getElementsByTagName"),
      j(g.window, "load"),
      j(g.window, "resize"),
      j(g.window, "keydown"),
      j(g.window, "hashchange"),
      j(g.document, "touchstart"),
      j(g.document, "touchend"),
      j(g.document, "touchmove"),
      j(g.document, "mousewheel"),
      g.on("load", k),
      g.on("resize", k);
  }),
  require.define("/src/remark/controller.js", function (a, b, c, d, e) {
    function h(a) {
      function c(a, c) {
        var e = d(c),
          h = e === b,
          i = e < 1 || e > a.getSlideCount();
        if (h || i) return;
        b !== 0 && f.emit("hideSlide", b - 1),
          f.emit("showSlide", e - 1),
          (b = e),
          (g.window.location.hash = c);
      }
      function d(b) {
        var c, d;
        return typeof b == "number"
          ? b
          : (c = parseInt(b, 10)).toString() === b
          ? c
          : (d = a.getSlideByName(b))
          ? d.index + 1
          : 1;
      }
      var b = 0;
      f.on("gotoSlide", function (b) {
        c(a, b);
      }),
        f.on("gotoPreviousSlide", function () {
          c(a, b - 1);
        }),
        f.on("gotoNextSlide", function () {
          c(a, b + 1);
        });
    }
    var f = a("./dispatcher"),
  ...
  require.define("/src/remark/dispatcher.js", function (a, b, c, d, e) {
    function i() {
      function a() {
        var a = (h.window.location.hash || "").substr(1);
        m(a);
      }
      h.on("hashchange", a), a();
    }
    ...
    function k() {
      var a,
        ...
        e = function () {
          c < h.innerWidth / 2 ? o() : n();
        },
        f = function () {
          b > c ? n() : o();
        };
      h.on("touchstart", function (c) {
        (a = c.touches[0]), (b = a.clientX);
      }),
        h.on("touchend", function (b) {
          if (b.target.nodeName.toUpperCase() === "A") return;
          (a = b.changedTouches[0]), (c = a.clientX), d() ? e() : f();
        }),
    ...
    function l() {
      h.on("mousewheel", function (a) {
        a.wheelDeltaY > 0 ? o() : a.wheelDeltaY < 0 && n();
      });
    }
    function m(a) {
      g.emit("gotoSlide", a);
    ...
    function n() {
      g.emit("gotoNextSlide");
    }
    function o() {
      g.emit("gotoPreviousSlide");
    }
    var f = a("events").EventEmitter,
      g = (b.exports = new f()),
      h = a("./dom");
  ...
  require.define("/src/remark/highlighter.js", function (a, b, c, d, e) {
    var f = a("./api"),
      g = a("./config"),
      h = a("./resources"),
      i = (b.exports = {});
    (f.highlighter = {
      engine: function () {
        return h.highlighter.engine;
      },
    }),
      (i.cssForStyle = function () {
        return (
          g.highlightStyle === undefined && (g.highlightStyle = "default"),
          g.highlightStyle === null
            ? ""
            : h.highlighter.styles[g.highlightStyle]
        );
      }),
      (i.highlightCodeBlocks = function (a) {
        var b = a.getElementsByTagName("code"),
          c,
          d;
        for (d = 0; d < b.length; d++)
          (c = b[d]), h.highlighter.engine.highlightBlock(c, "  ");
      });
  }),
  require.define("/src/remark/config.js", function (a, b, c, d, e) {
    function j(a) {
      m(a);
    }
    function k() {
      var a = /remark(-\d\.\d(\.\d)?)?(\.min)?\.js/i,
    ...
    function l(a) {
      ...
      try {
        ...
        h.alert("Parsing remark config failed! Be sure to use valid JSON.");
      }
      m(b);
    }
    function m(a) {
      ...
      for (b = 0; b < i.length; ++b)
        (c = i[b]), a.hasOwnProperty(c) && (f[c] = a[c]);
    }
    var f = (b.exports = j),
      g = a("./api"),
      h = a("./dom"),
      i = ["highlightInline", "highlightLanguage", "highlightStyle"];
    (g.config = f), k();
  }),
  require.define("/src/remark/resources.js", function (a, b, c, d, e) {
    (b.exports = {
      documentStyles:
      ...
      (b.exports.highlighter.engine = (function () {
        var a = new (function () {
          ...
          function e(a) {
            ...
            for (var c = 0; c < b.length; c++)
              if (o[b[c]] || b[c] == "no-highlight") return b[c];
          }
          function f(a) {
            var b = [];
            return (
              (function c(a, d) {
                for (var e = a.firstChild; e; e = e.nextSibling)
                  e.nodeType == 3
                    ? (d += e.nodeValue.length)
                    : e.nodeName == "BR"
                    ? (d += 1)
                    : e.nodeType == 1 &&
                      (b.push({ event: "start", offset: d, node: e }),
                      (d = c(e, d)),
                      b.push({ event: "stop", offset: d, node: e }));
                return d;
              })(a, 0),
              b
            );
          ...
          function g(a, c, d) {
            ...
            function i(a) {
              ...
              return (
                "<" +
                a.nodeName +
                Array.prototype.map.call(a.attributes, c).join("") +
                ">"
              );
            }
            var e = 0,
            ...
            while (a.length || c.length) {
              var j = h().splice(0, 1)[0];
              (f += b(d.substr(e, j.offset - e))), (e = j.offset);
              if (j.event == "start") (f += i(j.node)), g.push(j.node);
              else if (j.event == "stop") {
                var k,
                  l = g.length;
                do
                  l--, (k = g[l]), (f += "</" + k.nodeName.toLowerCase() + ">");
                while (k != j.node);
                g.splice(l, 1);
                while (l < g.length) (f += i(g[l])), l++;
              }
            }
            return f + b(d.substr(e));
          }
          function h(b) {
            function c(a, c) {
              return RegExp(
                a,
                "m" + (b.case_insensitive ? "i" : "") + (c ? "g" : "")
              );
            }
            function d(b, e) {
              if (b.compiled) return;
              b.compiled = !0;
              var f = [];
              if (b.keywords) {
                var g = {};
                ...
                b.lexemsRe = c(b.lexems || a.IDENT_RE, !0);
                if (typeof b.keywords == "string") h("keyword", b.keywords);
                else
                  for (var i in b.keywords) {
                    if (!b.keywords.hasOwnProperty(i)) continue;
                    h(i, b.keywords[i]);
                  }
                b.keywords = g;
              }
              e &&
                (b.beginWithKeyword &&
                  (b.begin = "\\b(" + f.join("|") + ")\\s"),
                (b.beginRe = c(b.begin ? b.begin : "\\B|\\b")),
                !b.end && !b.endsWithParent && (b.end = "\\B|\\b"),
                b.end && (b.endRe = c(b.end)),
                (b.terminator_end = b.end || ""),
                b.endsWithParent &&
                  e.terminator_end &&
                  (b.terminator_end += (b.end ? "|" : "") + e.terminator_end)),
                b.illegal && (b.illegalRe = c(b.illegal)),
                b.relevance === undefined && (b.relevance = 1),
                b.contains || (b.contains = []);
              for (var j = 0; j < b.contains.length; j++)
                b.contains[j] == "self" && (b.contains[j] = b),
                  d(b.contains[j], b);
              b.starts && d(b.starts, e);
              var k = [];
              for (var j = 0; j < b.contains.length; j++)
                k.push(b.contains[j].begin);
              b.terminator_end && k.push(b.terminator_end),
                b.illegal && k.push(b.illegal),
                (b.terminators = k.length
                  ? c(k.join("|"), !0)
                  : {
                      exec: function (a) {
                        return null;
          ...
          function i(a, c) {
            function d(a, b) {
              for (var c = 0; c < b.contains.length; c++) {
                var d = b.contains[c].beginRe.exec(a);
                if (d && d.index == 0) return b.contains[c];
              }
            }
            function e(a, b) {
              if (a.end && a.endRe.test(b)) return a;
              if (a.endsWithParent) return e(a.parent, b);
            }
            function f(a, b) {
              return b.illegal && b.illegalRe.test(a);
            }
            function g(a, b) {
              var c = q.case_insensitive ? b[0].toLowerCase() : b[0];
              return a.keywords.hasOwnProperty(c) && a.keywords[c];
            }
            function k() {
              var a = b(s);
              if (!r.keywords) return a;
              var c = "",
                d = 0;
              r.lexemsRe.lastIndex = 0;
              var e = r.lexemsRe.exec(a);
              while (e) {
                c += a.substr(d, e.index - d);
                var f = g(r, e);
                f
                  ? ((u += f[1]),
                    (c += '<span class="' + f[0] + '">' + e[0] + "</span>"))
                  : (c += e[0]),
                  (d = r.lexemsRe.lastIndex),
                  (e = r.lexemsRe.exec(a));
              }
              return c + a.substr(d);
            }
            function l() {
              if (r.subLanguage && !o[r.subLanguage]) return b(s);
              var a = r.subLanguage ? i(r.subLanguage, s) : j(s);
              return (
                r.relevance > 0 && ((u += a.keyword_count), (t += a.relevance)),
                '<span class="' + a.language + '">' + a.value + "</span>"
              );
            }
            function m() {
              return r.subLanguage !== undefined ? l() : k();
            }
            function n(a, c) {
              var d = a.className ? '<span class="' + a.className + '">' : "";
              a.returnBegin
                ? ((v += d), (s = ""))
                : a.excludeBegin
                ? ((v += b(c) + d), (s = ""))
                : ((v += d), (s = c)),
                (r = Object.create(a, { parent: { value: r } })),
                (t += a.relevance);
            }
            function p(a, c) {
              s += a;
              ...
              var g = d(c, r);
              if (g) return (v += m()), n(g, c), g.returnBegin;
              var h = e(r, c);
              if (h) {
                !h.returnEnd && !h.excludeEnd && (s += c), (v += m());
                do r.className && (v += "</span>"), (r = r.parent);
                while (r != h.parent);
                return (
                  h.excludeEnd && (v += b(c)),
                  (s = ""),
            ...
            try {
              var w,
                x = 0;
              for (;;) {
                (r.terminators.lastIndex = x), (w = r.terminators.exec(c));
                if (!w) break;
                var y = p(c.substr(x, w.index - x), w[0]);
                x = w.index + (y ? 0 : w[0].length);
              }
              return (
                p(c.substr(x), undefined),
                { relevance: t, keyword_count: u, value: v, language: a }
              );
            } catch (z) {
              if (z == "Illegal")
                return { relevance: 0, keyword_count: 0, value: b(c) };
              throw z;
            }
          }
          function j(a) {
            var c = { keyword_count: 0, relevance: 0, value: b(a) },
              d = c;
            for (var e in o) {
              if (!o.hasOwnProperty(e)) continue;
              var f = i(e, a);
              (f.language = e),
                f.keyword_count + f.relevance > d.keyword_count + d.relevance &&
                  (d = f),
                f.keyword_count + f.relevance > c.keyword_count + c.relevance &&
                  ((d = c), (c = f));
            }
          ...
          function k(a, b, c) {
            return (
              b &&
                (a = a.replace(/^((<[^>]+>|\t)+)/gm, function (a, c, d, e) {
          ...
          function l(a, b, c) {
            var h = d(a, c),
              l = e(a);
            if (l == "no-highlight") return;
            var m = l ? i(l, h) : j(h);
            l = m.language;
            var n = f(a);
            if (n.length) {
              var o = document.createElement("pre");
              (o.innerHTML = m.value), (m.value = g(n, f(o), h));
            }
            m.value = k(m.value, b, c);
            var p = a.className;
            p.match("(\\s|^)(language-)?" + l + "(\\s|$)") ||
              (p = p ? p + " " + l : l),
              (a.innerHTML = m.value),
              (a.className = p),
              (a.result = {
              ...
              m.second_best &&
                (a.second_best = {
                  language: m.second_best.language,
                  kw: m.second_best.keyword_count,
                  re: m.second_best.relevance,
                });
          }
          function m() {
            if (m.called) return;
        ...
        return (
          (a.LANGUAGES.javascript = (function (a) {
            return {
              keywords: {
                keyword:
              ...
              contains: [
                ...
                {
                  begin:
                    "(" + a.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*",
          ...
          (a.LANGUAGES.ruby = (function (a) {
            var b = "[a-zA-Z_][a-zA-Z0-9_]*(\\!|\\?)?",
              ...
              e = { className: "yardoctag", begin: "@[A-Za-z]+" },
              f = [
                { className: "comment", begin: "#", end: "$", contains: [e] },
                {
                  className: "comment",
                  begin: "^\\=begin",
                  end: "^\\=end",
              ...
              j = {
                ...
                keywords: "def",
                contains: [
                  { className: "title", begin: c, lexems: b, keywords: d },
                  {
                    className: "params",
                    begin: "\\(",
                    end: "\\)",
            ...
            return (
              (g.contains = k),
              (j.contains[1].contains = k),
              { lexems: b, keywords: d, contains: k }
            );
          })(a)),
          (a.LANGUAGES.python = (function (a) {
            var b = [
                {
                  className: "string",
                  begin: "(u|b)?r?'''",
              ...
              ].concat([a.APOS_STRING_MODE, a.QUOTE_STRING_MODE]),
              c = { className: "title", begin: a.UNDERSCORE_IDENT_RE },
              d = {
                className: "params",
                begin: "\\(",
                end: "\\)",
                contains: ["self", a.C_NUMBER_MODE].concat(b),
              },
              e = {
                beginWithKeyword: !0,
                end: ":",
            ...
            return {
              ...
              contains: b.concat([
                a.HASH_COMMENT_MODE,
                a.inherit(e, { className: "function", keywords: "def" }),
                a.inherit(e, { className: "class", keywords: "class" }),
                a.C_NUMBER_MODE,
          ...
          (a.LANGUAGES.bash = (function (a) {
            var b = "true false",
              c = { className: "variable", begin: "\\$[a-zA-Z0-9_]+\\b" },
              d = { className: "variable", begin: "\\${([^}]|\\\\})+}" },
              e = {
                className: "string",
                begin: '"',
                end: '"',
            ...
            return {
              ...
              contains: [
                ...
                e,
                f,
                a.inherit(g, { begin: "\\[ ", end: " \\]", relevance: 0 }),
                a.inherit(g, { begin: "\\[\\[ ", end: " \\]\\]" }),
              ],
            };
          })(a)),
          (a.LANGUAGES.java = (function (a) {
            return {
              keywords:
              ...
              contains: [
                {
                  ...
                  contains: [{ className: "javadoctag", begin: "@[A-Za-z]+" }],
                  relevance: 10,
                },
                a.C_LINE_COMMENT_MODE,
                a.C_BLOCK_COMMENT_MODE,
                ...
                a.QUOTE_STRING_MODE,
                {
                  ...
                  contains: [
                    ...
                    { className: "title", begin: a.UNDERSCORE_IDENT_RE },
                  ],
                },
                a.C_NUMBER_MODE,
          ...
          (a.LANGUAGES.php = (function (a) {
            var b = {
              ...
              d = [a.BINARY_NUMBER_MODE, a.C_NUMBER_MODE],
              e = { className: "title", begin: a.UNDERSCORE_IDENT_RE };
            return {
              case_insensitive: !0,
              keywords:
              ...
              contains: [
                ...
                a.HASH_COMMENT_MODE,
                {
                  ...
                  contains: [{ className: "phpdoc", begin: "\\s@[A-Za-z]+" }],
                },
                {
                  className: "comment",
                  excludeBegin: !0,
                ...
                { className: "preprocessor", begin: "<\\?php", relevance: 10 },
                ...
                b,
                {
                  ...
                  contains: [
                    e,
                    {
                      ...
                      contains: ["self", b, a.C_BLOCK_COMMENT_MODE]
                        .concat(c)
                        .concat(d),
                    },
                  ],
          ...
          (a.LANGUAGES.perl = (function (a) {
            var b =
              ...
              d = { className: "variable", begin: "\\$\\d" },
              e = {
                className: "variable",
                begin:
                  "[\\$\\%\\@\\*](\\^\\w\\b|#\\w+(\\:\\:\\w+)*|[^\\s\\w{]|{\\w+}|\\w+(\\:\\:\\w*)*)",
              },
              f = [a.BACKSLASH_ESCAPE, c, d, e],
              g = {
                begin: "->",
                contains: [{ begin: a.IDENT_RE }, { begin: "{", end: "}" }],
              },
              h = {
                className: "comment",
            ...
            return (
              (c.contains = i),
              (g.contains[1].contains = i),
              { keywords: b, contains: i }
            );
          })(a)),
          (a.LANGUAGES.cpp = (function (a) {
            var b = {
              keyword:
          ...
          (a.LANGUAGES.objectivec = (function (a) {
            var b = {
              keyword:
                "int float while private char catch export sizeof typedef const struct for union unsigned long volatile static protected bool mutable if public do return goto void enum else break extern class asm case short default double throw register explicit signed typename try this switch continue wchar_t inline readonly assign property protocol self synchronized end synthesize id optional required implementation nonatomic interface super unichar finally dynamic IBOutlet IBAction selector strong weak readonly",
            ...
            return {
              ...
              contains: [
                ...
                { className: "preprocessor", begin: "#", end: "$" },
                {
                  ...
                  contains: [{ className: "id", begin: a.UNDERSCORE_IDENT_RE }],
                },
                { className: "variable", begin: "\\." + a.UNDERSCORE_IDENT_RE },
              ],
            };
          })(a)),
          (a.LANGUAGES.cs = (function (a) {
            return {
              keywords:
                  ...
                  contains: [
                    {
                      ...
                      contains: [a.BACKSLASH_ESCAPE, { begin: "''" }],
                      relevance: 0,
                    },
                    {
                      className: "string",
          ...
          (a.LANGUAGES.xml = (function (a) {
            var b = "[A-Za-z0-9\\._:-]+",
              c = {
                endsWithParent: !0,
                contains: [
                  { className: "attribute", begin: b, relevance: 0 },
                  {
                    begin: '="',
                    returnBegin: !0,
                    end: '"',
                    contains: [
                      { className: "value", begin: '"', endsWithParent: !0 },
                    ],
                  },
                  {
                    begin: "='",
            ...
            return {
              ...
              contains: [
                ...
                { begin: "<%", end: "%>", subLanguage: "vbscript" },
                {
                  ...
                  contains: [{ className: "title", begin: "[^ />]+" }, c],
                },
              ],
            };
          })(a)),
          (a.LANGUAGES.css = (function (a) {
            var b = {
              className: "function",
              begin: a.IDENT_RE + "\\(",
              end: "\\)",
            ...
            return {
              ...
              contains: [
                ...
                { className: "tag", begin: a.IDENT_RE, relevance: 0 },
                {
                  className: "rules",
                  begin: "{",
                  end: "}",
          ...
          (a.LANGUAGES.scala = (function (a) {
            var b = { className: "annotation", begin: "@[A-Za-z]+" },
              c = {
                className: "string",
                begin: 'u?r?"""',
                end: '"""',
                ...
                c,
                {
                  ...
                  contains: [
                    ...
                    { className: "title", begin: a.UNDERSCORE_IDENT_RE },
                    {
                      ...
                      contains: [a.APOS_STRING_MODE, a.QUOTE_STRING_MODE, c, b],
                    },
                  ],
                },
                a.C_NUMBER_MODE,
          ...
          (a.LANGUAGES.coffeescript = (function (a) {
            var b = {
                keyword:
              ...
              d = { className: "title", begin: c },
              e = {
                className: "subst",
                begin: "#\\{",
                end: "}",
                keywords: b,
                contains: [a.BINARY_NUMBER_MODE, a.C_NUMBER_MODE],
              };
            return {
              keywords: b,
              contains: [
                ...
                { className: "property", begin: "@" + c },
              ],
            };
          })(a)),
          (a.LANGUAGES.lisp = (function (a) {
            var b =
                "[a-zA-Z_\\-\\+\\*\\/\\<\\=\\>\\&\\#][a-zA-Z0-9_\\-\\+\\*\\/\\<\\=\\>\\&\\#]*",
              c =
                "(\\-|\\+)?\\d+(\\.\\d+|\\/\\d+)?((d|e|f|l|s)(\\+|\\-)?\\d+)?",
              d = { className: "literal", begin: "\\b(t{1}|nil)\\b" },
              e = [
                { className: "number", begin: c },
              ...
              g = { className: "comment", begin: ";", end: "$" },
              h = { className: "variable", begin: "\\*", end: "\\*" },
              i = { className: "keyword", begin: "[:&]" + b },
              j = {
                begin: "\\(",
                end: "\\)",
                contains: ["self", d, f].concat(e),
              },
              k = {
                className: "quoted",
                begin: "['`]\\(",
                end: "\\)",
                contains: e.concat([f, h, i, j]),
              },
              l = {
                className: "quoted",
                begin: "\\(quote ",
              ...
              n = { className: "body", endsWithParent: !0, excludeEnd: !0 };
            return (
              (m.contains = [{ className: "title", begin: b }, n]),
              (n.contains = [k, l, m, d].concat(e).concat([f, g, h, i])),
              { illegal: "[^\\s]", contains: e.concat([d, f, g, k, l, m]) }
            );
          })(a)),
          (a.LANGUAGES.clojure = (function (a) {
            var b = {
                built_in:
              ...
              c = "[a-zA-Z_0-9\\!\\.\\?\\-\\+\\*\\/\\<\\=\\>\\&\\#\\$';]+",
              d = "[\\s:\\(\\{]+\\d+(\\.\\d+)?",
              e = { className: "number", begin: d, relevance: 0 },
              f = {
                className: "string",
                begin: '"',
                end: '"',
              ...
              g = { className: "comment", begin: ";", end: "$", relevance: 0 },
              h = {
                className: "collection",
                begin: "[\\[\\{]",
                end: "[\\]\\}]",
              },
              i = { className: "comment", begin: "\\^" + c },
              j = { className: "comment", begin: "\\^\\{", end: "\\}" },
              k = { className: "attribute", begin: "[:]" + c },
              l = { className: "list", begin: "\\(", end: "\\)", relevance: 0 },
              m = {
                endsWithParent: !0,
                excludeEnd: !0,
            ...
            return (
              (l.contains = [{ className: "comment", begin: "comment" }, n]),
              (m.contains = [l, f, i, j, g, k, h, e]),
              (h.contains = [l, f, i, g, k, h, e]),
              { illegal: "\\S", contains: [g, l] }
            );
          })(a)),
          a
        );
  ...
  require.define("/src/remark/models/slideshow.js", function (a, b, c, d, e) {
    function g(a) {
      var b = h(a),
        c = i(b);
      j(b, c),
    ...
    function h(a) {
      var b = [],
        ...
        d = !1,
        e;
      while ((e = c.exec(a)) !== null)
        b.push(f.create(a.substr(0, e.index), { continued: d.toString() })),
          (a = a.substr(e.index + e[0].length)),
          (d = e[0] === "\n--\n");
      return a !== "" && b.push(f.create(a, { continued: d.toString() })), b;
    }
    function i(a) {
      var b = {};
      return (
        a.each(function (a) {
          a.properties.name && (b[a.properties.name] = a);
        }),
        b
      );
    }
    function j(a, b) {
      var c;
      a.each(function (d, e) {
        d.properties.continued === "true" && e > 0
          ? d.inherit(a[e - 1])
          : b[d.properties.template]
          ? d.inherit(b[d.properties.template])
          : d.properties.layout === "false"
          ? (c = undefined)
          : c && d.properties.layout !== "true" && d.inherit(c),
          d.properties.layout === "true" && (c = d);
      });
    }
    function k(a) {
      return a.filter(function (a) {
        return a.properties.layout !== "true";
      });
    }
    function l(a) {
    ...
    var f = a("./slide").Slide;
    (c.Slideshow = g),
      (g.prototype.getSlideByName = function (a) {
        return this.slides.names[a];
      }),
      (g.prototype.getSlideCount = function () {
        return this.slides.length;
      });
  }),
  require.define("/src/remark/models/slide.js", function (a, b, c, d, e) {
    function f(a, b) {
      (this.properties = b || {}), (this.source = g(a, this.properties));
    }
    function g(a, b) {
      var c = /^\n*(\w+):([^$\n]*)/i,
        d;
      while ((d = c.exec(a)) !== null)
        (a = a.substr(0, d.index) + a.substr(d.index + d[0].length)),
          (b[d[1].trim()] = d[2].trim()),
          (c.lastIndex = d.index);
      return a;
    }
    function h(a, b) {
      ...
      for (c in b.properties) {
        if (!b.properties.hasOwnProperty(c) || i(c)) continue;
        (d = [b.properties[c]]),
          c === "class" && a.properties[c] && d.push(a.properties[c]);
        if (c === "class" || a.properties[c] === undefined)
          a.properties[c] = d.join(", ");
      }
    }
    function i(a) {
      return a === "name" || a === "layout";
    }
    function j(a, b) {
      var c;
      (a.properties.content = a.source),
        (a.source = b.source),
        (c = a.expandVariables(!0)),
        c.content === undefined && (a.source += a.properties.content),
        delete a.properties.content;
    }
    (c.Slide = f),
      (f.create = function (a, b) {
        return new f(a, b);
      }),
      (f.prototype.inherit = function (a) {
        h(this, a), j(this, a);
      }),
      (f.prototype.expandVariables = function (a) {
            ...
            function (d, e, f, g) {
              ...
              return e
                ? a
                  ...
                  : f
                : ((i = b[h]),
                  i !== undefined ? ((c[h] = i), i) : h === "content" ? "" : f);
            }
          )),
          c
        );
  ...
  require.define("/src/remark/views/slideshowView.js", function (
    a,
    b,
    c,
    d,
    ...
    function m(a, b) {
      (this.slideViews = n(a.slides)),
        this.slideViews.each(function (a) {
          b.appendChild(a.element);
        }),
        (this.positionElement = o()),
        b.appendChild(this.positionElement),
        q(b),
        p(this);
    }
    function n(a) {
    ...
    function o() {
      ...
      return (a.className = "position"), a;
    }
    function p(a) {
      g.on("hideSlide", function (b) {
        a.hideSlide(b);
      }),
        g.on("showSlide", function (b) {
          a.showSlide(b);
        });
    }
    function q(a) {
      var b = j * l,
        ...
        d = function () {
          var d = i.innerHeight,
            e = i.innerWidth,
            f;
          e / l > d / k ? (f = d / (j * k)) : (f = e / (j * l)),
            (a.style["-webkit-transform"] = "scale(" + f + ")"),
            (a.style.MozTransform = "scale(" + f + ")"),
            (a.style.left = (e - b * f) / 2 + "px"),
            (a.style.top = (d - c * f) / 2 + "px");
        };
      (a.style.width = j * l + "px"),
        (a.style.height = j * k + "px"),
        i.on("resize", d),
        d();
    }
    var f = a("../api"),
      g = a("../dispatcher"),
      h = a("./slideView").SlideView,
      i = a("../dom"),
      j = 227,
      k = 3,
      l = 4;
    (c.SlideshowView = m),
      (m.prototype.showSlide = function (a) {
        var b = this.slideViews[a];
        f.emit("slidein", b.element, a),
          b.show(),
          (this.positionElement.innerHTML =
            a + 1 + " / " + this.slideViews.length);
      }),
      (m.prototype.hideSlide = function (a) {
        var b = this.slideViews[a];
        f.emit("slideout", b.element, a), b.hide();
      });
  }),
  require.define("/src/remark/views/slideView.js", function (a, b, c, d, e) {
    function i(a) {
      (this.slide = a),
        (this.element = j()),
        (this.contentElement = k(a.source, a.properties)),
        this.element.appendChild(this.contentElement);
    }
    function j() {
      var a = g.createElement("div");
      return (a.className = "slide"), (a.style.display = "none"), a;
    }
    function k(a, b) {
      var c = g.createElement("div");
      return (
        b.name && (c.id = "slide-" + b.name),
        (c.innerHTML = a),
        l(c, b),
        f.convertContentClasses(c),
        f.convertMarkdown(c),
        f.convertCodeClasses(c),
        f.trimEmptySpace(c),
        h.highlightCodeBlocks(c),
        c
      );
    }
    function l(a, b) {
      var c = (b["class"] || "").split(/,| /).filter(function (a) {
        return a !== "";
      });
      a.className = ["content"].concat(c).join(" ");
    }
    var f = a("../converter"),
      g = a("../dom"),
      h = a("../highlighter");
  ...
  require.define("/src/remark/converter.js", function (a, b, c, d, e) {
    var f = a("marked"),
      g = a("./config"),
      h = (b.exports = {});
    f.setOptions({ gfm: !1 }),
      (h.convertContentClasses = function (a) {
        var b = /(\\)?((?:\.[a-z_\-][a-z\-_0-9]*)+)\[/gi,
          c,
          d,
          e,
          f,
          g,
          h;
        while ((c = b.exec(a.innerHTML)) !== null) {
          e = i(a.innerHTML.substr(c.index + c[0].length));
          if (e === null) continue;
          c[1]
            ? ((f = c[2] + "[" + e + "]"), (b.lastIndex = c.index + f.length))
            : ((d = c[2].substr(1).split(".")),
              (g = e.indexOf("\n") === -1 ? "span" : "div"),
              (f =
                "&lt;" +
                g +
              ...
              (b.lastIndex =
                c.index +
                ("&lt;" + g + ' class="' + d.join(" ") + '"&gt;').length)),
            (h = a.innerHTML.substr(c.index + c[0].length + e.length + 1)),
            (a.innerHTML = a.innerHTML.substr(0, c.index) + f + h);
        }
      });
    var i = function (a) {
      var b = 1,
        c = 0,
        d;
      while (b > 0 && c < a.length)
        (d = a[c++]), (b += (d === "[" && 1) || (d === "]" && -1) || 0);
      return (b === 0 && a.substr(0, c - 1)) || null;
    };
    (h.convertMarkdown = function (a) {
      (a.innerHTML = f(a.innerHTML.replace(/^\s+/, ""))),
        (a.innerHTML = a.innerHTML.replace(/&[l|g]t;/g, function (a) {
          return a === "&lt;" ? "<" : ">";
        })),
        (a.innerHTML = a.innerHTML.replace(/&amp;/g, "&"));
    }),
      (h.convertCodeClasses = function (a) {
        var b = a.getElementsByTagName("code"),
          c;
        for (c = 0; c < b.length; c++) j(b[c]);
      });
    var j = function (a) {
        var b = g.highlightLanguage,
          c = g.highlightInline,
          d = a.parentNode.nodeName.toUpperCase() !== "PRE";
        if (k(a)) return;
        d && !c ? (a.className = "no-highlight") : b && (a.className = b);
      },
      k = function (a) {
        var b = /^(\\)?\.([a-z_\-][a-z\-_0-9]*)(?:\n|\ )/i,
          c;
        if ((c = b.exec(a.innerHTML)) !== null) {
          if (!c[1])
            return (
          ...
          a.innerHTML = a.innerHTML.substr(c[1].length);
        }
        return !1;
      };
    h.trimEmptySpace = function (a) {
      a.innerHTML = a.innerHTML.replace(/<p>\s*<\/p>/g, "");
    };
  }),
  require.define("/node_modules/marked/package.json", function (a, b, c, d, e) {
    b.exports = { main: "./lib/marked.js" };
  }),
  require.define("/node_modules/marked/lib/marked.js", function (
    a,
    b,
    c,
    d,
    ...
    (function () {
      function m() {
        var a =
          "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+";
        return a;
      }
      function n(a) {
        return (
          (a = a.source),
          function b(c, d) {
            return c ? ((a = a.replace(c, d.source || d)), b) : new RegExp(a);
          }
        );
      }
      function o() {}
      ...
      (a.list = n(a.list)("bullet", /(?:[*+-](?!(?: *[-*]){2,})|\d+\.)/)()),
        (a.html = n(a.html)("comment", /<!--[^\0]*?-->/)(
          "closed",
          /<(tag)[^\0]+?<\/\1>/
        )("closing", /<tag(?!:\/|@)\b(?:"[^"]*"|'[^']*'|[^'">])*?>/)(
          /tag/g,
        ...
        (a.paragraph = (function () {
          ...
          return (
            ...
            })("hr")("heading")("lheading")("blockquote")("<" + m())("def"),
            new RegExp(b.replace("body", c.join("|")))
          );
        })()),
        (a.normal = { fences: a.fences, paragraph: a.paragraph }),
        (a.gfm = {
          fences: /^ *``` *(\w+)? *\n([^\0]+?)\s*``` *(?:\n+|$)/,
          paragraph: /^/,
        }),
        (a.gfm.paragraph = n(a.paragraph)(
          "(?!",
          "(?!" + a.gfm.fences.source.replace(/(^|[^\[])\^/g, "$1") + "|"
        )()),
        (a.lexer = function (b) {
          var c = [];
          return (
        ...
        (a.token = function (b, c, d) {
          var b = b.replace(/^ +$/gm, ""),
            ...
            k;
          while (b) {
            if ((g = a.newline.exec(b)))
              (b = b.substring(g[0].length)),
                g[0].length > 1 && c.push({ type: "space" });
            if ((g = a.code.exec(b))) {
              (b = b.substring(g[0].length)),
                (g = g[0].replace(/^ {4}/gm, "")),
                c.push({
                  type: "code",
                  text: q.pedantic ? g : g.replace(/\n+$/, ""),
                });
              continue;
            }
            if ((g = a.fences.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "code", lang: g[1], text: g[2] });
              continue;
            }
            if ((g = a.heading.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "heading", depth: g[1].length, text: g[2] });
              continue;
            }
            if ((g = a.lheading.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({
                  type: "heading",
                  depth: g[2] === "=" ? 1 : 2,
            ...
            if ((g = a.hr.exec(b))) {
              (b = b.substring(g[0].length)), c.push({ type: "hr" });
              continue;
            }
            if ((g = a.blockquote.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "blockquote_start" }),
                (g = g[0].replace(/^ *> ?/gm, "")),
                a.token(g, c, d),
                c.push({ type: "blockquote_end" });
              continue;
            }
            if ((g = a.list.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "list_start", ordered: isFinite(g[2]) }),
                (g = g[0].match(
                  /^( *)([*+-]|\d+\.) [^\n]*(?:\n(?!\1(?:[*+-]|\d+\.) )[^\n]*)*/gm
                )),
                (e = !1),
              ...
              for (; j < k; j++)
                (h = g[j]),
                  ...
                  ~h.indexOf("\n ") &&
                    ...
                    (h = q.pedantic
                      ? h.replace(/^ {1,4}/gm, "")
                      : h.replace(new RegExp("^ {1," + i + "}", "gm"), ""))),
                  (f = e || /\n\n(?!\s*$)/.test(h)),
                  j !== k - 1 && ((e = h[h.length - 1] === "\n"), f || (f = e)),
                  c.push({ type: f ? "loose_item_start" : "list_item_start" }),
                  a.token(h, c),
                  c.push({ type: "list_item_end" });
              c.push({ type: "list_end" });
              continue;
            }
            if ((g = a.html.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "html", pre: g[1] === "pre", text: g[0] });
              continue;
            }
            if (d && (g = a.def.exec(b))) {
              (b = b.substring(g[0].length)),
                (c.links[g[1].toLowerCase()] = { href: g[2], title: g[3] });
              continue;
            }
            if (d && (g = a.paragraph.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "paragraph", text: g[0] });
              continue;
            }
            if ((g = a.text.exec(b))) {
              (b = b.substring(g[0].length)),
                c.push({ type: "text", text: g[0] });
              continue;
            }
          }
          return c;
      ...
      (c._linkInside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/),
        ...
        (c.lexer = function (a) {
          var b = "",
            ...
            j;
          while (a) {
            if ((j = c.escape.exec(a))) {
              (a = a.substring(j[0].length)), (b += j[1]);
              continue;
            }
            if ((j = c.autolink.exec(a))) {
              (a = a.substring(j[0].length)),
                j[2] === "@"
                  ? ((h = j[1][6] === ":" ? l(j[1].substring(7)) : l(j[1])),
                    (i = l("mailto:") + h))
                  : ((h = k(j[1])), (i = h)),
                (b += '<a href="' + i + '">' + h + "</a>");
              continue;
            ...
            if ((j = c.tag.exec(a))) {
              (a = a.substring(j[0].length)),
                (b += q.sanitize ? k(j[0]) : j[0]);
              continue;
            }
            if ((j = c.link.exec(a))) {
              (a = a.substring(j[0].length)),
                (b += d(j, { href: j[2], title: j[3] }));
              continue;
            }
            if ((j = c.reflink.exec(a)) || (j = c.nolink.exec(a))) {
              (a = a.substring(j[0].length)),
                (g = (j[2] || j[1]).replace(/\s+/g, " ")),
                (g = f[g.toLowerCase()]);
              if (!g || !g.href) {
                (b += j[0][0]), (a = j[0].substring(1) + a);
                continue;
              }
              b += d(j, g);
              continue;
            }
            if ((j = c.strong.exec(a))) {
              (a = a.substring(j[0].length)),
                (b += "<strong>" + c.lexer(j[2] || j[1]) + "</strong>");
              continue;
            }
            if ((j = c.em.exec(a))) {
              (a = a.substring(j[0].length)),
                (b += "<em>" + c.lexer(j[2] || j[1]) + "</em>");
              continue;
            }
            if ((j = c.code.exec(a))) {
              (a = a.substring(j[0].length)),
            ...
            if ((j = c.br.exec(a))) {
              (a = a.substring(j[0].length)), (b += "<br>");
              continue;
            }
            if ((j = c.text.exec(a))) {
              (a = a.substring(j[0].length)), (b += k(j[0]));
              continue;
            }
          }
          return b;
      ...
      var d = function (a, b) {
        ...
        h = function () {
          switch (f.type) {
            ...
            case "heading":
              return (
                "<h" + f.depth + ">" + c.lexer(f.text) + "</h" + f.depth + ">\n"
              );
            case "code":
              return (
                "<pre><code" +
                (f.lang ? ' class="' + f.lang + '"' : "") +
                ">" +
                (f.escaped ? f.text : k(f.text, !0)) +
                "</code></pre>\n"
              );
            case "blockquote_start":
              var a = "";
              while (g().type !== "blockquote_end") a += h();
              return "<blockquote>\n" + a + "</blockquote>\n";
            case "list_start":
              var b = f.ordered ? "ol" : "ul",
                a = "";
              while (g().type !== "list_end") a += h();
              return "<" + b + ">\n" + a + "</" + b + ">\n";
            case "list_item_start":
              var a = "";
              while (g().type !== "list_item_end")
                a += f.type === "text" ? i() : h();
              return "<li>" + a + "</li>\n";
            case "loose_item_start":
              var a = "";
              while (g().type !== "list_item_end") a += h();
              return "<li>" + a + "</li>\n";
            case "html":
              return q.sanitize
                ? c.lexer(f.text)
        ...
        i = function () {
          var a = f.text,
            b;
          while ((b = e[e.length - 1]) && b.type === "text")
            a += "\n" + g().text;
          return c.lexer(a);
        },
        j = function (a) {
      ...
      var p = function (b, c) {
        ...
        s = function (b) {
          ...
          (q = b),
            q.gfm
              ? ((a.fences = a.gfm.fences),
                (a.paragraph = a.gfm.paragraph),
                (c.text = c.gfm.text),
                (c.url = c.gfm.url))
              : ((a.fences = a.normal.fences),
                (a.paragraph = a.normal.paragraph),
                (c.text = c.normal.text),
                (c.url = c.normal.url)),
            q.pedantic
              ? ((c.em = c.pedantic.em), (c.strong = c.pedantic.strong))
              : ((c.em = c.normal.em), (c.strong = c.normal.strong));
        };
      (p.options = p.setOptions = function (a) {
        (r = a), s(a);
      }),
        p.options({ gfm: !0, pedantic: !1, sanitize: !1 }),
        (p.parser = function (a, b) {
          return s(b), j(a);
        }),
        (p.lexer = function (b, c) {
          return s(c), a.lexer(b);
        }),
        (p.parse = p),
        typeof b != "undefined" ? (b.exports = p) : (this.marked = p);
    }.call(this));
  }),
  require.define("/index.js", function (a, b, c, d, e) {
    var f = a("./src/remark");
  }),
  require("/index.js");

require = (function (e, l, s) {
...
})(
  {
    ...
    nZr0zp: [
      function (e, l) {
        ...
        (s.prototype = new t()),
          ...
          (s.prototype.setPageOrientation = function (e) {
            if (e === o) (this._pageHeight = i), (this._pageWidth = h);
            else {
              if (e !== r) throw new Error("Unknown print orientation: " + e);
              (this._pageHeight = h), (this._pageWidth = i);
            }
            (this._orientation = e),
      ...
      { events: 1, "components/styler": "t5Lx4S" },
    ],
    ...
    3: [
      ...
      { "components/styler": "t5Lx4S", "./polyfills": 4, "./remark/api": 5 },
    ],
    "components/styler": [
      function (e, l) {
        l.exports = e("t5Lx4S");
      ...
      function (e, l) {
        function s() {
          ...
          if (!a()) {
            ...
            for (s in h.styles)
              h.styles.hasOwnProperty(s) &&
                (l.innerHTML = l.innerHTML + h.styles[s]);
                  ...
                  (function (l) {
                              ...
                              i = function (l, s) {
                                e.case_insensitive && (s = s.toLowerCase()),
                                  s.split(" ").forEach(function (e) {
                                    var s = e.split("|");
                                    h[s[0]] = [l, s[1] ? Number(s[1]) : 1];
                                  });
                              };
                            "string" == typeof a.keywords
                              ? i("keyword", a.keywords)
                    ...
                    function n(e, s, a, r) {
                      ...
                      function h(e, l) {
                        ...
                        return e.endsWithParent ? h(e.parent, l) : void 0;
                      }
                      function c(e, l) {
                        return !a && t(l.illegalRe, e);
                      }
                      function d(e, l) {
                        var s = _.case_insensitive ? l[0].toLowerCase() : l[0];
                      ...
                      function m() {
                        if (!x.keywords) return l(z);
                        var e = "",
                          s = 0;
                        x.lexemesRe.lastIndex = 0;
                        for (var t = x.lexemesRe.exec(z); t; ) {
                          e += l(z.substr(s, t.index - s));
                          var a = d(x, t);
                          a
                            ? ((M += a[1]), (e += u(a[0], l(t[0]))))
                            : (e += l(t[0])),
                            (s = x.lexemesRe.lastIndex),
                            (t = x.lexemesRe.exec(z));
                        }
                        return e + l(z.substr(s));
                      }
                      function g() {
                        if (x.subLanguage && !w[x.subLanguage]) return l(z);
                        var e = x.subLanguage
                          ? n(x.subLanguage, z, !0, E[x.subLanguage])
                          : j(z);
                        return (
                          x.relevance > 0 && (M += e.relevance),
                      ...
                      function f(e, s) {
                        ...
                        if (a) {
                          var r = x;
                          r.returnEnd || r.excludeEnd || (z += s), (N += p());
                          do
                            x.className && (N += "</span>"),
                              (M += x.relevance),
                              (x = x.parent);
                      ...
                      var v,
                        ...
                        E = {},
                        N = "";
                      for (v = x; v != _; v = v.parent)
                        v.className && (N = u(v.className, "", !0) + N);
                      var z = "",
                        M = 0;
                      try {
                        for (var S, C, O = 0; ; ) {
                          if (
                            ...
                            (S = x.terminators.exec(s)),
                            !S)
                          )
                            break;
                          (C = f(s.substr(O, S.index - O), S[0])),
                            (O = S.index + C);
                        }
                        for (f(s.substr(O)), v = x; v.parent; v = v.parent)
                          v.className && (N += "</span>");
                        return { relevance: M, value: N, language: e, top: x };
                      } catch (T) {
                    ...
                    function u(e) {
                      ...
                      if (!/no(-?)highlight|plain|text/.test(l)) {
                        ...
                        if (i.length) {
                          ...
                          (u.innerHTML = r.value), (r.value = h(i, o(u), t));
                        }
                        (r.value = c(r.value)),
                          (e.innerHTML = r.value),
                ...
                },
                {
                  ...
                  create: function (e) {
                    ...
                    return (
                      (s.contains = h),
                      (t.contains = h),
                      { aliases: ["pl"], keywords: l, contains: h }
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  create: function (e) {
                    var l =
                      ...
                      h = e.inherit(e.QUOTE_STRING_MODE, { illegal: null }),
                      ...
                      u = {
                        ...
                        contains: ["self", r, h, o, c],
                      },
                      m = {
                        className: "quoted",
                        contains: [o, h, n, j, u, c],
                        variants: [
                          { begin: "['`]\\(", end: "\\)" },
                    ...
                    return (
                      ...
                      (b.contains = [m, g, p, r, o, h, i, n, j, d, c]),
                      { illegal: /\S/, contains: [o, a, r, h, i, m, g, p, c] }
                    );
                  },
                },
                {
    ...
    5: [
      ...
      },
      {
        ...
        "./parser": 10,
        "./resources": 6,
        "./views/slideshowView": 11,
        "./controllers/defaultController": 12,
        "./macros": 13,
        "./dom": 14,
        "./models/slideshow": 15,
      },
                ...
                j.forEach(function (e) {
                  switch (e.type) {
                    ...
                    case "macro":
                      ...
                      var h = o.apply(e.obj, e.args);
                      "string" == typeof h
                        ? ((h = s.parse(h, l)),
                          r(d[d.length - 1], h[0].content[0]))
                        : r(d[d.length - 1], void 0 === h ? "" : h.toString());
                      break;
                    case "content_start":
                      d.push(a(e));
                      break;
    ...
    11: [
        ...
        (l.exports = s),
          ...
          (s.prototype.configureChildElements = function () {
            ...
            (s.containerElement.innerHTML += n.containerLayout),
              ...
              (s.notesView = new h(s.events, s.notesArea, function () {
                return s.slideViews;
              })),
      ...
      {
        "components/timer": "yAcg0L",
        "components/printing": "nZr0zp",
        "./slideView": 22,
        "./notesView": 23,
        "../scaler": 24,
        "../resources": 6,
            ...
            (s = s || ""),
              ...
              w.forEach(function (e) {
                for (var l in e.links)
                  e.links.hasOwnProperty(l) && (_[l] = e.links[l]);
              }),
          ...
          return (
            ...
            a.forEach(function (e, t) {
              ...
              "true" === e.properties.continued && t > 0
                ...
                (i = new h(r.length, e, a)),
                "true" === e.properties.layout && (s = i),
                e.properties.name && (o[e.properties.name] = i),
                "true" !== e.properties.layout &&
                  (r.push(i),
                  e.properties.name && (r.byName[e.properties.name] = i));
            }),
            r
          );
        }
            ...
            e.on("touchstart", function (e) {
              ...
              e.on("touchend", function (e) {
                "A" !== e.target.nodeName.toUpperCase() &&
                  ((s = e.changedTouches[0]), (a = s.clientX), r() ? o() : h());
              }),
    ...
    24: [
      function (e, l) {
        ...
        function a(e) {
          return { width: Math.floor((r / h) * e.ratio), height: o };
        }
        var r = 908,
          o = 681,
          h = r / o;
        (l.exports = s),
          (s.prototype.scaleToFit = function (e, l) {
            var s,
              ...
              j = h.ratio,
              c = h.dimensions;
            (s = n / j.width > i / j.height ? i / c.height : n / c.width),
              (t = c.width * s),
              (a = c.height * s),
              (r = (n - t) / 2),
              (o = (i - a) / 2),
      ...
      function (e, l) {
        function s(e) {
          ...
          (c.getCurrentSlideIndex = t),
            ...
            e.on("gotoNextSlide", h),
            e.on("gotoFirstSlide", i),
    ...
    22: [
      function (e, l) {
        ...
        function a(e, l, s) {
          (l.className = ""), i(l, s), h(l, s, e), o(l, s);
        }
        function r(e, l) {
      ...
      {
        "components/slide-number": "aIW4aw",
        "../converter": 9,
        "../highlighter": 7,
        "../utils": 8,
      },
      ...
      function (e, l, s) {
        !(function (e) {
          !function () {
            ...
            function c(l, s, t) {
              if (t || "function" == typeof s) {
                ...
                var u = function () {
                  ...
                  return (s.highlight = i), l ? t(l) : t(null, e);
                };
                if (!i || i.length < 3) return u();
                if ((delete s.highlight, !h)) return u();
                for (; n < a.length; n++)
                  !(function (e) {
                    return "code" !== e.type
                      ? --h || u()
                      : i(e.text, e.lang, function (l, s) {
            ...
            (d.bullet = /(?:[*+-]|\d+\.)/),
              (d.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
              (d.item = i(d.item, "gm")(/bull/g, d.bullet)()),
              (d.list = i(d.list)(/bull/g, d.bullet)(
                "hr",
                /\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/
              )()),
              (d._tag =
                "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b"),
              (d.html = i(d.html)("comment", /<!--[\s\S]*?-->/)(
                "closed",
                /<(tag)[\s\S]+?<\/\1>/
              )("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(
                /tag/g,
              ...
              (d.paragraph = i(d.paragraph)("hr", d.hr)("heading", d.heading)(
                "lheading",
                d.lheading
              ...
              (e.prototype.token = function (e, l) {
                for (
                  var s, t, a, r, o, h, i, n, j, e = e.replace(/^ +$/gm, "");
                  e;
            ...
            (u._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/),
              ...
              (u.link = i(u.link)("inside", u._inside)("href", u._href)()),
              (u.reflink = i(u.reflink)("inside", u._inside)()),
              (u.normal = j({}, u)),
              ...
              (r.prototype.tok = function () {
                switch (this.token.type) {
                  ...
                  case "list_start":
                    for (
                      var o = "", h = this.token.ordered;
                      "list_end" !== this.next().type;

                    )
                      o += this.tok();
                    return this.renderer.list(o, h);

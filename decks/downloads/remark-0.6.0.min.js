!(function (e, t, n) {
...
})(
  {
    1: [
      ...
      { "./remark/api": 2, "./remark/highlighter": 3, "./remark/resources": 4 },
    ],
    3: [
      function (require, module, exports) {
        !(function () {
          var hljs = new (function () {
              ...
              function blockText(block, ignoreNewLines) {
                return Array.prototype.map
                  .call(block.childNodes, function (node) {
                    if (node.nodeType == 3) {
              ...
              function blockLanguage(block) {
                var classes = (
                  block.className +
                  " " +
                  (block.parentNode ? block.parentNode.className : "")
                ).split(/\s+/);
              ...
              function mergeStreams(stream1, stream2, value) {
                ...
                function selectStream() {
                  if (stream1.length && stream2.length) {
                    if (stream1[0].offset != stream2[0].offset)
                      return stream1[0].offset < stream2[0].offset
                        ? stream1
                        : stream2;
                    else {
                ...
                while (stream1.length || stream2.length) {
                  ...
                  result += escape(
                    value.substr(processed, current.offset - processed)
                  );
              ...
              function compileLanguage(language) {
                ...
                function compileMode(mode, parent) {
                  ...
                  if (mode.keywords) {
                    ...
                    mode.lexemsRe = langRe(
                      mode.lexems || hljs.IDENT_RE + "(?!\\.)",
                      true
                    );
                    if (typeof mode.keywords == "string") {
                      ...
                      for (var className in mode.keywords) {
                        if (!mode.keywords.hasOwnProperty(className)) continue;
              ...
              function highlight(language_name, value, ignore_illegals) {
                ...
                function processSubLanguage() {
                  ...
                  var result = top.subLanguage
                    ? highlight(top.subLanguage, mode_buffer)
              ...
              function highlightAuto(text) {
                ...
                for (var key in languages) {
                  ...
                  if (
                    current.keyword_count + current.relevance >
                    second_best.keyword_count + second_best.relevance
                  ) {
                    second_best = current;
                  }
                  if (
                    current.keyword_count + current.relevance >
                    result.keyword_count + result.relevance
                  ) {
                    second_best = result;
                    result = current;
                  }
              ...
              function fixMarkup(value, tabReplace, useBR) {
                if (tabReplace) {
                  value = value.replace(/^((<[^>]+>|\t)+)/gm, function (
                    match,
                    p1,
                    offset,
                    s
              ...
              function initHighlighting() {
                ...
                Array.prototype.map
                  .call(document.getElementsByTagName("pre"), findCode)
                  .filter(Boolean)
            ...
            languages = [
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  var COMMENTS = [
                    ...
                    { className: "comment", begin: "^__END__", end: "\\n$" },
                  ];
                  var SUBST = {
                    className: "subst",
                    begin: "#\\{",
                  ...
                  var RUBY_DEFAULT_CONTAINS = COMMENTS.concat(
                    STRINGS.concat([
                      {
                        className: "class",
                        beginWithKeyword: true,
              ...
              },
              {
                name: "python",
                create: function (hljs) {
                  var PROMPT = { className: "prompt", begin: /^(>>>|\.\.\.) / };
                  var STRINGS = [
                    {
                      className: "string",
                      begin: /(u|b)?r?'''/,
                  ...
                  var PARAMS = {
                    ...
                    contains: ["self", hljs.C_NUMBER_MODE, PROMPT].concat(
                      STRINGS
                    ),
                  };
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  var VAR2 = { className: "variable", begin: /\$\{(.*?)\}/ };
                  var QUOTE_STRING = {
                    className: "string",
                    begin: /"/,
                    end: /"/,
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  var VAR1 = { className: "variable", begin: "\\$\\d" };
                  var VAR2 = {
                    className: "variable",
                    begin:
                      "[\\$\\%\\@\\*](\\^\\w\\b|#\\w+(\\:\\:\\w+)*|[^\\s\\w{]|{\\w+}|\\w+(\\:\\:\\w*)*)",
                  ...
                  var PERL_DEFAULT_CONTAINS = [
                    ...
                    { className: "string", begin: "{\\w+}", relevance: 0 },
                    {
                      className: "string",
                      begin: "-?\\w+\\s*\\=\\>",
                      relevance: 0,
                  ...
                  return {
                    ...
                    contains: [
                      ...
                      { className: "preprocessor", begin: "#", end: "$" },
                      {
                        ...
                        contains: [
                          { className: "id", begin: hljs.UNDERSCORE_IDENT_RE },
                        ],
                      },
                      {
                        className: "variable",
                    ...
                    contains: [
                      {
                        ...
                        returnBegin: true,
                        contains: [
                          { className: "xmlDocTag", begin: "///|<!--|-->" },
                          { className: "xmlDocTag", begin: "</?", end: ">" },
                        ],
                      },
                      hljs.C_LINE_COMMENT_MODE,
                      hljs.C_BLOCK_COMMENT_MODE,
                ...
                create: function (hljs) {
                  ...
                  var TAG_INTERNALS = {
                    ...
                    contains: [
                      ...
                      {
                        begin: "=",
                        contains: [{ className: "value", begin: "[^\\s/>]+" }],
                      },
                    ],
                  };
                  return {
                ...
                create: function (hljs) {
                  ...
                  return {
                    ...
                    contains: [
                      ...
                      { className: "tag", begin: IDENT_RE, relevance: 0 },
                      {
                        className: "rules",
                        begin: "{",
                        end: "}",
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  var EXPRESSIONS = [
                    ...
                    { className: "regexp", begin: "//[gim]*", relevance: 0 },
                    {
                      className: "regexp",
                      begin: "/\\S(\\\\.|[^\\n])*?/[gim]*(?=\\s|\\W|$)",
                    },
                    { className: "property", begin: "@" + JS_IDENT_RE },
                    {
                      begin: "`",
                      end: "`",
                      excludeBegin: true,
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  var LIST = { className: "list", begin: "\\(", end: "\\)" };
                  var BODY = { endsWithParent: true, relevance: 0 };
                  LIST.contains = [
                    { className: "title", begin: LISP_IDENT_RE },
                    BODY,
                  ];
                  BODY.contains = [QUOTED1, QUOTED2, LIST, LITERAL]
                    .concat(NUMBERS)
                    .concat([STRING, COMMENT, VARIABLE, KEYWORD]);
                  return {
                    illegal: "[^\\s]",
                    contains: NUMBERS.concat([
                      SHEBANG,
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  return { illegal: "\\S", contains: [COMMENT, LIST] };
                },
              },
              {
                name: "http",
    ...
    2: [
      function (require, module, exports) {
        ...
        module.exports.create = function (options) {
          ...
          controller =
            options.controller || new Controller(events, slideshowView);
          return slideshow;
        };
    ...
    8: [
      function (require, module, exports) {
        ...
        function handleFullscreen(self) {
          var requestFullscreen = getPrefixedProperty(
              self.containerElement,
              "requestFullScreen"
            ),
            cancelFullscreen = getPrefixedProperty(
              document,
              "cancelFullScreen"
            );
        ...
        SlideshowView.prototype.configureChildElements = function () {
          ...
          self.elementArea = self.containerElement.getElementsByClassName(
            "remark-slides-area"
          )[0];
          self.previewArea = self.containerElement.getElementsByClassName(
            "remark-preview-area"
          )[0];
          self.notesArea = self.containerElement.getElementsByClassName(
            "remark-notes-area"
          )[0];
          self.notesElement = self.notesArea.getElementsByClassName(
            "remark-notes"
          )[0];
          self.toolbarElement = self.notesArea.getElementsByClassName(
            "remark-toolbar"
          )[0];
          var commands = {
            increase: function () {
              self.notesElement.style.fontSize =
                (parseFloat(self.notesElement.style.fontSize) || 1) +
                0.1 +
                "em";
            },
            decrease: function () {
          ...
          self.backdropElement = self.containerElement.getElementsByClassName(
            "remark-backdrop"
          )[0];
          self.helpElement = self.containerElement.getElementsByClassName(
            "remark-help"
          )[0];
          self.timerElement = self.notesArea.getElementsByClassName(
            "remark-toolbar-timer"
          )[0];
          self.pauseElement = self.containerElement.getElementsByClassName(
            "remark-pause"
          )[0];
            ...
            window.matchMedia("print").addListener(function (e) {
              if (e.matches) {
                self.slideViews.forEach(function (slideView) {
                  slideView.scale({ clientWidth: 908, clientHeight: 681 });
                });
              }
            });
          }
        ...
        SlideshowView.prototype.showSlide = function (slideIndex) {
          ...
          if (nextSlideView) {
            self.previewArea.innerHTML =
              nextSlideView.containerElement.outerHTML;
          } else {
            self.previewArea.innerHTML = "";
          }
        ...
        SlideshowView.prototype.scaleElements = function () {
          ...
          if (self.previewArea.children.length) {
            self.scaler.scaleToFit(
              self.previewArea.children[0].children[0],
              self.previewArea
            );
          }
      ...
      { "./slideView": 15, "../scaler": 16, "../resources": 4, "../utils": 12 },
    ],
    10: [
      function (require, module, exports) {
      ...
      function (require, module, exports) {
        ...
        function inheritProperties(slide, template) {
          ...
          for (property in template.properties) {
            ...
            if (
              property === "class" ||
              slide.properties[property] === undefined
            ) {
    ...
    14: [
      function (require, module, exports) {
        ...
        function createSlide() {
          return { source: "", properties: { continued: "false" } };
        }
    ...
    15: [
      function (require, module, exports) {
        ...
        SlideView.prototype.configureElements = function () {
          ...
          self.contentElement = createContentElement(
            self.events,
            self.slideshow,
            self.slide
          );
          ...
          self.numberElement.innerHTML =
            self.slide.number + " / " + self.slideshow.getSlides().length;
        ...
        SlideView.prototype.scaleBackgroundImage = function (dimensions) {
          var self = this,
            ...
            image;
          if (
            (match = /^url\(("?)([^\)]+?)\1\)/.exec(backgroundImage)) !== null
          ) {
            image = new Image();
            image.onload = function () {
              if (
                ...
                if (!self.originalBackgroundSize) {
                  self.originalBackgroundSize =
                    self.contentElement.style.backgroundSize;
        ...
        function setHighlightStyleFromProperties(
          element,
          properties,
          slideshow
        ) {
          var highlightStyle =
            properties["highlight-style"] || slideshow.getHighlightStyle();
          if (highlightStyle) {
      ...
      { "../converter": 18, "../highlighter": 3, "../utils": 12 },
    ],
    17: [
      function (require, module, exports) {
        ...
        var block = replace(
            /CODE|CONTENT|FENCES|SEPARATOR|NOTES_SEPARATOR/,
            regexByName
          ),
        ...
        function lex(src, regex, tokens) {
          ...
          while ((cap = regex.exec(src)) !== null) {
            ...
            if (cap[CODE]) {
              ...
              tokens.push({ type: "separator", text: cap[SEPARATOR] });
        ...
        function replace(regex, replacements) {
          return new RegExp(
            regex.source.replace(/\w{2,}/g, function (key) {
            ...
            InlineLexer.prototype.output = function (src) {
              ...
              while (src) {
                ...
                if ((cap = this.rules.strong.exec(src))) {
                  src = src.substring(cap[0].length);
                  out +=
                    "<strong>" + this.output(cap[2] || cap[1]) + "</strong>";
                  continue;
                }
              ...
              switch (this.token.type) {
                ...
                case "code": {
                  if (this.options.highlight) {
                    var code = this.options.highlight(
                      this.token.text,
                      this.token.lang
                    );

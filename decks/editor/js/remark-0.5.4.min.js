!(function (e, t, n) {
...
})(
  {
          ...
          var hljs = new (function () {
              ...
              function highlight(language_name, value) {
                ...
                function processModeInfo(buffer, lexem) {
                  ...
                  if (isIllegal(lexem, top)) throw "Illegal";
                }
                ...
                try {
                  ...
                  while (true) {
                    ...
                    if (!match) break;
                    var return_lexem = processModeInfo(
              ...
              },
              {
                ...
                create: function (hljs) {
                  ...
                  var TEST_CONDITION = {
                    ...
                    keywords: { literal: BASH_LITERAL },
                    relevance: 0,
                  };
                  return {
                    keywords: {
                      keyword:
                        "if then else fi for break continue while in do done echo exit return set declare",
                    ...
                    contains: [
                      {
                        className: "operator",
                        begin:
                          "(begin|start|commit|rollback|savepoint|lock|alter|create|drop|rename|call|delete|do|handler|insert|load|replace|select|truncate|update|set|show|pragma|grant)\\b",
                        end: ";",
                        endsWithParent: true,
                        keywords: {
                          keyword:
                ...
                create: function (hljs) {
                  ...
                  return {
                    ...
                    contains: [
                      ...
                      { className: "tag", begin: hljs.IDENT_RE, relevance: 0 },
                      {
                        className: "rules",
                        begin: "{",
                        end: "}",
    ...
    7: [
      ...
      { "./slideView": 14, "../resources": 4, "../utils": 11 },
    ],
    11: [
      function (require, module, exports) {
    ...
    14: [
      ...
      { "../converter": 16, "../highlighter": 3, "../utils": 11 },
    ],
    15: [
      function (require, module, exports) {
